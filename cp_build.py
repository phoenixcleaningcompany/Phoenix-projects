...
"glasgow": {
    ...
    "nearby": ["Paisley", "East Kilbride", "Coatbridge"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Glasgow, embroidered in-house to brand guidelines. Glasgow is one of the UK's largest financial centres outside London, with more than 58,000 people in financial and business services, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Branded kit for Glasgow's financial district",
    "s1loc": [
        "Glasgow's International Financial Services District, nicknamed Wall Street on the Clyde, runs between St Vincent Street and the River Clyde along the Broomielaw, with space planned for around 28,000 staff. Major employers based in and around the district include Barclays at its Tradeston campus, JP Morgan's European Technology Centre, Morgan Stanley, BNP Paribas, Aon, Arthur J Gallagher and AXA, alongside Bank of Scotland and Lloyds Banking Group. Law firms such as Brodies and Ashurst and the city's accountancy and consultancy practices round out the professional core.",
        "Around 58,000 people work in financial and business services across Glasgow, fed by the University of Strathclyde Business School and the University of Glasgow's Adam Smith Business School, which together produce thousands of finance and accounting graduates each year. These teams wear suits day to day, then step into branded polos, softshells and fleeces for conferences, away days, exhibitions, client visits and sponsored events. Procurement, office and brand managers order the kit and care that the embroidery matches their brand exactly, which is what an account-managed service delivers.",
    ],
    "kit_loc": "across the city centre and the financial services district",
    "s2_intro": "Whether you are a Glasgow bank, law firm, accountancy, consultancy, insurer or a technology company",
},
"sheffield": {
    "region": "Sheffield and South Yorkshire",
    "nearby": ["Rotherham", "Barnsley", "Chesterfield"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Sheffield, embroidered in-house to brand guidelines. Sheffield anchors the professional-services economy of South Yorkshire, with a city-centre legal and financial core and a fast-growing digital sector, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Branded kit for Sheffield's professional core",
    "s1loc": [
        "Sheffield's professional core sits around the Heart of the City scheme and the new West Bar quarter near the Combined Court Centre. International law firm CMS occupies Charter Square, DLA Piper works from Elshaw House on Carver Street, and Irwin Mitchell is based at Riverside East on Millsands. Accountancy and advisory firms including Grant Thornton, BHP and Begbies Traynor sit in the same district, with HSBC running a major banking operations centre in the city centre, giving the quarter a dense mix of legal, financial and consultancy employers.",
        "Sheffield's professional workforce is fed by the University of Sheffield and Sheffield Hallam University, whose accounting, finance and computing graduates supply the firms above and a strong digital cluster that includes Sumo Group, Zoo Digital and ASK4. These teams wear suits day to day, then move into branded polos, softshells and fleeces for conferences, away days, exhibitions, client visits and sponsored events. Office, procurement and brand managers place the orders and care that the embroidery matches the brand exactly, which is what an account-managed service is built to deliver.",
    ],
    "kit_loc": "across the city centre and professional core",
    "s2_intro": "Whether you are a Sheffield bank, law firm, accountancy, consultancy, insurer or a technology company",
},
"manchester": {
    "region": "Manchester and the North West",
    "nearby": ["Salford", "Stockport", "Oldham"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Manchester, embroidered in-house to brand guidelines. Manchester is the largest financial and professional-services centre outside London, with Spinningfields alone home to around 20,000 people, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Branded kit for Manchester's Spinningfields quarter",
    "s1loc": [
        "Spinningfields is Manchester's legal and financial quarter, home to roughly 20,000 workers, where DWF runs a team of more than 1,000 and Fieldfisher, JMW and Wrigley Claydon all hold offices. The wider city carries the highest concentration of top-100 UK law firms outside London, with PwC, Deloitte, KPMG and EY all expanding their Manchester footprints, and more than 60 banks present, including Barclays, HSBC and BNY Mellon running regional headquarters and operations centres across the centre.",
        "Manchester's financial, professional and business-services sector employs tens of thousands of people, fed by the University of Manchester, Manchester Metropolitan University and the University of Salford. KPMG alone bases more than 1,000 staff in the city, including data scientists and software engineers in its technology hub. These teams wear suits day to day, then step into branded polos, softshells and fleeces for conferences, away days, exhibitions, client visits and sponsored events. Procurement, office and brand managers order the kit and care that the embroidery matches their brand exactly.",
    ],
    "kit_loc": "across the city centre and Spinningfields",
    "s2_intro": "Whether you are a Manchester bank, law firm, accountancy, consultancy, insurer or a technology company",
},
"edinburgh": {
    "region": "Edinburgh and the Lothians",
    "nearby": ["Musselburgh", "Livingston", "Dunfermline"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Edinburgh, embroidered in-house to brand guidelines. As the UK's second-largest financial centre, with hundreds of asset managers, life offices and professional firms across the city, Edinburgh runs on its brand, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Branded kit for Edinburgh's financial and professional firms",
    "s1loc": [
        "Edinburgh is the UK's second-largest financial centre, and its core runs through Charlotte Square, St Andrew Square and the Exchange district around Lothian Road. Bank of Scotland, Royal Bank of Scotland and Lloyds anchor the banking side, while Baillie Gifford, abrdn, Aegon, Royal London, Artemis and Martin Currie make the city the largest asset-management base outside London. Law firms, accountancies and insurers fill the office blocks around George Street and St Andrew Square, alongside a fast-growing fintech presence across the central business district.",
        "More than a hundred thousand people work across financial and professional services here, fed by the University of Edinburgh, Heriot-Watt and Edinburgh Napier and their strong finance, law and computing schools. These are suited firms day to day, but they step into branded polos, softshells and fleeces for conferences, away days, exhibitions, client and site visits and sponsored fundraising events. Procurement, office and brand managers order the kit, and they care that every embroidered logo matches the corporate brand exactly across all their teams.",
    ],
    "kit_loc": "across the city centre and the financial district",
    "s2_intro": "Whether you are an Edinburgh bank, an asset manager, a law firm, an accountancy, a consultancy, an insurer or a technology company",
},
"liverpool": {
    "region": "Liverpool and Merseyside",
    "nearby": ["Bootle", "Birkenhead", "St Helens"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Liverpool, embroidered in-house to brand guidelines. With more than forty thousand people working in financial and professional services across the city region, Liverpool is a substantial commercial centre, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Branded kit for Liverpool's commercial business quarter",
    "s1loc": [
        "Liverpool's commercial district runs through Old Hall Street, Castle Street and Dale Street, with The Plaza at 100 Old Hall Street a focal point. National law firms including Hill Dickinson, DLA Piper, CMS, DWF, Weightmans and Brabners are based in the quarter, alongside accountancies and consultancies. The city hosts major operations for Santander, Barclaycard, Handelsbanken and RSA, and Bibby Financial Services is a long-standing local name. Insurers, banks and a growing technology and digital cluster fill the office towers across the business quarter.",
        "More than forty thousand people work in financial and professional services across Liverpool, around one in six of all city jobs, with over six hundred legal firms employing thousands more. The University of Liverpool, Liverpool John Moores and Edge Hill feed that workforce. Suited day to day, these firms move into branded polos, softshells and fleeces for conferences, away days, exhibitions, client and site visits and sponsored fundraising events. Office, procurement and brand managers place the orders and want every embroidered logo matched precisely to the corporate brand.",
    ],
    "kit_loc": "across the city centre and the commercial district",
    "s2_intro": "Whether you are a Liverpool bank, a law firm, an accountancy, a consultancy, an insurer or a technology company",
},
"bristol": {
    "region": "Bristol and the West of England",
    "nearby": ["Bath", "Weston-super-Mare", "Portishead"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Bristol, embroidered in-house to brand guidelines. As one of the UK's strongest centres for law, aerospace and technology, with thousands of firms across the West of England, Bristol carries serious commercial weight, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Branded kit for Bristol's central business district",
    "s1loc": [
        "Bristol's central business district centres on Temple Quay, beside Temple Meads station, and the financial blocks around the city centre. Osborne Clarke, Burges Salmon, TLT, Womble Bond Dickinson, DAC Beachcroft and RPC make Bristol the UK's second city for law, working alongside accountancies, consultancies and insurers. HMRC and OVO Energy are major Temple Quay employers, and the region's aerospace strength runs through Airbus, GKN Aerospace, Rolls-Royce, Leonardo and Vertical Aerospace, anchoring a wider engineering and technology cluster across the city.",
        "Bristol sits at the heart of the West of England technology corridor, with thousands of digital, cyber, fintech and creative firms, fed by the University of Bristol and UWE and their engineering and computing strength. These professional and technical firms are suited day to day, but they step into branded polos, softshells and fleeces for conferences, away days, exhibitions, client and site visits and sponsored fundraising events. Procurement, office and brand managers handle the kit, and they care that every embroidered logo matches the corporate brand exactly.",
    ],
    "kit_loc": "across the city centre and Temple Quay",
    "s2_intro": "Whether you are a Bristol bank, a law firm, an accountancy, a consultancy, an insurer, an aerospace business or a technology company",
},
"cardiff": {
    "region": "Cardiff and South Wales",
    "nearby": ["Newport", "Barry", "Caerphilly"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Cardiff, embroidered in-house to brand guidelines. As the capital of Wales and home to its only FTSE 100 headquarters, the city anchors a dense financial and professional-services core, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Cardiff's financial and professional core",
    "s1loc": [
        "Cardiff's central business district runs from Callaghan Square through Central Square to the Capital Quarter, the heart of the city's financial and professional-services enterprise zone. Callaghan Square draws occupiers such as Eversheds, HSBC, JLL and AECOM, while Central Square added the new BBC Cymru Wales headquarters, HMRC and the law firm Hugh James. Admiral Group, the only FTSE 100 company headquartered in Wales, runs its Cardiff offices nearby, alongside insurers, accountancies and consultancies clustered around Capital Tower and the Capital Quarter towers.",
        "Thousands of Cardiff professionals work across these banks, insurers, law firms and accountancies, fed by Cardiff University and a steady graduate pipeline into financial and technology roles. They wear suits day to day but step into branded polos, softshells and fleeces for conferences, away days, exhibitions, client visits and sponsored events. The kit is ordered by procurement, office and brand managers who care that every embroidered logo matches the brand exactly, across each office and team.",
    ],
    "kit_loc": "across the city centre and the central business district",
    "s2_intro": "Whether you are a Cardiff bank, law firm, accountancy, consultancy, insurer or a technology company",
},
"leicester": {
    "region": "Leicester and the East Midlands",
    "nearby": ["Loughborough", "Hinckley", "Oadby"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Leicester, embroidered in-house to brand guidelines. As one of the largest cities in the East Midlands, with a financial and professional-services base spanning wealth management, specialist banking and national law and accountancy firms, the city sustains a broad corporate workforce, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Leicester's city-centre professional district",
    "s1loc": [
        "Leicester's professional district sits in and around the city centre, between the railway station and the New Walk and St George's quarters. The city is home to wealth manager Mattioli Woods and to Cambridge and Counties Bank, a specialist SME and property lender headquartered in Leicester. Law firms including Howes Percival, Weightmans and Browne Jacobson advise local business, while accountancies such as MHA, Forvis Mazars, TC Group and Haines Watts work alongside them, supported by banks including HSBC and a network of insurers and consultancies.",
        "Leicester's professional-services workforce is fed by the University of Leicester and De Montfort University, with firms like Mattioli Woods known for recruiting graduates directly from the local universities. These are suited finance, legal and advisory teams who switch into branded polos, softshells and fleeces for conferences, away days, exhibitions, client visits and sponsored events. The kit is chosen by procurement, office and brand managers who want every embroidered logo to match the brand precisely, across each office and team.",
    ],
    "kit_loc": "across the city centre and professional district",
    "s2_intro": "Whether you are a Leicester bank, law firm, accountancy, consultancy, insurer or a technology company",
},
"bradford": {
    "region": "Bradford and West Yorkshire",
    "nearby": ["Keighley", "Shipley", "Bingley"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Bradford, embroidered in-house to brand guidelines. Built on a Victorian commercial heritage and now home to major financial and professional-services employers, the city keeps a substantial corporate workforce in and around its city centre, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Bradford's commercial heart and Little Germany",
    "s1loc": [
        "Bradford's professional core centres on the city centre and Little Germany, the conservation area of honey-coloured Victorian warehouses that once drove the wool trade and now houses more than a hundred businesses and several thousand workers. The city is the headquarters of Yorkshire Building Society, based at Yorkshire House, and of Vanquis Banking Group, the bank formerly known as Provident Financial. Commercial law firm Schofield Sweeney is headquartered here, with firms such as Ison Harrison adding city-centre offices, alongside local accountancies, insurers and consultancies.",
        "Bradford's financial and professional-services workforce draws on the University of Bradford and a long commercial tradition, supplying banking, legal, advisory and technology teams across the district. They work in suits but move into branded polos, softshells and fleeces for conferences, away days, exhibitions, client visits and sponsored events. The kit is ordered by procurement, office and brand managers who care that every embroidered logo matches the brand exactly, kept consistent across each office and team.",
    ],
    "kit_loc": "across the city centre and Little Germany",
    "s2_intro": "Whether you are a Bradford bank, law firm, accountancy, consultancy, insurer or a technology company",
},
"coventry": {
    "region": "Coventry and Warwickshire",
    "nearby": ["Nuneaton", "Bedworth", "Kenilworth"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Coventry, embroidered in-house to brand guidelines. Coventry pairs a growing professional-services base around the city centre and the Friargate business district with major regulatory and energy employers, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Corporate kit for Coventry and Friargate firms",
    "s1loc": [
        "Coventry's professional core runs from the city centre out to Friargate, the dedicated business district laid out around the railway station with nearly two million square feet of Grade A office space. The Financial Ombudsman Service and Octopus Energy anchor large headcounts here, alongside SEGRO and a widening set of advisory and membership bodies. Law firms Band Hatton Button and HCR Wright Hassall serve corporate, employment and real-estate clients across the region, while accountancy and consultancy practices cluster nearby to support the city's manufacturing and energy economy.",
        "Coventry's professional workforce is fed by the University of Warwick and Coventry University, which channel graduates into finance, law, technology and engineering-services roles. These are suit-and-laptop teams day to day, but they step into branded polos, softshells and fleeces for conferences, away days, exhibitions and client or site visits, plus sponsored and fundraising events across Coventry and Warwickshire. The buyers are procurement, office and brand managers who need the embroidery, colour and logo placement to match their corporate identity exactly, every reorder.",
    ],
    "kit_loc": "across the city centre and the Friargate business district",
    "s2_intro": "Whether you are a Coventry bank, law firm, accountancy, consultancy, insurer or a technology company",
},
"nottingham": {
    "region": "Nottingham and the East Midlands",
    "nearby": ["Beeston", "Arnold", "Carlton"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Nottingham, embroidered in-house to brand guidelines. Nottingham is one of the East Midlands' largest professional, financial and technology centres, home to Experian and Capital One and a deep legal sector, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Corporate kit for Nottingham's professional sector",
    "s1loc": [
        "Nottingham's professional and financial core runs from the historic Lace Market through the city centre to Castle Wharf and Castle Meadow. Experian, the global credit and data business, is headquartered in the city, and Capital One runs its UK base from Station Street. The legal sector is exceptionally strong: Browne Jacobson and Freeths are headquartered here, joined by national firms Eversheds Sutherland, Gateley and Shoosmiths, with KPMG, Grant Thornton and other accountancy and consultancy practices supporting deals, audit and advisory work across the region.",
        "Nottingham's professional workforce draws on the University of Nottingham and Nottingham Trent University, which supply graduates into financial services, law, data and technology roles, with more than thirty thousand people in digital and tech work across the city. These suited teams switch into branded polos, softshells and fleeces for conferences, away days, exhibitions and client or site visits, alongside sponsored and fundraising events. Orders are placed by procurement, office and brand managers who insist the embroidery, thread colours and logo placement match their corporate guidelines exactly on every reorder.",
    ],
    "kit_loc": "across the city centre, the Lace Market and Castle Wharf",
    "s2_intro": "Whether you are a Nottingham bank, law firm, accountancy, consultancy, insurer or a technology company",
},
"newcastle upon tyne": {
    "region": "Newcastle and the North East",
    "nearby": ["Gateshead", "South Shields", "Tynemouth"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Newcastle upon Tyne, embroidered in-house to brand guidelines. Newcastle upon Tyne is the North East's leading professional, financial and technology centre, with a major legal and insurance cluster on the Quayside and large employers out at Cobalt Park, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Corporate kit for Newcastle upon Tyne firms",
    "s1loc": [
        "Newcastle upon Tyne's business district stretches along the Quayside and out to Cobalt Park at the edge of the city. The Quayside is a dense legal and insurance cluster: Norton Rose Fulbright, Womble Bond Dickinson, Ward Hadaway, Muckle LLP and the insurance specialist Clyde and Co all hold significant offices there, with PwC and other accountancy and consultancy practices alongside. Cobalt Park is home to the Sage Group, Newcastle Building Society and Accenture, plus Santander, IBM, DXC Technology and DNV, anchoring the region's technology and back-office economy.",
        "Newcastle upon Tyne's professional workforce is fed by Newcastle University and Northumbria University, which supply graduates into law, accountancy, insurance, financial services and technology roles right across Tyneside. These office-based teams move into branded polos, softshells and fleeces for conferences, away days, exhibitions and client or site visits, plus sponsored and fundraising events. The buyers are procurement, office and brand managers who care that the embroidery, colours and logo placement match their corporate identity precisely, keeping every team and every reorder consistent on brand.",
    ],
    "kit_loc": "across the Quayside, the city centre and Cobalt Park",
    "s2_intro": "Whether you are a Newcastle upon Tyne bank, law firm, accountancy, consultancy, insurer or a technology company",
},
"sunderland": {
    "region": "Sunderland and the North East",
    "nearby": ["Washington", "Houghton le Spring", "Seaham"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Sunderland, embroidered in-house to brand guidelines. As a fast-growing North East software and professional-services centre anchored by Riverside Sunderland and Sunderland Software City, the city carries a real corporate base, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Branded kit for Sunderland's corporate and tech employers",
    "s1loc": [
        "Sunderland's corporate core has shifted to the new Riverside Sunderland district beside the Wear, where The Beam and City Hall anchor an emerging central business quarter. Ocado Retail runs a major operation from The Beam, EDF holds a long-standing customer base in the city, and Maker and Faber adds Grade A space funded by Legal and General. Sunderland Software City and the Sunderland Software Centre cluster technology firms such as tombola and Leighton, while accountancies including TTR Barnes and the Willis Scott Group and law firms such as Longden, Walker and Renney and Mortons serve the wider commercial base.",
        "The professional-services workforce here is fed by the University of Sunderland and the wider Tyne and Wear talent pool, spanning software, customer operations, finance and legal teams. These people work in suits or smart-casual day to day, then step into branded polos, softshells and fleeces for conferences, away days, exhibitions, client and site visits, and sponsored community events. Office managers, procurement leads and brand managers order the kit, and they care that the embroidered logo, the thread colours and the garment styling match their brand exactly across every team.",
    ],
    "kit_loc": "across the city centre and the Riverside business district",
    "s2_intro": "Whether you are a Sunderland bank, law firm, accountancy, consultancy, insurer or a technology company",
},
"brighton": {
    "region": "Brighton and the South Coast",
    "nearby": ["Hove", "Worthing", "Eastbourne"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Brighton, embroidered in-house to brand guidelines. With a digital cluster of around 1,500 firms known as Silicon Beach plus major financial-services and professional employers, the city carries a substantial corporate base, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Branded kit for Brighton's tech and financial employers",
    "s1loc": [
        "Brighton and Hove is one of the UK's leading creative-tech clusters, the Silicon Beach economy of roughly 1,500 digital firms, with the New England House and FuseBox hubs near the station as its incubation centre. American Express is the city's largest private-sector employer, with thousands of staff at its 1 John Street office, and Legal and General has a long-established presence too. Technology names such as Brandwatch, Paxton and 15below sit alongside law firm DMH Stallard and chartered accountants including Plus Accounting, giving the city a broad professional-services and financial base.",
        "That base draws on the University of Sussex and the University of Brighton, feeding software, data, design, finance, insurance and legal teams across the city and into Hove. These professionals work in suits or smart-casual most days, then move into branded polos, softshells and fleeces for conferences, away days, exhibitions, client and site visits, and sponsored community events. Brand managers, office managers and procurement leads place the orders, and they want the embroidered logo, thread colours and garment styling to match their brand exactly across every office and team.",
    ],
    "kit_loc": "across the city centre and the digital and financial district",
    "s2_intro": "Whether you are a Brighton bank, law firm, accountancy, consultancy, insurer or a technology company",
},
"plymouth": {
    "region": "Plymouth and the South West",
    "nearby": ["Saltash", "Newton Abbot", "Torquay"],
    "snapshot": "iNeedWorkwear supplies branded polos, shirts, softshells and fleeces to banks, law firms, accountancies, consultancies, insurers and technology companies across Plymouth, embroidered in-house to brand guidelines. As the largest city on the South West coast, with a strong professional-services base and major marine and defence engineering employers, Plymouth carries a substantial corporate economy, and we run it as a managed account: a single point of contact, your brand pack held on file, and reorders kept consistent across every office, team and event.",
    "s1_head": "Branded kit for Plymouth's professional and engineering employers",
    "s1loc": [
        "Plymouth's corporate base runs through the city centre and the waterfront business quarters at Millbay, Sutton Harbour and Royal William Yard. Womble Bond Dickinson, the largest law firm in the city, sits at Millbay, while Foot Anstey holds a major office around Sutton Harbour, and chartered accountancies including PKF Francis Clark at Royal William Yard, Bishop Fleming and Westcotts serve the wider commercial market. Babcock International runs the Devonport site, the largest naval support operation in Western Europe, and is moving thousands of staff into a new city-centre base, alongside marine engineering employer Princess Yachts.",
        "Plymouth's professional and engineering workforce is fed by the University of Plymouth and City College Plymouth, spanning law, accountancy, consultancy, finance, marine and defence engineering teams. These people work in suits or smart-casual day to day, then step into branded polos, softshells and fleeces for conferences, away days, exhibitions, client and site visits, and sponsored community events. Office managers, procurement leads and brand managers order the kit, and they care that the embroidered logo, the thread colours and the garment styling match their brand exactly across every office and team.",
    ],
    "kit_loc": "across the city centre and the waterfront business district",
    "s2_intro": "Whether you are a Plymouth bank, law firm, accountancy, consultancy, insurer or a technology company",
},
}
