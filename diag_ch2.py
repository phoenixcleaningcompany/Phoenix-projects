#!/usr/bin/env python3
"""diag_vt.py - over-cap-pair diagnostic for the CH2 series.

When score_ch2.py reports a pair over the 52% cap, this isolates exactly what
...
Usage:
  ...
  python3 diag_vt.py ch2-a.html ch2-b.html  # a specific pair (control auto-picked)
  python3 diag_vt.py ch2-a.html ch2-b.html ch2-c.html   # explicit control = c
"""
import os, sys, glob
from itertools import combinations
import score_ch2 as S
...
def main():
    ...
    if len(files) >= 2:
        ...
        paths = collect(args)
        if len(paths) < 2:
            sys.exit("need at least 2 ch2-*.html files")
