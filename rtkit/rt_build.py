...
TOWNS = {
 ...
 "glasgow": {"region": "Glasgow and the west of Scotland", "nearby": ["Paisley", "East Kilbride", "Coatbridge"], "snapshot": "iNeedWorkwear supplies embroidered polos, tabards, fleeces, safety shoes, hi-vis and stockroom trousers to independent retailers, convenience stores, garden centres and farm shops across Glasgow, from the Barras market and De Courcy's Arcade to the suburban high streets, branded in-house with the shop name on a managed trade account, with artwork and sizes held on file so new starters and second stores are kitted in exactly the same uniform.", "s1_head": "Kitting the shops behind Glasgow's independent quarters", "s1loc": ["A major retail city, Glasgow runs its chains down Buchanan Street and Argyle Street but keeps a far deeper independent scene in the lanes and neighbourhoods around them. In the West End, Byres Road and Great Western Road carry delis, gift shops and homeware stores, with Cresswell Lane and De Courcy's Arcade tucked behind them, while Finnieston gathers makers and galleries around the Hidden Lane. East of the centre, the Barras market on Duke Street has traded for generations, and Dennistoun keeps its own run of bakeries, grocers and corner shops along the street.", "Out from the core, the southside and suburban high streets carry the everyday independents: Shawlands, Dennistoun and Finnieston, plus the parades reaching toward Paisley and the outer schemes, full of family-run convenience stores, butchers, florists and refill shops. The Shawlands farmers' market draws producers to Langside Halls, and Caulders garden centres ring the city at Newton Mearns and Kirkintilloch. Nearly all of these put a member of staff in front of a customer wearing something with the shop name on it, and nearly all are owner-run businesses rather than national chains."], "kit_loc": "across the city's high streets, convenience stores and garden centres", "s2_intro": "Whether you run a Shawlands high-street shop, a convenience store, a garden centre or a small group of sites across Glasgow"},
 "sheffield": {"region": "Sheffield and South Yorkshire", "nearby": ["Rotherham", "Barnsley", "Chesterfield"], "snapshot": "iNeedWorkwear supplies embroidered polos, tabards, fleeces, safety shoes, hi-vis and stockroom trousers to independent retailers, convenience stores, garden centres and farm shops across Sheffield, from the Moor Market and the Devonshire Quarter to the suburban high streets, branded in-house with the shop name on a managed trade account, with artwork and sizes held on file so new starters and second stores are kitted in exactly the same uniform.", "s1_head": "Kitting the independents along Sheffield's high streets", "s1loc": ["Set among its seven hills, Sheffield carries one of the strongest independent retail scenes in the north outside the big chains. The covered Moor Market gathers more than ninety traders, grocers, butchers and delis under one roof, while Division Street and the Devonshire Quarter hold boutiques, plant shops and record stores. Across the river, Kelham Island has turned its old works into studios, artisan shops and a flea market, and the long runs of Ecclesall Road and Abbeydale Road carry independent fashion, beer shops and the Antiques Quarter end to end.", "Beyond the centre, the hillside suburbs keep their own village high streets: Crookes, Broomhill, Hillsborough and Nether Edge, each with cobbled passages, family bakeries, greengrocers and convenience stores serving the streets around them. Producers' markets and the Moss Valley market garden sit on the south side, and garden centres ring the city out toward the Peak fringe. Almost every one of these counts on staff who meet customers face to face in branded kit, and almost every one is an independent trading under its own name rather than a chain."], "kit_loc": "across the city's high streets, convenience stores and garden centres", "s2_intro": "Whether you run a Crookes high-street shop, a convenience store, a garden centre or a small group of sites across Sheffield"},
 "manchester": {"region": "Manchester and Greater Manchester", "nearby": ["Salford", "Stockport", "Oldham"], "snapshot": "iNeedWorkwear supplies embroidered polos, tabards, fleeces, safety shoes, hi-vis and stockroom trousers to independent retailers, convenience stores, garden centres and farm shops across Manchester, from the Northern Quarter and the Arndale Market to the suburban high streets, branded in-house with the shop name on a managed trade account, with artwork and sizes held on file so new starters and second stores are kitted in exactly the same uniform.", "s1_head": "Kitting the shops that fill Manchester's indie corners", "s1loc": ["Beyond the chains in the Arndale and on Market Street, Manchester holds one of the highest concentrations of independent shops in the country in the Northern Quarter. Oldham Street and Tib Street form its spine, with Afflecks, the old department store turned indoor market, packing in vintage traders, streetwear stalls, florists and jewellers across its floors. A few doors on, the Arndale Market keeps its produce stalls, fishmonger and grocers running on independent traders rather than multiples.", "Spread across the south of the city, the suburban high streets carry the everyday independents: Beech Road in Chorlton, Burton Road in West Didsbury and the parades of Levenshulme, full of grocers, bookshops, plant stores, delis and convenience stores, with Unicorn Grocery in Chorlton and the weekend Levenshulme Market drawing the local trade. Farm shops and garden centres sit on the fringe out toward Wythenshawe and the Cheshire edge. Behind nearly every counter stands a member of staff facing the public in branded uniform, and nearly every business is a local independent rather than part of a national group."], "kit_loc": "across the city's high streets, convenience stores and garden centres", "s2_intro": "Whether you run a Chorlton high-street shop, a convenience store, a garden centre or a small group of sites across Manchester"},
 "edinburgh": {"region": "Edinburgh and the Lothians", "nearby": ["Livingston", "Dunfermline", "Musselburgh"], "snapshot": "iNeedWorkwear supplies embroidered polos, tabards, fleeces, safety shoes, hi-vis and stockroom trousers to independent retailers, convenience stores, garden centres and farm shops across Edinburgh, from the Grassmarket and Victoria Street to the suburban high streets, branded in-house with the shop name on a managed trade account, with artwork and sizes held on file so new starters and second stores are kitted in exactly the same uniform.", "s1_head": "Kitting the shops that line the capital's streets", "s1loc": ["A capital city built on independent trade, Edinburgh keeps a remarkable density of small shops away from the chain pull of Princes Street and the St James Quarter. The curved sweep of Victoria Street and the Grassmarket below it carry cheesemongers, hat makers, booksellers and gift shops, while the West End's William Street is a tight enclave of boutiques, jewellers and delis. Stockbridge alone counts more than fifty independents, from I J Mellis and George Mewes cheese to the plant shop Grow Urban and a clutch of vintage stores, and every Sunday the Stockbridge Market sets out producer and food stalls along the Water of Leith.", "Head out from the centre and the neighbourhood high streets take over. Bruntsfield and Morningside run a long parade of fashion boutiques, charity shops, grocers and cafes, and similar everyday independents trade across Leith, Corstorphine and Portobello alongside the convenience stores that keep each district stocked. On the city fringe sit the garden centres and nurseries, Dobbies out at Lasswade, Pentland Plants near Loanhead and Riccarton, with farmers' markets bringing Lothian produce into town. The people serving behind those counters are the face of the shop, and nearly all of these are independent traders rather than national names."], "kit_loc": "across the city's high streets, convenience stores and garden centres", "s2_intro": "Whether you run a Stockbridge high-street shop, a convenience store, a garden centre or a small group of sites across Edinburgh"},
 "liverpool": {"region": "Liverpool and Merseyside", "nearby": ["Bootle", "Birkenhead", "St Helens"], "snapshot": "iNeedWorkwear supplies embroidered polos, tabards, fleeces, safety shoes, hi-vis and stockroom trousers to independent retailers, convenience stores, garden centres and farm shops across Liverpool, from Bold Street and the Baltic Market to the suburban high streets, branded in-house with the shop name on a managed trade account, with artwork and sizes held on file so new starters and second stores are kitted in exactly the same uniform.", "s1_head": "Kitting the shops that line Merseyside's high streets", "s1loc": ["Set on the Mersey with a long trading history, Liverpool runs an independent retail scene that thrives well beyond Liverpool ONE and the city-centre chains. Bold Street is the best known stretch, packed with vintage stores, record shops, booksellers and independent cafes, while over in the Baltic Triangle the Baltic Market fills the old Cains Brewery with street-food traders and weekend arts, craft and farmers' stalls from Thursday through to Sunday. These are owner-run businesses where the staff behind the counter are the brand customers remember.", "South of the centre the suburban high streets carry the everyday trade. Lark Lane in Aigburth has its cluster of bohemian boutiques and a monthly farmers' market, Allerton Road and Smithdown Road run grocers, cafes and convenience stores, and Woolton and Crosby villages keep their own parades of independent shops. The fringe adds garden centres such as the family-run Aigburth Garden Centre with its locally sourced eggs and honey, plus farm produce and nurseries dotted around the outskirts. Almost every one of these shops puts a member of staff in front of customers in something branded, and they are independents rather than chains."], "kit_loc": "across the city's high streets, convenience stores and garden centres", "s2_intro": "Whether you run a Lark Lane high-street shop, a convenience store, a garden centre or a small group of sites across Liverpool"},
 "bristol": {"region": "Bristol and the South West", "nearby": ["Bath", "Weston-super-Mare", "Portishead"], "snapshot": "iNeedWorkwear supplies embroidered polos, tabards, fleeces, safety shoes, hi-vis and stockroom trousers to independent retailers, convenience stores, garden centres and farm shops across Bristol, from St Nicholas Market and the Clifton Arcade to the suburban high streets, branded in-house with the shop name on a managed trade account, with artwork and sizes held on file so new starters and second stores are kitted in exactly the same uniform.", "s1_head": "Kitting the shops that line the West Country's streets", "s1loc": ["Beyond the chains in Cabot Circus and Broadmead, Bristol holds one of the strongest independent retail scenes in the country. Gloucester Road is reckoned one of the longest unbroken stretches of independent shops in the UK, a run of delis, cheesemongers, greengrocers, bakers and refill stores that flows down through Stokes Croft, while St Nicholas Market, trading since 1743, packs more than sixty independent stalls under one roof selling food, records, books, vintage and crafts. Up the hill, Clifton Village and the Victorian Clifton Arcade keep their boutiques, jewellers, delis and homeware shops.", "Across the rest of the city the neighbourhood high streets do the daily work. North Street in Bedminster mixes second-hand shops, independents and eateries with a Sunday market for local produce, Whiteladies Road blends food shops and boutiques with a Saturday artisan market, and convenience stores keep every suburb supplied. Out on the fringe come the garden centres and farm shops, Gatcombe at Long Ashton with its own butchery, Easter Compton, and Farrington's towards Bath, plus Little Dobbies tucked into Clifton itself. Behind every till stands a member of staff who is the public face of the shop, and these are family-run independents, not national chains."], "kit_loc": "across the city's high streets, convenience stores and garden centres", "s2_intro": "Whether you run a Bedminster high-street shop, a convenience store, a garden centre or a small group of sites across Bristol"},
 "cardiff": {"region": "Cardiff and South Wales", "nearby": ["Newport", "Barry", "Caerphilly"], "snapshot": "iNeedWorkwear supplies embroidered polos, tabards, fleeces, safety shoes, hi-vis and stockroom trousers to independent retailers, convenience stores, garden centres and farm shops across Cardiff, from the Victorian arcades and Cardiff Central Market to the suburban high streets, branded in-house with the shop name on a managed trade account, with artwork and sizes held on file so new starters and second stores are kitted in exactly the same uniform.", "s1_head": "Kitting the shops behind Cardiff's arcades and high streets", "s1loc": ["Known as the City of Arcades, Cardiff holds the highest concentration of Victorian and Edwardian shopping arcades in Britain, and beyond the chains in the centre these are where the independents trade. The Castle Quarter arcades, High Street, Duke Street and Castle, sit alongside the Royal Arcade of 1858, the Morgan Arcade with Spillers, the oldest record shop in the world, and the Wyndham Arcade running between St Mary Street and Mill Lane, all full of family-run boutiques, jewellers, record and craft shops. A few steps away under its great glass roof, Cardiff Central Market has run since 1891 on independent traders, butchers, grocers, delis and stalls, some at the same pitch for generations.", "Out from the centre, the neighbourhood high streets carry the everyday independents: Wellfield Road in Roath with its cafes, boutiques and professional services, Whitchurch Village to the north, and the parades of Canton, Pontcanna and Penarth, all leaning on family-run shops and convenience stores. The Vale of Glamorgan fringe adds farm shops and garden centres such as Pugh's with its Farmers Pantry butchers, plus the Roath and Riverside farmers' markets. Across every one of these, the person serving is the face of the shop, and they are run by local owners rather than national chains."], "kit_loc": "across the city's high streets, convenience stores and garden centres", "s2_intro": "Whether you run a Wellfield Road high-street shop, a convenience store, a garden centre or a small group of sites across Cardiff"},
 "leicester": {"region": "Leicester and Leicestershire", "nearby": ["Loughborough", "Hinckley", "Coalville"], "snapshot": "iNeedWorkwear supplies embroidered polos, tabards, fleeces, safety shoes, hi-vis and stockroom trousers to independent retailers, convenience stores, garden centres and farm shops across Leicester, from Leicester Market and the Lanes to the suburban high streets, branded in-house with the shop name on a managed trade account, with artwork and sizes held on file so new starters and second stores are kitted in exactly the same uniform.", "s1_head": "Kitting the independents across Leicester's markets and lanes", "s1loc": ["A long-standing market city, Leicester is built around one of the largest outdoor covered markets in Europe, where hundreds of stalls of fruit and veg, flowers, fish and clothing keep independent traders front and centre. Around it, the cobbled medieval Lanes and St Martin's Square hold a dense run of independent shops, boutiques, tearooms and historic pubs near the Cathedral and the Clock Tower, while the Golden Mile along Belgrave Road is a bazaar of family-run jewellers, sari boutiques and gemstone emporiums famous well beyond the city.", "Heading out of the centre, the suburban high streets do the daily trade: Queens Road and Francis Street in Clarendon Park, voted one of the trendiest neighbourhoods in the country, line up butchers, bike shops, gift shops, delis and drinks specialists alongside the convenience stores that anchor every parade. The Leicestershire fringe brings garden centres such as Palmers and a strong run of farm shops like Stonehurst Farm at Mountsorrel with its own bakery. In each of these the counter staff are what customers see first, and the businesses behind them are local independents, not chains run from a head office."], "kit_loc": "across the city's high streets, convenience stores and garden centres", "s2_intro": "Whether you run a Clarendon Park high-street shop, a convenience store, a garden centre or a small group of sites across Leicester"},
 "bradford": {"region": "Bradford and West Yorkshire", "nearby": ["Halifax", "Keighley", "Shipley"], "snapshot": "iNeedWorkwear supplies embroidered polos, tabards, fleeces, safety shoes, hi-vis and stockroom trousers to independent retailers, convenience stores, garden centres and farm shops across Bradford, from Kirkgate Market and the Oastler Centre to the suburban high streets, branded in-house with the shop name on a managed trade account, with artwork and sizes held on file so new starters and second stores are kitted in exactly the same uniform.", "s1_head": "Kitting the shops on Bradford's markets and village streets", "s1loc": ["Set among the textile warehouses that made it, Bradford runs its independent retail through its markets and its old commercial quarter. Kirkgate Market is home to dozens of independent businesses selling everything from jewellery and books to bacon, with tailoring, alterations and repairs alongside, while the neighbouring Oastler Centre is the foodie heart of the city, packed with independent butchers, delis, cheese, fish and global produce stalls. A short walk away, Little Germany, the Victorian merchant district of imposing former wool warehouses dating from 1855, still holds more than a hundred working businesses.", "Out in the wards the village high streets take over: Idle, Thornton, Thackley and Eccleshill with their parades of family-run shops and convenience stores, and Saltaire, the UNESCO model village by Shipley, where Salts Mill houses independent bookshops, homeware and specialist retailers like All Terrain Cycles. The West Yorkshire fringe fills out with farm shops and garden centres, among them Robertshaw's at Thornton, backing over 400 local suppliers with its own garden centre and cafe, and Woodbank near Bingley. Every one of these keeps staff in front of customers in branded kit, and all of them are local independents rather than chains."], "kit_loc": "across the district's high streets, convenience stores and garden centres", "s2_intro": "Whether you run an Idle high-street shop, a convenience store, a garden centre or a small group of sites across Bradford"},
}
