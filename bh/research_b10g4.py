NEW = {
 ...
 "bromborough": {
  ...
  "s1loc": [
   ...
   "And the trade here is almost entirely small and independent. The Allport Lane hair salons, the village barbers and aesthetics rooms, the nail and brow studios off the green, and the mobile beauticians driving between Bromborough, Eastham, Bromborough Pool and Spital are nearly all sole traders or small teams rather than chains. Almost every one of them puts staff in front of clients in something branded, and on a Wirral village parade a neat, named uniform is part of how a salon holds its regulars.",
  ],
  "kit_loc": "across the village salons, barber chairs and treatment rooms",
