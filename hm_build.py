...
TOWNS = {
 ...
 "cramlington": {
  ...
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Cramlington's highway maintenance teams and roadworks contractors, from Northumberland County Council's in-house highways service to National Highways work on the A1 and A19, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Cramlington area's roads running",
  "s1loc":[
   "Cramlington is a planned 1960s new town built around the A189 South East Northumberland Spine Road, a dual carriageway running some twenty-one miles north from the Tyne and Wear boundary and threading directly past the town. Northumberland County Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that spine and the streets laid out in the new-town era.",
   "The council delivers highways largely in house through its own direct workforce and depots, recruiting skilled operatives across south-east Northumberland for resurfacing, cyclic maintenance, lighting and pothole repair, with regional strategy coordinated by the North East Mayoral Combined Authority. The Nelson and Bassington industrial estates make the town a major employment zone driving heavy goods traffic.",
   "National Highways carries the A1 to the west and the A19 to the east, while the A189 Spine Road links the town to both and to the Port of Blyth and the A1068 serves the area, with recent collaborative Spine Road programmes covering resurfacing and safety technology. Trunk-adjacent and new-town distributor work alike mean fast roads and tight management.",
   "Surfacing, lining, drainage, lighting and winter gritting are all handled by Cramlington crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, spine-road and winter-maintenance work",
  "s2_intro":"Across Cramlington's Northumberland carriageway work and the National Highways A1 and A19",
 },
 "blyth": {
  "region":"Blyth and Northumberland",
  "nearby":["Cramlington","Bedlington","Ashington"],
  "snapshot":"iNeedWorkwear kits Blyth's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Northumberland County Council's in-house highways service to the A189 Spine Road and the Port of Blyth, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Blyth area's roads running",
  "s1loc":[
   "Blyth combines a working port with a fast-growing offshore-energy supply base, its quaysides, the Northumberland Energy Park and the new Cambois Dock moving large wind-sector components onto the surrounding roads. Northumberland County Council is the unitary highway authority, and its gangs work in Class 3 hi-vis beside that project-cargo traffic.",
   "The council delivers highways largely in house, recruiting skilled operatives for the Blyth area and running its own depots and reactive and planned maintenance, with regional transport coordinated by the North East Mayoral Combined Authority. Abnormal loads and heavy logistics feed onto the A189 and A193 from the energy sites.",
   "National Highways carries the nearby A1 and A19 trunk roads, while the A189 Spine Road provides Blyth's direct link to them and the A193 acts as the key local distributor through Bebside, with recent overnight closures for drainage works and the new Blyth Bebside station footbridge. Port-access and distributor work alike mean fast roads and abnormal-load planning.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Blyth crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, port-access and winter-maintenance work",
  "s2_intro":"Across Blyth's Northumberland carriageway work and the A189 Spine Road",
 },
 "north shields": {
  "region":"North Shields and North Tyneside",
  "nearby":["Whitley Bay","Tynemouth","Newcastle upon Tyne"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to North Shields highway maintenance teams and roadworks contractors, from North Tyneside Council's Capita partnership to National Highways work on the A19 and the Tyne Tunnel, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the North Shields area's roads running",
  "s1loc":[
   "North Shields is defined by the Tyne Tunnel river crossing and its historic Fish Quay, with the A19 diving under the Tyne and the A1058 Coast Road meeting it at the Silverlink interchange. North Tyneside Council is the highway authority, and its gangs work in Class 3 hi-vis around that estuary-crossing corridor.",
   "The council maintains its network through a long-standing technical-services partnership with Capita, entered in 2012, delivering the annual resurfacing and maintenance programme through reactive and planned works, with regional transport and the Metro coordinated by the North East Mayoral Combined Authority. The Silverlink area is a major retail and employment hub at the A19 and A1058 junction.",
   "National Highways operates the A19 through the borough and the Tyne Tunnel, and rebuilt the Silverlink junction as the North East's first three-level stack interchange completed in 2019, while the A1058 Coast Road is the major east-west route. Trunk-crossing and interchange work alike mean fast roads and major structures.",
   "Surfacing, lining, drainage, lighting and winter gritting are all handled by North Shields crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, tunnel-corridor and winter-maintenance work",
  "s2_intro":"Across North Shields Capita carriageway work and the National Highways A19 and A1058",
 },
 "whitley bay": {
  "region":"Whitley Bay and North Tyneside",
  "nearby":["North Shields","Tynemouth","Newcastle upon Tyne"],
  "snapshot":"iNeedWorkwear kits Whitley Bay's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from North Tyneside Council's Capita partnership to the A1058 Coast Road and the seafront route, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Whitley Bay area's roads running",
  "s1loc":[
   "Whitley Bay is a coastal town whose seafront regeneration, from the restored Spanish City dome to the Seafront Master Plan between St Mary's Lighthouse and Cullercoats, defines much of its highways work. North Tyneside Council is the highway authority, and its gangs work in Class 3 hi-vis along the coast and town-centre routes.",
   "The council maintains its network through the technical-services partnership with Capita running since 2012, delivering the annual resurfacing programme, with the multi-phase Seafront Sustainable Route driving resurfacing of roads and footpaths and traffic management along the coastal corridor. Regional transport is coordinated by the North East Mayoral Combined Authority.",
   "National Highways carries the A19 and the A1058 Coast Road meeting at Silverlink for the town's strategic links, while the A191 and A1148 are the principal local distributors and the A193 runs along the seafront, with recent traffic-calming on The Links. Coastal and distributor work alike mean exposed conditions and seafront schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Whitley Bay crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, seafront and winter-maintenance work",
  "s2_intro":"Across Whitley Bay's Capita carriageway work and the A1058 Coast Road",
 },
 "chester-le-street": {
  "region":"Chester-le-Street and County Durham",
  "nearby":["Stanley","Washington","Houghton le Spring"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Chester-le-Street's highway maintenance teams and roadworks contractors, from Durham County Council to National Highways work on the A1(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Chester-le-Street area's roads running",
  "s1loc":[
   "Chester-le-Street sits on the A1(M) and the A167 Great North Road, with the Riverside cricket ground beside the River Wear just off the A1 drawing seasonal match-day traffic. Durham County Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that motorway-and-Great-North-Road corridor.",
   "The council manages the county's roadworks, closures and improvement schemes through its own delivery arrangements, publishing its roadworks map and traffic information, and is a constituent member of the North East Mayoral Combined Authority. Recent A167 upgrade works have featured in the local programme.",
   "National Highways operates the A1(M) immediately past the town as the defining strategic route, while the A167 runs through as the main local distributor paralleling the motorway and the A693 heads west toward Stanley and Consett. Motorway and Great-North-Road work alike mean fast roads and busy junctions.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Chester-le-Street crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, Great-North-Road and winter-maintenance work",
  "s2_intro":"Across Chester-le-Street's Durham carriageway work and the National Highways A1(M)",
 },
 "houghton le spring": {
  "region":"Houghton le Spring and Wearside",
  "nearby":["Sunderland","Washington","Chester-le-Street"],
  "snapshot":"iNeedWorkwear kits Houghton le Spring highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Sunderland City Council and its surfacing contractor to National Highways work on the A19, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Houghton le Spring area's roads running",
  "s1loc":[
   "Houghton le Spring is a former coal-mining town in the Durham and Wearside coalfield, where the A690 Durham Road runs through the Houghton Cut, a deep rock cutting through the Magnesian Limestone escarpment. Sunderland City Council is the metropolitan highway authority, and its gangs work in Class 3 hi-vis along that escarpment route in the council's Coalfield area.",
   "Resurfacing and structural works are delivered through the council's Highway Operations Section with its long-standing surfacing contractor Northumbrian Roads under a rolling Highway Maintenance Programme. The Rainton Bridge and Houghton industrial estates serve the wider coalfield towns.",
   "National Highways carries the A19 trunk dual carriageway to the east, meeting the A690 at the Herrington interchange, while the council-managed A690 Durham Road is the principal east-west artery toward Sunderland and Durham. Trunk and escarpment-route work alike mean fast roads and rock-cutting structures.",
   "Surfacing, lining, drainage, lighting and winter gritting put Houghton crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, coalfield-route and winter-maintenance work",
  "s2_intro":"Across Houghton le Spring's Sunderland carriageway work and the National Highways A19 and A690",
 },
 "redcar": {
  "region":"Redcar and Teesside",
  "nearby":["Middlesbrough","Guisborough","Stockton-on-Tees"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Redcar's highway maintenance teams and roadworks contractors, from Redcar and Cleveland Council to the A174 Parkway and the South Tees freeport, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Redcar area's roads running",
  "s1loc":[
   "Redcar is defined by the A174 coastal corridor and the vast South Tees and Teesworks regeneration of the former steelworks land, now a flagship Teesside Freeport and advanced-manufacturing site. Redcar and Cleveland Borough Council is the unitary highway authority, and its gangs work in Class 3 hi-vis beside that heavy plant and abnormal-load activity.",
   "The council delivers highways through its own service and contractor frameworks, with investment supported by the wider Tees Valley transport package approved in 2024. Ongoing demolition and construction on the South Tees site make roadworks and hi-vis a constant on the surrounding network.",
   "National Highways operates the wider A66 and A19 trunk corridor, while the council-managed A174 Parkway is the main east-west route, the A1085 serves Redcar and the South Tees area and the A1053 carries access toward Teesport. Coastal-corridor and industrial-access work alike mean fast roads and very heavy freight.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Redcar crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, industrial-access and winter-maintenance work",
  "s2_intro":"Across Redcar's council carriageway work and the A174 Parkway and South Tees network",
 },
 "glenrothes": {
  "region":"Glenrothes and Fife",
  "nearby":["Kirkcaldy","Dunfermline","Perth"],
  "snapshot":"iNeedWorkwear kits Glenrothes highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Fife Council to Transport Scotland trunk roads on the M90 and A92, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Glenrothes area's roads running",
  "s1loc":[
   "Glenrothes is a post-war Scottish new town with a deliberately planned road layout, famous for its extensive roundabout network used in place of traffic signals to keep distributor traffic flowing. Fife Council is the unitary roads authority, and its gangs work in Class 3 hi-vis across that roundabout-and-distributor network.",
   "The council delivers local roads through its own service, running a Glenrothes Area Roads Programme with around one and a third million pounds allocated for the 2026-27 area programme. The town's extensive industrial estates developed to the south are served by dual-carriageway A92 access into the central Scotland network.",
   "In Scotland trunk roads are Transport Scotland's responsibility, with BEAR Scotland operating the M90 and A92 in the east-central unit, the A92 a trunk dual carriageway running past the town toward Dundee and the A911 the council route east-west through it. New-town distributor and trunk work alike mean fast roads and careful management.",
   "Surfacing, lining, drainage, lighting and winter gritting put Glenrothes crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the new town's carriageway, distributor-road and winter-maintenance work",
  "s2_intro":"Across Glenrothes Fife Council carriageway work and the Transport Scotland M90 and A92",
 },
 "falkirk": {
  "region":"Falkirk and central Scotland",
  "nearby":["Cumbernauld","Alloa","Bathgate"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Falkirk's highway maintenance teams and roadworks contractors, from Falkirk Council to Transport Scotland trunk roads on the M9 and M876, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Falkirk area's roads running",
  "s1loc":[
   "Falkirk sits at a major motorway crossroads in the Forth Valley, where the M9, the M876 link and the A9 and A803 corridors meet, with the Kelpies sculptures standing right beside the M9 in the Helix park. Falkirk Council is the unitary roads authority, and its gangs work in Class 3 hi-vis across that motorway-junction network.",
   "The council delivers local roads through its own roads service, while the dominant industrial geography is Grangemouth to the east, Scotland's largest petrochemical and refinery complex with its port, generating heavy freight and abnormal loads. The Helix project even involved re-routing high-pressure oil pipelines feeding the refinery.",
   "In Scotland trunk roads are Transport Scotland's responsibility, with BEAR Scotland operating the M9, M876 and A9 in the east-central unit, and significant bridge structures around Falkirk driving major maintenance closures. Motorway and refinery-corridor work alike mean fast roads and heavy industrial traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Falkirk crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, motorway-junction and winter-maintenance work",
  "s2_intro":"Across Falkirk's council carriageway work and the Transport Scotland M9 and M876",
 },
 "airdrie": {
  "region":"Airdrie and the Lanarkshire corridor",
  "nearby":["Coatbridge","Motherwell","Bellshill"],
  "snapshot":"iNeedWorkwear kits Airdrie's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from North Lanarkshire Council's Amey partnership to Transport Scotland trunk roads on the M8, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Airdrie area's roads running",
  "s1loc":[
   "Airdrie sits in the dense Lanarkshire corridor between Glasgow and the central belt, a heavily trafficked belt of motorway, freight logistics and former industrial towns. North Lanarkshire Council is the unitary roads authority, and its gangs work in Class 3 hi-vis across that corridor with the Eurocentral freight park nearby on the A8 and M8.",
   "Distinctively, the council has delivered local road maintenance for many years through a long-running partnership with Amey, separate from the trunk-road contracts, so Amey hi-vis is prominent on local Airdrie streets as well as the motorway. The A89 and A73 are the principal council A-roads through the corridor.",
   "In Scotland trunk roads are Transport Scotland's responsibility, with the M8 Glasgow-to-Edinburgh corridor maintained in the south-west unit also operated by Amey, including the upgraded M8, M73 and M74 sections. Local-roads and trunk work alike mean a dual Amey presence and fast, freight-heavy roads.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Airdrie crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, logistics-corridor and winter-maintenance work",
  "s2_intro":"Across Airdrie's North Lanarkshire and Amey carriageway work and the Transport Scotland M8",
 },
 "leyland": {
  "region":"Leyland and Lancashire",
  "nearby":["Preston","Chorley","Skelmersdale"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Leyland's highway maintenance teams and roadworks contractors, from Lancashire County Council to National Highways work on the M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Leyland area's roads running",
  "s1loc":[
   "Leyland is defined by its Leyland Motors and Leyland Trucks heritage, with truck-building still carried on here beside the M6 that serves it. Lancashire County Council is the highway authority for around four thousand six hundred miles of road, and its gangs work in Class 3 hi-vis across the South Ribble network.",
   "The county has moved to a single managed-service term maintenance provider in recent years, keeping in-house teams for urgent defects and guaranteeing larger repairs for twelve months. The A582 South Ribble Western Distributor is the subject of a major upgrade of around seventy-seven million pounds, with junction works and the wider Penwortham bypass scheme, and employment sites cluster at Cuerden near the M6 and M65.",
   "National Highways operates the M6 just east of the town at junction 28, while the council-managed A582 links the M65 toward Penwortham and Preston and the A6 runs through the area. Motorway and distributor work alike mean fast roads and major junction schemes.",
   "Surfacing, lining, drainage, lighting and winter gritting are all handled by Leyland crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, distributor-road and winter-maintenance work",
  "s2_intro":"Across Leyland's Lancashire carriageway work and the National Highways M6 and A582",
 },
 "skelmersdale": {
  "region":"Skelmersdale and West Lancashire",
  "nearby":["Ormskirk","Wigan","St Helens"],
  "snapshot":"iNeedWorkwear kits Skelmersdale's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Lancashire County Council to National Highways work on the M58, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Skelmersdale area's roads running",
  "s1loc":[
   "Skelmersdale is a 1960s Lancashire new town built on automobile-era planning, with oversized roundabouts and grade-separated distributor roads and an almost complete absence of traffic lights. Lancashire County Council is the highway authority, and its gangs work in Class 3 hi-vis across that roundabout-and-distributor network.",
   "The county delivers maintenance through a single managed-service term provider working to the council client team, part of the four-thousand-six-hundred-mile network. The town's extensive industrial estates from its new-town build-out, including Stanley, Gillibrands, Pimbo and White Moss, are served directly off the M58.",
   "National Highways operates the M58 along the southern edge linking the M6 to Switch Island near Liverpool, while the A577 is the main east-west arterial through the town toward Ormskirk and Wigan and the A506 a local distributor link. Motorway and new-town distributor work alike mean fast roads and a signal-free road layout.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Skelmersdale crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the new town's carriageway, distributor-road and winter-maintenance work",
  "s2_intro":"Across Skelmersdale's Lancashire carriageway work and the National Highways M58",
 },
 "accrington": {
  "region":"Accrington and Lancashire",
  "nearby":["Blackburn","Burnley","Rawtenstall"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Accrington's highway maintenance teams and roadworks contractors, from Lancashire County Council to National Highways work on the M65 and A56, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Accrington area's roads running",
  "s1loc":[
   "Accrington sits at the heart of the Hyndburn corridor where the M65 and the A56 and A680 meet, an East Lancashire highways crossroads known for NORI brick and the Accrington Pals. Lancashire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that motorway spine and the A-roads off it.",
   "The county delivers maintenance through its single managed-service term provider serving the four-thousand-six-hundred-mile network. Industrial provision around Altham, Whitebirk and the Hyndburn corridor drives the local workload.",
   "National Highways operates the M65 East Lancashire motorway through Hyndburn with junctions serving Accrington and the A56 Haslingden bypass linking south toward the M66, while the A680 connects toward Rochdale, with recent barrier and junction works on the M65 and A56. Motorway and bypass work alike mean fast roads and Pennine exposure.",
   "Surfacing, lining, drainage, lighting and winter gritting are all handled by Accrington crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, Hyndburn-corridor and winter-maintenance work",
  "s2_intro":"Across Accrington's Lancashire carriageway work and the National Highways M65 and A56",
 },
 "denton": {
  "region":"Denton and Greater Manchester",
  "nearby":["Hyde","Ashton-under-Lyne","Stockport"],
  "snapshot":"iNeedWorkwear kits Denton's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Tameside Council to National Highways work on the M60 and M67, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Denton area's roads running",
  "s1loc":[
   "Denton sits at the M60 orbital and M67 interchange, where the M67 begins at the Denton Interchange and runs east as the former Denton Relief Road toward Mottram and the A57 Snake Pass. Tameside Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis under the Transport for Greater Manchester Bee Network.",
   "The council maintains the local network through a mix of in-house teams and framework contractors typical of the Greater Manchester districts, with the Crown Point commercial and retail area around the junction corridor. Structures work has included the M67 St Anne's Road bridge replacement.",
   "National Highways operates the M60 and M67 meeting at the Denton Interchange, with the A57 running through the town itself, the M67 originally built as the 1970s Denton Relief Road to bypass the congested A57. Orbital and relief-road work alike mean fast roads and junction structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Denton crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, interchange and winter-maintenance work",
  "s2_intro":"Across Denton's Tameside carriageway work and the National Highways M60 and M67",
 },
 "port talbot": {
  "region":"Port Talbot and South Wales",
  "nearby":["Neath","Swansea","Bridgend"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Port Talbot's highway maintenance teams and roadworks contractors, from Neath Port Talbot Council to Welsh Government trunk roads on the M4, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Port Talbot area's roads running",
  "s1loc":[
   "Port Talbot is dominated by the Tata steelworks and its deep-water docks, with the elevated M4 viaduct running on tall concrete pillars right over the town between junctions 40 and 41 on a fifty mile per hour limit. Neath Port Talbot County Borough Council is the Welsh unitary highway authority, and its gangs work in Class 3 hi-vis beneath that landmark motorway.",
   "The council maintains local roads and is also the lead authority hosting the South Wales Trunk Road Agent, which runs the strategic network across south Wales for the Welsh Government, so the body maintaining Port Talbot's streets also hosts the trunk-road agent. The A4241 Harbour Way distributor links the M4 to the steelworks and docks.",
   "Trunk roads in Wales are the Welsh Government's responsibility via Traffic Wales and SWTRA, with the M4 through the town served by junction 38 at Margam, junction 40 at Port Talbot and junction 41, and the A48 the old through-route the M4 bypassed. Elevated-motorway and dock-access work alike mean fast roads and major structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Port Talbot crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, dock-access and winter-maintenance work",
  "s2_intro":"Across Port Talbot's council carriageway work and the Welsh Government M4",
 },
 "arnold": {
  "region":"Arnold and Nottinghamshire",
  "nearby":["Nottingham","Carlton","Hucknall"],
  "snapshot":"iNeedWorkwear kits Arnold's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Nottinghamshire County Council's Via East Midlands company to the A60 and A614 corridors, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Arnold area's roads running",
  "s1loc":[
   "Arnold is a large suburb on the northern edge of Nottingham in Gedling borough, strung along the A60 and A614 as the gateway toward Sherwood Forest country. Nottinghamshire County Council is the highway authority, and its gangs work in Class 3 hi-vis on those busy urban arterials and junctions.",
   "The county delivers highways through Via East Midlands, its wholly-owned company since 2019 with profits reinvested in the county, maintaining over four thousand kilometres of road and around ninety-three thousand street lights, and running a Worst First capital programme. The A614 and A6097 Major Road Network scheme between Ollerton and Lowdham is progressing nearby.",
   "National Highways operates the wider trunk network, while the council-managed A60 Mansfield Road runs south into Nottingham and north toward Mansfield, the A614 heads toward Sherwood and Ollerton and the A6097 lies east. Urban-arterial and Major Road Network work alike mean busy roads and junction schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Arnold crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, urban-arterial and winter-maintenance work",
  "s2_intro":"Across Arnold's Via East Midlands carriageway work and the A60 and A614 corridors",
 },
 "long eaton": {
  "region":"Long Eaton and Derbyshire",
  "nearby":["Nottingham","Beeston","Ilkeston"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Long Eaton's highway maintenance teams and roadworks contractors, from Derbyshire County Council's ALLRoads service to National Highways work on the M1, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Long Eaton area's roads running",
  "s1loc":[
   "Long Eaton is an Erewash town known for its furniture and upholstery trade, sitting about a mile from M1 junction 25 where the motorway meets the A52 Brian Clough Way between Derby and Nottingham. Derbyshire County Council is the highway authority for over three thousand five hundred miles of road, and its gangs work in Class 3 hi-vis along that motorway-fed corridor.",
   "The county delivers much of its work in house through ALLRoads, its direct labour organisation with a turnover above twenty million pounds handling construction, reinstatements, drainage and lighting, supplemented by external term contractors. The town lies beside the Toton sidings, once proposed as the East Midlands HS2 hub before the eastern leg was cancelled in 2023, leaving M1 junction 25 the dominant strategic feature.",
   "National Highways operates the M1 at junction 25 nearby, while the council-managed A6005 is the main road through Long Eaton and the A453 runs south toward East Midlands Airport. Motorway and town-route work alike mean fast roads and busy freight interchanges.",
   "Surfacing, lining, drainage, lighting and winter gritting are all handled by Long Eaton crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, motorway-corridor and winter-maintenance work",
  "s2_intro":"Across Long Eaton's Derbyshire ALLRoads carriageway work and the National Highways M1",
 },
 "wednesbury": {
  "region":"Wednesbury and the Black Country",
  "nearby":["West Bromwich","Walsall","Tipton"],
  "snapshot":"iNeedWorkwear kits Wednesbury's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Sandwell Council and the Black Country highways framework to National Highways work on the M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Wednesbury area's roads running",
  "s1loc":[
   "Wednesbury is a core Black Country industrial and logistics town defined by the M6 junction 9 interchange at Bescot, a major and heavily trafficked junction feeding the A461 and the Black Country Route. Sandwell Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis around that interchange and the West Midlands Key Route Network.",
   "Highway improvement and surfacing works are procured through the Black Country framework led by Wolverhampton on behalf of the four boroughs, with Colas among the appointed contractors and a successor framework worth around a hundred and fifty million pounds running from April 2026. Dense distribution and trading estates support the local economy.",
   "National Highways operates the M6 at junction 9, with recurring junction 9 to 10 maintenance, while the A41 Black Country New Road and the A461 are the local strategic routes, and the West Midlands Metro tram serves the town near the Great Western Street depot. Motorway, arterial and tram work alike mean fast roads and close-packed infrastructure.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Wednesbury crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, interchange and winter-maintenance work",
  "s2_intro":"Across Wednesbury's Black Country framework carriageway work and the National Highways M6",
 },
 "coalville": {
  "region":"Coalville and Leicestershire",
  "nearby":["Loughborough","Leicester","Hinckley"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Coalville's highway maintenance teams and roadworks contractors, from Leicestershire County Council's Aggregate Industries patching contract to National Highways work on the M1 and A42, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Coalville area's roads running",
  "s1loc":[
   "Coalville grew around nineteenth-century coal mining and now sits squarely in the East Midlands golden logistics triangle, with the A511 and A42 and M1 junction 22 making it a prime warehousing location on former coalfield land. Leicestershire County Council is the highway authority, and its gangs work in Class 3 hi-vis beside that distribution traffic.",
   "Carriageway patching and pothole repair are delivered under the joint contract with Leicester City awarded to Aggregate Industries, worth up to around forty-seven million pounds, with the company headquartered in the town and supplying from its Bardon Hill and Croft plants. The A511 Major Road Network Growth Corridor scheme is improving around nine locations between the A42 and the A50.",
   "National Highways operates the M1 about two miles east at junction 22 and the M42 and A42 to the north-west, while the council-managed A511 links the two motorways through the town. Motorway-corridor and growth-scheme work alike mean fast roads and heavy logistics traffic.",
   "Surfacing, lining, drainage, lighting and winter gritting are all handled by Coalville crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, logistics-corridor and winter-maintenance work",
  "s2_intro":"Across Coalville's Aggregate Industries carriageway work and the National Highways M1 and A42",
 },
 "warwick": {
  "region":"Warwick and Warwickshire",
  "nearby":["Leamington Spa","Kenilworth","Coventry"],
  "snapshot":"iNeedWorkwear kits Warwick's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Warwickshire County Council's Balfour Beatty contract to National Highways work on the M40, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Warwick area's roads running",
  "s1loc":[
   "Warwick is a historic county town dominated by Warwick Castle, a major tourist draw, sitting on the M40 and the A46 corridor between Coventry and Stratford and adjoining Leamington Spa. Warwickshire County Council is the highway authority, and its gangs work in Class 3 hi-vis balancing a medieval centre against motorway-fed traffic.",
   "The county procures highways jointly with Coventry and Solihull, awarding the seven-year contract to Balfour Beatty Living Places from May 2026 at around three hundred and fifteen million pounds over more than five thousand kilometres of road, using a centralised digital planning model. The A425 Castle Bridge over the Avon has had a heritage repair and restoration programme.",
   "National Highways operates the M40 at junction 15 and the A46 trunk sections toward Coventry and Stratford, with recent A46 Coventry junctions and Stoneleigh works, while the A425 serves Warwick and Leamington locally. Motorway, trunk and heritage-structure work alike mean fast roads and listed-bridge maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Warwick crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, heritage-town and winter-maintenance work",
  "s2_intro":"Across Warwick's Balfour Beatty carriageway work and the National Highways M40 and A46",
 },
 "herne bay": {
  "region":"Herne Bay and Kent",
  "nearby":["Whitstable","Canterbury","Faversham"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Herne Bay's highway maintenance teams and roadworks contractors, from Kent County Council's Ringway term contract to the A299 Thanet Way, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Herne Bay area's roads running",
  "s1loc":[
   "Herne Bay sits on the A299 Thanet Way coastal corridor, the main arterial feeding the north Kent coast and Thanet from the M2 at Brenley Corner. Kent County Council is the highway authority for the roughly five-thousand-four-hundred-mile Kent network, and its gangs work in Class 3 hi-vis on that exposed coastal route.",
   "Kent signed a new twenty-one-year Highways Term Maintenance Contract with Ringway, a Vinci company, taking over from Amey from May 2026 at around fifty million pounds a year, covering potholes, drainage, structures, gritting and emergency response. A high-speed road improvement programme on the A299 has brought overnight closures and a temporary fifty mile per hour restriction, plus a new slip at Strode Farm, with trade activity at Altira Business Park.",
   "National Highways operates the wider motorway network, while the council-managed A299 Thanet Way runs from Brenley Corner past Whitstable and Herne Bay toward Ramsgate and the A291 Canterbury Road links the town south to it. Coastal-corridor and slip-road work alike mean exposed conditions and busy through-traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Herne Bay crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, coastal-corridor and winter-maintenance work",
  "s2_intro":"Across Herne Bay's Ringway carriageway work and the A299 Thanet Way",
 },
 "canvey island": {
  "region":"Canvey Island and Essex",
  "nearby":["Basildon","Southend-on-Sea","Rayleigh"],
  "snapshot":"iNeedWorkwear kits Canvey Island's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Essex County Council's Essex Highways partnership with Ringway Jacobs to the A130 Canvey Way, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Canvey Island area's roads running",
  "s1loc":[
   "Canvey Island is low-lying, with ground levels nearly two metres below daily high tide, protected by around fourteen miles of tidal sea defences rebuilt after the 1953 flood, and connected to the mainland by just two road crossings. Essex County Council is the highway authority, and its gangs work in Class 3 hi-vis on an access-constrained island network.",
   "The council delivers through the Essex Highways integrated partnership with Ringway Jacobs, let in 2012 and extended to 2027 with a successor seven-year contract being procured, maintaining a very large county network. The island's petrochemical and energy infrastructure, including oil and gas storage terminals, sits alongside industrial and wharf areas off the A130.",
   "National Highways operates the motorways and trunk roads, while the council-managed A130 Canvey Way is the primary crossing over East Haven Creek to join the A13 at Sadler's Farm Roundabout and the B1014 is the secondary access, the single effective route carrying around twenty-five thousand vehicles a day. Sea-defence and single-access work alike mean a distinctive resilience-driven profile.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Canvey Island crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the island's carriageway, sea-defence and winter-maintenance work",
  "s2_intro":"Across Canvey Island's Ringway Jacobs carriageway work and the A130 Canvey Way",
 },
 "billericay": {
  "region":"Billericay and Essex",
  "nearby":["Brentwood","Wickford","Basildon"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Billericay's highway maintenance teams and roadworks contractors, from Essex County Council's Essex Highways partnership with Ringway Jacobs to National Highways work on the A12 and A127, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Billericay area's roads running",
  "s1loc":[
   "Billericay is a strong commuter town that grew at the Sun Corner crossroads, with a large share of its workforce travelling to London by train or driving the A127. Essex County Council is the highway authority, and its gangs work in Class 3 hi-vis on roads under peak-time commuter pressure with no direct M25 junction.",
   "The council delivers through the Essex Highways partnership with Ringway Jacobs, let in 2012 and extended to 2027 ahead of a successor seven-year contract, maintaining carriageways, footways and structures across the county. Local employment and trade is served off the A129 and A176 and the wider Basildon industrial areas.",
   "National Highways operates the A12 to the north and the A127 to the south as the nearest primary routes, channelling orbital traffic onto them, while the council-managed A129 links west to Brentwood and east to Wickford and the A176 connects south to Basildon. Commuter-corridor and primary-route work alike mean busy roads and peak-time pressure.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Billericay crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, commuter-corridor and winter-maintenance work",
  "s2_intro":"Across Billericay's Ringway Jacobs carriageway work and the National Highways A12 and A127",
 },
 "erith": {
  "region":"Erith and South East London",
  "nearby":["Woolwich","Sidcup","Dartford"],
  "snapshot":"iNeedWorkwear kits Erith's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from the London Borough of Bexley's FM Conway contract to the A2016 Bronze Age Way, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Erith area's roads running",
  "s1loc":[
   "Erith sits on the Thames riverside, where the A2016 Bronze Age Way spine road and the Belvedere industrial area define its heavy-goods and riverside character. The London Borough of Bexley is the highway authority, and its gangs work in Class 3 hi-vis amid that dock and industrial traffic.",
   "Bexley delivers highway maintenance and civil engineering through term contracts, with FM Conway holding the borough's highway maintenance and minor works contract in recent years and the council procuring boroughwide works in lots, with strategic oversight partly through Transport for London. The Belvedere industrial area at Crabtree Manorway is a major warehousing zone off the A2016.",
   "National Highways operates the motorways and trunk roads and Transport for London the red routes, while the council-managed A2016 Bronze Age Way runs east toward the M25 junction 1a at the Dartford Crossing and west via the A206 toward Woolwich, with the A220 Bexley Road a gateway into the town centre. Spine-road and riverside work alike mean heavy freight and regeneration schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Erith crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, riverside-corridor and winter-maintenance work",
  "s2_intro":"Across Erith's FM Conway carriageway work and the A2016 Bronze Age Way",
 },
 "aldershot": {
  "region":"Aldershot and Hampshire",
  "nearby":["Farnborough","Camberley","Farnham"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Aldershot's highway maintenance teams and roadworks contractors, from Hampshire County Council's M Group Highways contract to National Highways work on the M3 and the A331, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Aldershot area's roads running",
  "s1loc":[
   "Aldershot is the Home of the British Army, with a large garrison footprint shaping local traffic and access, served by the A331 Blackwater Valley Route as its key strategic relief road. Hampshire County Council is the highway authority for one of the largest networks in England, and its gangs work in Class 3 hi-vis around that military town.",
   "Hampshire Highways runs through the partnership with Milestone Infrastructure, now trading as M Group Highways, in place since 2017 and extended to 2029, covering over eight thousand five hundred kilometres of carriageway. Aldershot's employment areas sit within Rushmoor district alongside Farnborough.",
   "National Highways operates the M3 a few miles north around junction 4, while the council-managed A325 runs through the town to the motorway and the A331 Blackwater Valley Route is the north-south dual carriageway east of the town toward Camberley on a fifty mile per hour limit. Motorway and dual-carriageway work alike mean fast roads and garrison access.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Aldershot crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, garrison-route and winter-maintenance work",
  "s2_intro":"Across Aldershot's M Group Highways carriageway work and the National Highways M3 and A331",
 },
 "abingdon": {
  "region":"Abingdon and Oxfordshire",
  "nearby":["Oxford","Didcot","Witney"],
  "snapshot":"iNeedWorkwear kits Abingdon's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Oxfordshire County Council's M Group Highways contract to National Highways work on the A34, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Abingdon area's roads running",
  "s1loc":[
   "Abingdon sits immediately beside the A34 trunk road, the Newbury-Oxford-M40 spine, and carries strong MG car heritage from the works that built cars here until 1980. Oxfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that trunk corridor and the town's Thames crossings.",
   "The county runs its term maintenance through Milestone, now trading as M Group Highways and the long-standing incumbent, which won a new long-term deal worth around eight hundred and forty million pounds from April 2025 over more than four thousand eight hundred kilometres of road. Milton Park and the Harwell campus anchor the Science Vale cluster on the town's southern edge.",
   "National Highways operates the A34 alongside the town linking to the M4 and M40, while the council-managed A415 is the cross route through Abingdon and the A4183 the Oxford Road in, with Thames bridges and A34 grade-separated junctions notable structures. Trunk and town-route work alike mean fast roads and river crossings.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Abingdon crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, trunk-corridor and winter-maintenance work",
  "s2_intro":"Across Abingdon's M Group Highways carriageway work and the National Highways A34",
 },
 "exmouth": {
  "region":"Exmouth and Devon",
  "nearby":["Exeter","Newton Abbot","Tiverton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Exmouth's highway maintenance teams and roadworks contractors, from Devon County Council's term maintenance contract to National Highways work on the M5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Exmouth area's roads running",
  "s1loc":[
   "Exmouth sits at the mouth of the Exe estuary, a seaside resort where the highway network works around the estuary, the Exe Estuary Trail and the single primary A376 access corridor. Devon County Council is the highway authority, and its gangs work in Class 3 hi-vis along that estuary-constrained route in East Devon.",
   "The county maintains its roads under a county term maintenance contract, with the authority having explored future delivery options as it plans a large new maintenance deal toward the end of the decade. The Dinan Way extension scheme has added carriageway linking into the A376, with local employment around the Liverton and Brixington areas.",
   "National Highways operates the M5 to the west near Exeter, with the usual approach via junction 30 and then the A376 south down the east side of the estuary, while the A361 North Devon Link and the A30 and A38 serve the wider region. Estuary-corridor and trunk-access work alike mean tidal conditions and a single primary route.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Exmouth crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, estuary-corridor and winter-maintenance work",
  "s2_intro":"Across Exmouth's Devon carriageway work and the National Highways M5 and A376",
 },
 "amesbury": {
  "region":"Amesbury and Wiltshire",
  "nearby":["Salisbury","Andover","Trowbridge"],
  "snapshot":"iNeedWorkwear kits Amesbury's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Wiltshire Council's M Group Highways contract to National Highways work on the A303, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Amesbury area's roads running",
  "s1loc":[
   "Amesbury sits on the A303 right by Stonehenge and Woodhenge within the World Heritage Site, so the trunk road and heritage constraints dominate the local highways picture. Wiltshire Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that heritage corridor on Salisbury Plain.",
   "The council runs its highways through Milestone, now trading as M Group Highways, on a five-year contract worth around eighty million pounds from April 2023 with an option to 2032, covering carriageways, bridges, drainage, lighting and gritting plus the Parish Stewards. Solstice Park business park sits beside the A303 and the surrounding army garrison estate generates heavy military traffic.",
   "National Highways operates the A303 trunk road past the town, the long-running Stonehenge tunnel scheme now cancelled, while the council-managed A345 runs north to Marlborough and the A360 toward Devizes across the Plain. Trunk and garrison-route work alike mean fast roads and heritage-sensitive sites.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Amesbury crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, heritage-corridor and winter-maintenance work",
  "s2_intro":"Across Amesbury's M Group Highways carriageway work and the National Highways A303",
 },
 "hitchin": {
  "region":"Hitchin and Hertfordshire",
  "nearby":["Letchworth","Stevenage","Luton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Hitchin's highway maintenance teams and roadworks contractors, from Hertfordshire County Council's Ringway contract to National Highways work on the A1(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Hitchin area's roads running",
  "s1loc":[
   "Hitchin is a historic market town on the River Hiz at the edge of the Chilterns, its tight medieval centre feeding the nearby A1(M) and M1. Hertfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis threading that old town and the arterial routes off it.",
   "Hertfordshire retained Ringway, part of Vinci, as its term maintenance contractor on the new deal from October 2025, continuous since 2012, covering potholes, lighting, signals, gritting and improvement schemes. The Wilbury industrial estate and sites along the A505 anchor local employment.",
   "National Highways operates the A1(M) about three miles east at junctions 7 to 9 and the M1 around ten miles west, while the council-managed A505 is the key east-west corridor toward Letchworth and Luton and the A602 the north-south arterial to Stevenage. Motorway-adjacent and market-town work alike mean fast roads and constrained centres.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Hitchin crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, market-town and winter-maintenance work",
  "s2_intro":"Across Hitchin's Ringway carriageway work and the National Highways A1(M)",
 },
 "dunstable": {
  "region":"Dunstable and Bedfordshire",
  "nearby":["Luton","Hemel Hempstead","Bedford"],
  "snapshot":"iNeedWorkwear kits Dunstable's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Central Bedfordshire Council's M Group Highways contract to National Highways work on the A5 and the A5-M1 Link, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Dunstable area's roads running",
  "s1loc":[
   "Dunstable sits on the A5, the historic Roman Watling Street, at the foot of the Dunstable Downs chalk escarpment, with the A5-M1 Link reshaping access to the north of the town. Central Bedfordshire Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that Roman road and the new link routes.",
   "The council runs its highways through Milestone, now trading as M Group Highways, on a term service contract worth up to around two hundred and fifty million pounds from April 2023, taking over from Ringway Jacobs and covering roads, rights of way, drainage, structures, lighting and winter service. Major logistics estates cluster at Houghton Regis and the Thorn Turn and Woodside areas served by the new link roads.",
   "National Highways operates the A5 through the town and the M1 at junctions 11 and 11a, with the A5-M1 Link dual carriageway connecting the A5 at Thorn Turn to the new junction 11a and the Woodside Link feeding the industrial estates, both opened in 2017. Trunk and link-road work alike mean fast roads and escarpment constraints.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Dunstable crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, link-road and winter-maintenance work",
  "s2_intro":"Across Dunstable's M Group Highways carriageway work and the National Highways A5 and M1",
 },
 "wickford": {
  "region":"Wickford and Essex",
  "nearby":["Basildon","Billericay","Rayleigh"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Wickford's highway maintenance teams and roadworks contractors, from Essex County Council's Essex Highways partnership with Ringway Jacobs to the A127 Southend arterial, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Wickford area's roads running",
  "s1loc":[
   "Wickford sits on the A127 Southend arterial corridor and on the commuter rail line into London Liverpool Street, a commuter and arterial-road town where works around the A127 and the station are recurring. Essex County Council is the highway authority, and its gangs work in Class 3 hi-vis along that busy east-west route.",
   "The council delivers through the Essex Highways integrated partnership with Ringway Jacobs, in place since 2012 and extended to 2027 with a large successor contract being procured, managing over five thousand miles of highway and a quarter of a million street lights. The Russell Gardens and Ivanhurst industrial estates on Woodham Road support the local supply chain.",
   "The A127 Southend Arterial Road is managed locally within Essex rather than by National Highways, with the A132 connecting it into Wickford, the A129 Southend Road running toward Rayleigh and the A130 dual carriageway to the west. Arterial and commuter-town work alike mean busy roads and station-area schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Wickford crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, arterial-corridor and winter-maintenance work",
  "s2_intro":"Across Wickford's Ringway Jacobs carriageway work and the A127 Southend arterial",
 },
 "bridlington": {
  "region":"Bridlington and the East Riding",
  "nearby":["Beverley","Scarborough","Hull"],
  "snapshot":"iNeedWorkwear kits Bridlington's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from East Riding of Yorkshire Council's in-house highways service to the A165 coast road, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bridlington area's roads running",
  "s1loc":[
   "Bridlington is a working harbour town and one of the Yorkshire coast's principal seaside resorts, noted for its shellfish and lobster landings, with the A165 as the main coast road. East Riding of Yorkshire Council is the unitary highway authority for around two thousand two hundred miles of road, and its gangs work in Class 3 hi-vis along that resort seafront.",
   "The council maintains its large rural-and-coastal network substantially in house through its own operations, supported by term and surfacing framework contractors. Coastal drainage, sea-defence-adjacent carriageway and seafront structures are notable maintenance features, with the Bessingby industrial estate serving plant and contractor activity.",
   "National Highways operates the wider strategic trunk network, while Bridlington sits on council-managed principal roads, the A165 coast road running Hull to Scarborough through the resort, the A614 heading inland toward Howden and the A166 the York-direction corridor. Coastal-resort and inland-route work alike mean seasonal traffic and exposed conditions.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Bridlington crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the resort's carriageway, coast-road and winter-maintenance work",
  "s2_intro":"Across Bridlington's East Riding carriageway work and the A165 coast road",
 },
 "beverley": {
  "region":"Beverley and the East Riding",
  "nearby":["Bridlington","Hull","Cottingham"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Beverley's highway maintenance teams and roadworks contractors, from East Riding of Yorkshire Council's in-house highways service to the A1079 and A164, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Beverley area's roads running",
  "s1loc":[
   "Beverley is the historic county town of the East Riding, dominated by Beverley Minster, its medieval street pattern and bars, and the racecourse on the common at the town's edge. East Riding of Yorkshire Council is the unitary highway authority and is seated in the town, and its gangs work in Class 3 hi-vis through that conservation-area townscape.",
   "The council maintains its large network substantially in house with term and surfacing framework support, the conservation streets and the racecourse common shaping sensitive urban maintenance. Established industrial and commercial estates support plant and materials for resurfacing schemes.",
   "National Highways operates the wider trunk network, while the council-managed A1079 York-to-Hull route passes close to the town, the A164 Humber Bridge-to-Bridlington route serves it from the south and the A1035 links into the centre. Through-route and market-town work alike mean busy roads and heritage-sensitive sites.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Beverley crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the county town's carriageway, market-town and winter-maintenance work",
  "s2_intro":"Across Beverley's East Riding carriageway work and the A1079 and A164",
 },
 "dover": {
  "region":"Dover and Kent",
  "nearby":["Deal","Folkestone","Canterbury"],
  "snapshot":"iNeedWorkwear kits Dover's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Kent County Council's Ringway term contract to National Highways work on the A2 and A20 and the Port of Dover, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Dover area's roads running",
  "s1loc":[
   "Dover is dominated by the Port of Dover ferry traffic and the freight management it demands, where the A2 and A20 converge to feed the Eastern Docks. Kent County Council is the highway authority for the roughly five-thousand-four-hundred-mile Kent network, and its gangs work in Class 3 hi-vis amid heavy, slow-moving HGV traffic.",
   "Kent signed a new twenty-one-year Highways Term Maintenance Contract with Ringway, a Vinci subsidiary, taking over from Amey from May 2026 at around fifty million pounds a year, covering potholes, gritting, drainage, structures and emergency response. White Cliffs Business Park at Whitfield and the dock estate anchor local trade.",
   "National Highways operates the A2 from Canterbury and the M2 and the A20 coastal trunk route from the M20, both feeding the port, with Dover TAP queuing port-bound lorries in the nearside A20 lane after the Roundhill tunnel at forty miles per hour and Operation Brock behind it on the M20. Trunk and port-access work alike mean frequent live-carriageway operations.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Dover crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, port-access and winter-maintenance work",
  "s2_intro":"Across Dover's Ringway carriageway work and the National Highways A2 and A20",
 },
 "morecambe": {
  "region":"Morecambe and Lancashire",
  "nearby":["Lancaster","Fleetwood","Kendal"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Morecambe's highway maintenance teams and roadworks contractors, from Lancashire County Council to National Highways work on the M6 and the Bay Gateway, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Morecambe area's roads running",
  "s1loc":[
   "Morecambe's strategic connectivity hinges on the A683 Bay Gateway link to the M6, and the town is the site of the planned Eden Project Morecambe with main construction beginning in recent years. Lancashire County Council is the highway authority for around four thousand six hundred miles of road, and its gangs work in Class 3 hi-vis along the bay.",
   "The county runs an in-house highways management service supported by term framework providers for cyclic and construction work and a long-standing professional-services framework with Jacobs for design and drainage. The Heysham port and energy estates and White Lund in Morecambe drive the local workload.",
   "National Highways operates the M6 with junction 34 remodelled as part of the Bay Gateway, the A683 dual carriageway opened in 2016 linking the Heysham peninsula, the port and the nuclear stations to the motorway with a multi-span bridge over the Lune, while the A589 serves the town. Motorway and link-road work alike mean fast roads and major structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Morecambe crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, link-road and winter-maintenance work",
  "s2_intro":"Across Morecambe's Lancashire carriageway work and the National Highways M6 and A683",
 },
 "trowbridge": {
  "region":"Trowbridge and Wiltshire",
  "nearby":["Melksham","Chippenham","Frome"],
  "snapshot":"iNeedWorkwear kits Trowbridge's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Wiltshire Council's M Group Highways contract to the A350 corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Trowbridge area's roads running",
  "s1loc":[
   "Trowbridge is the county town of Wiltshire and seat of the unitary council, sitting on the A350 corridor, the county's strategic north-south spine. Wiltshire Council is the highway authority, and its gangs work in Class 3 hi-vis combining civic-centre status with significant local resurfacing activity.",
   "The council runs its highways through Milestone, now trading as M Group Highways, on a contract from April 2023 with a potential five-year extension, covering carriageways, bridges, gully and drainage cleaning, lighting, gritting and the Parish Stewards. Recent works around Spitfire Retail Park and the White Horse Business Park have featured on the A363.",
   "Wiltshire is a unitary authority so most routes are locally managed, with National Highways operating the M4 to the north, while the A350 passes near the town via Melksham toward Westbury and Chippenham, the A361 crosses to Devizes and the A363 runs through Trowbridge itself. County-spine and town-route work alike mean busy roads and steady resurfacing.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Trowbridge crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the county town's carriageway, A350-corridor and winter-maintenance work",
  "s2_intro":"Across Trowbridge's M Group Highways carriageway work and the A350 corridor",
 },
 "barnstaple": {
  "region":"Barnstaple and North Devon",
  "nearby":["Bideford","Exeter","Tiverton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Barnstaple's highway maintenance teams and roadworks contractors, from Devon County Council to National Highways work on the A361 North Devon Link Road, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Barnstaple area's roads running",
  "s1loc":[
   "Barnstaple is shaped by the A361 North Devon Link Road and the River Taw estuary, the Western Bypass having carried the A361 over the Taw on a downstream bridge to relieve the town centre. Devon County Council is the highway authority, one of the larger shire authorities, and its gangs work in Class 3 hi-vis along that link-road corridor.",
   "The county maintains the network through its highways service with major term and framework contractors for resurfacing and capital schemes, having delivered A361 junction upgrades and overtaking lanes between South Molton and Portmore under a roughly sixty-seven-million-pound improvement programme. The Pottington and Roundswell business parks anchor local employment.",
   "National Highways supports the trunk corridor, with the A361 North Devon Link Road and the A39 forming the route from M5 junction 27 at Tiverton through to the Barnstaple area, the four-hundred-and-nine-metre five-span Taw Bridge a key structure. Link-road and estuary work alike mean fast roads and major river crossings.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Barnstaple crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, link-road and winter-maintenance work",
  "s2_intro":"Across Barnstaple's Devon carriageway work and the A361 North Devon Link Road",
 },
 "sidcup": {
  "region":"Sidcup and South East London",
  "nearby":["Bromley","Orpington","Erith"],
  "snapshot":"iNeedWorkwear kits Sidcup's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from the London Borough of Bexley's FM Conway contract to the Transport for London A20 Sidcup Bypass, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Sidcup area's roads running",
  "s1loc":[
   "Sidcup is defined by the A20 Sidcup Bypass, an early arterial bypass in south-east London later upgraded in the Channel Tunnel era, carrying heavy commuter and Kent-bound traffic through Frognal and Crittall's Corner. The London Borough of Bexley is the highway authority, and its gangs work in Class 3 hi-vis along that arterial and the town centre.",
   "Bexley delivers its highway maintenance and civil engineering through a term contract with FM Conway, which uses its own recycled and manufactured highway materials from its London plants, while strategic red routes are Transport for London's. Foots Cray and the Sidcup and Blackfen industrial pockets serve the local supply chain.",
   "Transport for London manages the A20 Sidcup Bypass red route past the town crossing the A222 at Frognal Corner and the A224 at Crittall's Corner, while the council-managed A211 is Sidcup High Street and the A222 connects through the area. Red-route and high-street work alike mean fast roads and town-centre footway schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Sidcup crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bypass-corridor and winter-maintenance work",
  "s2_intro":"Across Sidcup's FM Conway carriageway work and the TfL A20 Sidcup Bypass",
 },
 "hyde": {
  "region":"Hyde and Greater Manchester",
  "nearby":["Denton","Stalybridge","Ashton-under-Lyne"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Hyde's highway maintenance teams and roadworks contractors, from Tameside Council to National Highways work on the M67, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Hyde area's roads running",
  "s1loc":[
   "Hyde sits on the M67, originally built as the Denton-to-Mottram relief route to take through traffic off the old A57 high streets, with the eastern end at Mottram a long-standing congestion pinch point. Tameside Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis under the Transport for Greater Manchester Bee Network.",
   "The council maintains the local network in house with support from a multi-lot maintenance framework, and in recent years has been establishing a Greater Manchester highways framework on behalf of the AGMA councils. Hyde's industrial estates off the M67 corridor feed the M67 and M60 junctions.",
   "National Highways operates the M67 from junction 24 of the M60 near Denton eastward to the A57 at Mottram, with the related Longdendale Bypass and A57 Link Roads Trans-Pennine upgrade approved in 2024, while the A57, A560 and A627 are local routes. Motorway and relief-road work alike mean fast roads and viaduct structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Hyde crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, relief-road and winter-maintenance work",
  "s2_intro":"Across Hyde's Tameside carriageway work and the National Highways M67",
 },
 "stretford": {
  "region":"Stretford and Greater Manchester",
  "nearby":["Urmston","Altrincham","Manchester"],
  "snapshot":"iNeedWorkwear kits Stretford's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Trafford Council's One Trafford Partnership with Amey to National Highways work on the M60, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Stretford area's roads running",
  "s1loc":[
   "Stretford is defined by Trafford Park and the M60, plus the Old Trafford football and cricket stadia that drive major event-day traffic management. Trafford Council is the highway authority, and its gangs work in Class 3 hi-vis along the A56 and A5081 corridor under the Bee Network.",
   "The council delivers highways through the One Trafford Partnership with Amey, formed in 2015, maintaining over eight hundred kilometres of carriageway, nearly twelve hundred of footway and around twenty-eight thousand street lights, topped up with additional in-year pothole funding. Trafford Park immediately north generates heavy goods traffic onto the A5081 and M60.",
   "National Highways operates the M60 orbital along the western and southern edge serving Trafford Park, while the council-managed A56 Chester Road and the A5081 Park Way are the key local corridors. Orbital, industrial and event-day work alike mean fast roads and surfacing-wear from logistics traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Stretford crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, industrial-corridor and winter-maintenance work",
  "s2_intro":"Across Stretford's One Trafford Partnership carriageway work and the National Highways M60",
 },
 "glossop": {
  "region":"Glossop and the High Peak",
  "nearby":["Hyde","Stalybridge","Buxton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Glossop's highway maintenance teams and roadworks contractors, from Derbyshire County Council's ALLRoads service to the A57 Snake Pass, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Glossop area's roads running",
  "s1loc":[
   "Glossop sits at the western foot of the A57 Snake Pass, one of the most weather-vulnerable Trans-Pennine crossings, frequently shut by snow, ice and landslip. Derbyshire County Council is the highway authority, and its gangs work in Class 3 hi-vis on those exposed High Peak moorland roads.",
   "The county keeps highways delivery largely in house through ALLRoads, its direct labour organisation with a turnover above twenty million pounds handling construction, reinstatements, drainage and lighting, with a county maintenance budget over fifty-eight million pounds. Employment areas lie along the Glossopdale corridor toward Hadfield.",
   "National Highways supports the trunk network, while the A57 Snake Pass is a Derbyshire road over the moors, the A624 heads toward Chapel-en-le-Frith and the A6 serves the wider High Peak, with the National Highways Mottram bypass and A57 Link Roads approved in 2024 to relieve nearby congestion. Moorland-crossing and bypass work alike mean severe winters and landslip repair.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Glossop crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, moorland-route and winter-maintenance work",
  "s2_intro":"Across Glossop's Derbyshire ALLRoads carriageway work and the A57 Snake Pass",
 },
 "billingham": {
  "region":"Billingham and Teesside",
  "nearby":["Stockton-on-Tees","Thornaby-on-Tees","Hartlepool"],
  "snapshot":"iNeedWorkwear kits Billingham's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Stockton-on-Tees Borough Council to National Highways work on the A19, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Billingham area's roads running",
  "s1loc":[
   "Billingham is defined by the Teesside chemical industry and the A19, with the former ICI site now home to fertiliser production alongside Quorn and KP Snacks manufacturing. Stockton-on-Tees Borough Council is the unitary highway authority, and its gangs work in Class 3 hi-vis beside that heavy process-industry traffic.",
   "The council maintains most local roads through in-house teams plus contractors and frameworks, with customer service points at Stockton, Billingham and Thornaby. The concentration of plant, tank farms and food manufacturing means the local network carries heavy industrial loading.",
   "National Highways operates the A19 Teesside spine immediately west of the town and the A66 across the Tees Valley, while the council-managed A1027 Billingham bypass and the A689 corridor toward Hartlepool serve the area, the A19 grade-separated junctions major structures. Trunk and industrial-corridor work alike mean fast roads and heavy tanker traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Billingham crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, industrial-corridor and winter-maintenance work",
  "s2_intro":"Across Billingham's Stockton carriageway work and the National Highways A19",
 },
 "oldbury": {
  "region":"Oldbury and the Black Country",
  "nearby":["West Bromwich","Smethwick","Dudley"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Oldbury's highway maintenance teams and roadworks contractors, from Sandwell Council and the Black Country highways framework to National Highways work on the M5 viaduct, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Oldbury area's roads running",
  "s1loc":[
   "Oldbury sits beneath the elevated M5 Oldbury viaduct, a roughly three-kilometre six-lane structure carrying around a hundred and twenty thousand vehicles a day, and is the civic seat of Sandwell with its Council House on Freeth Street. Sandwell Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis beneath that motorway.",
   "Local highway works are delivered through the Black Country framework led by Wolverhampton with Colas among the contractors and a successor framework worth around a hundred and fifty million pounds running from 2026, while the National Highways viaduct concrete-repair scheme was the largest of its kind in the UK by value. Industrial estates cluster around M5 junction 2 and the A4123.",
   "National Highways operates the M5 viaduct between junctions 1 and 2 with the Birchley Island interchange at junction 2, while the council-managed A4123 New Road and the A457 run through the borough. Elevated-motorway and arterial work alike mean fast roads and major concrete structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Oldbury crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, viaduct-corridor and winter-maintenance work",
  "s2_intro":"Across Oldbury's Black Country framework carriageway work and the National Highways M5 viaduct",
 },
 "irvine": {
  "region":"Irvine and North Ayrshire",
  "nearby":["Kilmarnock","Ayr","Paisley"],
  "snapshot":"iNeedWorkwear kits Irvine's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from North Ayrshire Council to Transport Scotland trunk roads on the A78, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Irvine area's roads running",
  "s1loc":[
   "Irvine is one of Scotland's post-war new towns, its harbourside the focus of the Great Harbour and Maritime Mile regeneration funded through the Ayrshire Growth Deal. North Ayrshire Council is the unitary roads authority, and its gangs work in Class 3 hi-vis around those harbour and town-centre works on the Ayrshire coast.",
   "The council delivers local roads through an in-house, asset-management-led maintenance approach rather than a concession, prioritising works against budgets. The town has substantial industrial capacity from its new-town era around the harbourside, Riverside and the Ardeer peninsula.",
   "In Scotland trunk roads are Transport Scotland's responsibility, maintained in the south-west unit by Amey, with the A78 coast road the spine route past the town, the A71 toward Kilmarnock, the A737 up the Garnock Valley and the A736 to Glasgow. New-town distributor and trunk work alike mean fast roads and regeneration-driven schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Irvine crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the new town's carriageway, harbourside and winter-maintenance work",
  "s2_intro":"Across Irvine's North Ayrshire carriageway work and the Transport Scotland A78",
 },
 "dumfries": {
  "region":"Dumfries and the Solway",
  "nearby":["Carlisle","Ayr","Kilmarnock"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Dumfries highway maintenance teams and roadworks contractors, from Dumfries and Galloway Council to Transport Scotland trunk roads on the A75, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Dumfries area's roads running",
  "s1loc":[
   "The A75 through and past Dumfries is the strategic freight Euroroute linking the M6 at Gretna to the Cairnryan ferry ports for Northern Ireland, carrying a large majority of the North Channel HGV traffic. Dumfries and Galloway Council is the unitary roads authority for an unusually large rural area, and its gangs work in Class 3 hi-vis beside that freight route.",
   "The council maintains its long local road network in house through its roads service, while most towns on the A75 are bypassed though Springholm and Crocketford to the west remain un-bypassed, with Transport Scotland design work toward a preferred route under way. Industrial capacity sits around Heathhall and Locharbriggs.",
   "In Scotland trunk roads are Transport Scotland's responsibility, maintained in the south-west unit by Amey, with the A75 Euroroute the strategic spine, the A76 toward Kilmarnock and the A701, and recent barrier-replacement work on the Dumfries bypass. Single-carriageway freight and rural work alike mean high HGV volumes and long routes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Dumfries crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, Euroroute-corridor and winter-maintenance work",
  "s2_intro":"Across Dumfries council carriageway work and the Transport Scotland A75",
 },
 "motherwell": {
  "region":"Motherwell and the Clyde Valley",
  "nearby":["Wishaw","Hamilton","Bellshill"],
  "snapshot":"iNeedWorkwear kits Motherwell's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from North Lanarkshire Council's Amey partnership to Transport Scotland trunk roads on the M74, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Motherwell area's roads running",
  "s1loc":[
   "Motherwell sits beside the M74 corridor and the vast former Ravenscraig steelworks site, one of Scotland's largest regeneration areas. North Lanarkshire Council is the unitary roads authority, and its gangs work in Class 3 hi-vis along that motorway and the regeneration corridor in the Clyde Valley.",
   "Distinctively, the council has delivered local roads and lighting for many years through a long-running partnership with Amey, separate from the trunk-road contracts. The Ravenscraig Access Infrastructure scheme, part of the Pan-Lanarkshire orbital corridor and City Region City Deal at around a hundred and ninety million pounds, links the M74 at Motherwell to the M8 at Holytown.",
   "In Scotland motorways are Transport Scotland's responsibility, with the M74 through the area under the Autolink DBFO concession, the A721 and A723 the principal council A-roads and the Raith interchange close by. Motorway and regeneration work alike mean fast roads and sustained new-build highway activity.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Motherwell crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, regeneration-corridor and winter-maintenance work",
  "s2_intro":"Across Motherwell's North Lanarkshire and Amey carriageway work and the Transport Scotland M74",
 },
 "aberdare": {
  "region":"Aberdare and the Cynon Valley",
  "nearby":["Merthyr Tydfil","Pontypridd","Maesteg"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Aberdare's highway maintenance teams and roadworks contractors, from Rhondda Cynon Taf County Borough Council to Welsh Government trunk roads on the A465 Heads of the Valleys, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Aberdare area's roads running",
  "s1loc":[
   "Aberdare anchors the Cynon Valley, where the A465 Heads of the Valleys dualling defines the area's strategic road activity, the Dowlais Top to Hirwaun sections completed in recent years. Rhondda Cynon Taf County Borough Council is the Welsh unitary highway authority, and its gangs work in Class 3 hi-vis on those valley routes.",
   "The council maintains the local road network in house and is promoting the A4059 Aberdare bypass extension, Cynon Gateway North, partly Welsh Government funded, toward a new A465 junction at Croesbychan. Industrial capacity sits around Hirwaun and Aberaman.",
   "Trunk roads in Wales are the Welsh Government's responsibility via Traffic Wales and the South Wales Trunk Road Agent, with the A465 the key strategic route, its dualled sections 5 and 6 maintained under the Future Valleys Mutual Investment Model concession rather than directly by SWTRA, and the A4059 and A4233 serving the valley. Trunk-dualling and valley work alike mean major civils and a concession-maintained corridor.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Aberdare crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, valley-corridor and winter-maintenance work",
  "s2_intro":"Across Aberdare's council carriageway work and the Welsh Government A465",
 },
 "lichfield": {
  "region":"Lichfield and Staffordshire",
  "nearby":["Burntwood","Tamworth","Cannock"],
  "snapshot":"iNeedWorkwear kits Lichfield's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Staffordshire County Council's Amey Infrastructure Plus partnership to National Highways work on the A38, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Lichfield area's roads running",
  "s1loc":[
   "Lichfield is a historic cathedral city, the three-spired Lichfield Cathedral its landmark, on the A38 corridor with significant HS2 works nearby carrying the A38, A5 and Rykneld Street over the new line at Streethay. Staffordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that trunk corridor.",
   "Highways run through the Infrastructure Plus partnership with Amey, in place since 2014 and extended from October 2024, covering carriageway reconstruction, surfacing, drainage and winter service, while HS2 enabling works have brought A38 slip-road closures and realignment. Industrial and distribution estates cluster around the A38 and A5 at Fradley.",
   "National Highways operates the trunk A38 dual carriageway along the eastern side at Streethay as a major freight route, with the A51 toward Tamworth, the A5127 the old A38 through the city and the A5 to the south. Trunk and HS2-adjacent work alike mean fast roads and active construction.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Lichfield crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, cathedral-city and winter-maintenance work",
  "s2_intro":"Across Lichfield's Amey carriageway work and the National Highways A38",
 },
 "whitstable": {
  "region":"Whitstable and Kent",
  "nearby":["Herne Bay","Canterbury","Faversham"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Whitstable's highway maintenance teams and roadworks contractors, from Kent County Council's Ringway term contract to the A299 Thanet Way, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Whitstable area's roads running",
  "s1loc":[
   "Whitstable is the historic oyster town, its working harbour built in 1832 still part of the local economy and its annual Oyster Festival driving seasonal traffic. Kent County Council is the highway authority, and its gangs work in Class 3 hi-vis along the A299 bypass and the A290 link to Canterbury.",
   "Kent's county term maintenance contract moved to Ringway, a Vinci company, taking over from Amey from May 2026 on the twenty-one-year, roughly fifty-million-pounds-a-year deal, with major A299 Thanet Way resurfacing between Whitstable and the Chestfield Tunnel in recent years. The Estuary View and Joseph Wilson industrial estates support local trade.",
   "National Highways operates the wider trunk network, while the council-managed A299 Thanet Way runs from Brenley Corner past Whitstable toward Thanet, the A290 connects south to Canterbury and the Chestfield Tunnel sits on the A299 near the town. Bypass and tunnel work alike mean busy through-traffic and structures maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Whitstable crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, coastal-corridor and winter-maintenance work",
  "s2_intro":"Across Whitstable's Ringway carriageway work and the A299 Thanet Way",
 },
 "strood": {
  "region":"Strood and Medway",
  "nearby":["Rochester","Chatham","Gravesend"],
  "snapshot":"iNeedWorkwear kits Strood's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Medway Council's VolkerHighways term contract to National Highways work on the A2 and M2 and the Medway Tunnel, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Strood area's roads running",
  "s1loc":[
   "Strood sits at the western approach to the Medway Tunnel and the river crossings, where the A2 and M2 corridor and the A228 funnel traffic across the Medway. Medway Council is the unitary highway authority for the Medway Towns, and its gangs work in Class 3 hi-vis around that tunnel-and-river network.",
   "Medway runs its highways and street lighting through a term contract with VolkerHighways, in place since 2017 at around nine million pounds a year with a large successor pipeline being procured, and the council-owned Medway Tunnel carrying around forty thousand vehicles a day is inspected and maintained by VolkerHighways during overnight closures. The Medway City Estate at Frindsbury anchors local trade.",
   "National Highways operates the A2 and the M2 at junction 2 serving Strood and Rochester, while the council-managed A228 runs toward the Hoo Peninsula and the Medway Tunnel is the standout council-owned structure. Trunk and tunnel work alike mean heavy through-traffic and specialist overnight possessions.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Strood crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, tunnel-approach and winter-maintenance work",
  "s2_intro":"Across Strood's VolkerHighways carriageway work and the National Highways A2 and M2",
 },
 "uxbridge": {
  "region":"Uxbridge and West London",
  "nearby":["Hayes","Ruislip","Slough"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Uxbridge's highway maintenance teams and roadworks contractors, from the London Borough of Hillingdon to National Highways work on the M40 and the Transport for London A40, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Uxbridge area's roads running",
  "s1loc":[
   "Uxbridge sits where the M40 meets the A40 on London's western edge, with the A4020 Uxbridge Road the historic arterial and Brunel University and Heathrow proximity driving heavy traffic. The London Borough of Hillingdon is the highway authority, and its gangs work in Class 3 hi-vis across that motorway-edge network.",
   "Hillingdon runs its own highways maintenance and works programme and has been re-tendering a Highways Term Service Contract worth up to around a hundred and twenty-eight million pounds over a maximum twelve-year term, with borough roads excluding the TfL and National Highways network. Logistics estates around Stockley Park and the Hayes and Uxbridge corridor support a dense supply chain.",
   "National Highways operates the M40 terminating at the A40 near Denham plus the M4 and M25, while Transport for London manages the A40 Western Avenue and the A312, the A4020 Uxbridge Road running east through Hillingdon and Hayes. Motorway, red-route and airport-freight work alike mean fast roads and three highway tiers.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Uxbridge crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-edge and winter-maintenance work",
  "s2_intro":"Across Uxbridge's Hillingdon carriageway work, the National Highways M40 and the TfL A40",
 },
 "haywards heath": {
  "region":"Haywards Heath and West Sussex",
  "nearby":["Burgess Hill","Crawley","East Grinstead"],
  "snapshot":"iNeedWorkwear kits Haywards Heath's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from West Sussex County Council's VolkerHighways contract to National Highways work on the A23, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Haywards Heath area's roads running",
  "s1loc":[
   "Haywards Heath sits on the A272 and A23 commuter corridor between Brighton to the south and Gatwick Airport to the north, a busy commuter town in Mid Sussex. West Sussex County Council is the highway authority, and its gangs work in Class 3 hi-vis managing maintenance windows around peak periods.",
   "The council restructured its highways delivery in recent years, awarding the core maintenance contract to VolkerHighways from April 2025 at around sixteen and a half million pounds a year over a seven-year term taking over from Balfour Beatty, with FM Conway on drainage. The Bridge Road and Bolnore commercial zones and county depots serve Mid Sussex.",
   "National Highways operates the A23 trunk road and M23 corridor linking London to Brighton, while the council-managed A272 connects through to the A23 and the former town route was renumbered the B2272 after the Haywards Heath bypass opened. Trunk and bypass work alike mean fast roads and tightly managed peak periods.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Haywards Heath crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, commuter-corridor and winter-maintenance work",
  "s2_intro":"Across Haywards Heath's VolkerHighways carriageway work and the National Highways A23",
 },
 "burgess hill": {
  "region":"Burgess Hill and West Sussex",
  "nearby":["Haywards Heath","Brighton","Hove"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Burgess Hill's highway maintenance teams and roadworks contractors, from West Sussex County Council's VolkerHighways contract to the A2300 link and the A23, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Burgess Hill area's roads running",
  "s1loc":[
   "Burgess Hill's defining highways theme is the A2300 link to the A23 and the large Homes England-led Northern Arc housing growth of thousands of new homes, making the town an active new-infrastructure environment. West Sussex County Council is the highway authority, and its gangs work in Class 3 hi-vis around those growth-driven works in Mid Sussex.",
   "Highways maintenance moved to VolkerHighways from April 2025 under the seven-year core services contract taking over from Balfour Beatty, with FM Conway on drainage, while major growth civils have involved Jackson Civil Engineering and John Sisk on the Northern Arc link roads. The Victoria Business Park and Sheddingdean estates anchor local industry.",
   "National Highways operates the A23 trunk road and M23 corridor nearby, while the council-managed A2300 was dualled in recent years to serve the growth areas, connecting the A23 into Burgess Hill, with the A273 the other principal local route. Trunk-link and growth-corridor work alike mean fast roads and new junctions.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Burgess Hill crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, growth-corridor and winter-maintenance work",
  "s2_intro":"Across Burgess Hill's VolkerHighways carriageway work and the A2300 link and A23",
 },
 "letchworth": {
  "region":"Letchworth and Hertfordshire",
  "nearby":["Hitchin","Stevenage","Hertford"],
  "snapshot":"iNeedWorkwear kits Letchworth's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Hertfordshire County Council's Ringway contract to National Highways work on the A1(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Letchworth area's roads running",
  "s1loc":[
   "Letchworth is the world's first garden city, founded in 1903 on Ebenezer Howard's plan with deliberately planned tree-lined avenues and early roundabout geometry, including Sollershott Circus, often cited as Britain's first purpose-built roundabout. Hertfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis through that planned street pattern.",
   "Hertfordshire retained Ringway, part of Vinci, as its term maintenance contractor on the new deal from October 2025, continuous since 2012, covering potholes, lighting, signals, gritting and improvement schemes. The Pixmore Avenue and Works Road estates from the garden city's planned employment zones support depot and yard activity.",
   "National Highways operates the A1(M) with junction 9 the key access connecting to the A505, while the A505 runs through toward Hitchin. Motorway-junction and garden-city work alike mean fast roads and a heritage-planned layout.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Letchworth crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, garden-city and winter-maintenance work",
  "s2_intro":"Across Letchworth's Ringway carriageway work and the National Highways A1(M)",
 },
 "borehamwood": {
  "region":"Borehamwood and Hertfordshire",
  "nearby":["Barnet","Potters Bar","Bushey"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Borehamwood's highway maintenance teams and roadworks contractors, from Hertfordshire County Council's Ringway contract to National Highways work on the A1 and M25, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Borehamwood area's roads running",
  "s1loc":[
   "Borehamwood is strongly associated with Elstree Studios, its film and TV production shaped by proximity to the A1 and M25, giving heavy through traffic and good national connectivity. Hertfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along those arterial routes in Hertsmere.",
   "Hertfordshire delivers routine and reactive works through Ringway, part of Vinci, retained on the new contract from October 2025 covering maintenance, potholes, lighting and gritting. The Waterfront business park on the A411 and the Studio Way and Centennial Park areas support local plant and depot activity.",
   "National Highways operates the A1 just to the east and the M25 with junction 23 at South Mimms about two miles north the principal access, while the council-managed A411 Elstree Road and the A5135 Shenley Road serve the town. Trunk, orbital and studio-traffic work alike mean fast roads and busy junctions.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Borehamwood crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, studio-town and winter-maintenance work",
  "s2_intro":"Across Borehamwood's Ringway carriageway work and the National Highways A1 and M25",
 },
 "windsor": {
  "region":"Windsor and Berkshire",
  "nearby":["Slough","Maidenhead","Staines"],
  "snapshot":"iNeedWorkwear kits Windsor's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from the Royal Borough of Windsor and Maidenhead's Marlborough contract to National Highways work on the M4, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Windsor area's roads running",
  "s1loc":[
   "Windsor is dominated by heavy tourist traffic drawn by Windsor Castle and nearby Legoland, with events and the Changing of the Guard briefly stopping traffic on the High Street and Sheet Street. The Royal Borough of Windsor and Maidenhead is the unitary highway authority, and its gangs work in Class 3 hi-vis scheduling maintenance around tourism and ceremonial movements.",
   "The borough retendered its highways contract, awarding it to Marlborough Highways to take over from VolkerHighways from April 2026 at up to around eight million pounds a year over an initial seven-year term, maintaining roughly three hundred and seventy-five miles of road and around three hundred bridges. The Vansittart Estate and Dedworth Road and the nearby Slough Trading Estate serve the area.",
   "National Highways operates the M4 with junction 6 the principal access about a mile away, while the council-managed A308 links east toward Staines and the M25, the A332 runs north to the M4 and south toward Ascot and the A355 connects to Slough. Motorway and tourist-corridor work alike mean fast roads and intense seasonal congestion.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Windsor crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, tourist-corridor and winter-maintenance work",
  "s2_intro":"Across Windsor's Marlborough carriageway work and the National Highways M4",
 },
 "bedworth": {
  "region":"Bedworth and Warwickshire",
  "nearby":["Nuneaton","Coventry","Hinckley"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Bedworth's highway maintenance teams and roadworks contractors, from Warwickshire County Council's Balfour Beatty contract to National Highways work on the M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bedworth area's roads running",
  "s1loc":[
   "Bedworth sits on M6 junction 3, wedged between Coventry to the south and Nuneaton to the north, with the A444 dual carriageway as its spine. Warwickshire County Council is the highway authority, and its gangs work in Class 3 hi-vis at that busy motorway junction in the conurbation.",
   "The county delivers highways through Balfour Beatty Living Places in a joint contract with Coventry and Solihull, the new seven-year term at around three hundred and fifteen million pounds covering over five thousand kilometres of road and fifty-five thousand street lights. The Bayton Road and surrounding estates along the A444 corridor anchor local industry.",
   "National Highways operates the M6 immediately south at junction 3, while the council-managed A444 Bedworth bypass crosses it and runs north into Nuneaton and south into Coventry and the B4113 is the former alignment through the town. Motorway-junction and dual-carriageway work alike mean fast roads and conurbation traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Bedworth crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-junction and winter-maintenance work",
  "s2_intro":"Across Bedworth's Balfour Beatty carriageway work and the National Highways M6",
 },
 "brighouse": {
  "region":"Brighouse and West Yorkshire",
  "nearby":["Halifax","Huddersfield","Mirfield"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Brighouse's highway maintenance teams and roadworks contractors, from Calderdale Council and the Yorkshire Alliance framework to National Highways work on the M62, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Brighouse area's roads running",
  "s1loc":[
   "Brighouse is a Calder Valley town defined by its position at M62 junction 25, sitting on the River Calder and the Calder and Hebble Navigation between Halifax and Huddersfield. Calderdale Council is the West Yorkshire metropolitan highway authority, and its gangs work in Class 3 hi-vis around that motorway-junction corridor.",
   "Calderdale is a partner on the Yorkshire Alliance surfacing and planing framework on which Colas holds places, and runs its own Highways Works Framework for wider work, with recent resurfacing on Halifax Road, Huddersfield Road and Wakefield Road. Calder Valley river and canal crossings and bridge structures are notable.",
   "National Highways operates the M62 with junction 25 the key Brighouse interchange, while the council-managed A641 Bradford Road and the A644 Wakefield Road run the Calder Valley corridors. Motorway and valley work alike mean fast roads and structures maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Brighouse crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, valley-corridor and winter-maintenance work",
  "s2_intro":"Across Brighouse's Yorkshire Alliance carriageway work and the National Highways M62",
 },
 "pudsey": {
  "region":"Pudsey and West Yorkshire",
  "nearby":["Leeds","Bradford","Horsforth"],
  "snapshot":"iNeedWorkwear kits Pudsey's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Leeds City Council and the Yorkshire Alliance framework to the A647 ring-road corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Pudsey area's roads running",
  "s1loc":[
   "Pudsey sits between Leeds and Bradford on the A647 corridor, where the Stanningley Bypass and Dawsons Corner make it one of the busier strategic junctions in the Leeds district. Leeds City Council is the West Yorkshire metropolitan highway authority, and its gangs work in Class 3 hi-vis along that ring-road corridor.",
   "Leeds is a partner on the Yorkshire Alliance surfacing and planing framework and runs a large annual programme of highway works, with the multi-year Dawsons Corner and Stanningley Bypass improvement scheme of around forty-four million pounds repairing well over a hundred structures and resurfacing the bypass. Industrial estates line the A647 corridor.",
   "National Highways operates the wider strategic network, while the council-managed A647 Leeds-to-Bradford corridor including the Stanningley Bypass and the A6120 Leeds Outer Ring Road meet at Dawsons Corner. Ring-road and bypass work alike mean busy roads and major structures repair.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Pudsey crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, ring-road and winter-maintenance work",
  "s2_intro":"Across Pudsey's Yorkshire Alliance carriageway work and the A647 corridor",
 },
 "hucknall": {
  "region":"Hucknall and Nottinghamshire",
  "nearby":["Nottingham","Arnold","Mansfield"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Hucknall's highway maintenance teams and roadworks contractors, from Nottinghamshire County Council's Via East Midlands company to National Highways work on the M1, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Hucknall area's roads running",
  "s1loc":[
   "Hucknall is a former mining town with strong Rolls-Royce aerospace heritage at the former airfield, sitting on the A611 corridor between Nottingham and the M1. Nottinghamshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that commuter-and-regeneration corridor in Ashfield.",
   "The county delivers highways through Via East Midlands, its wholly-owned company since 2019, maintaining over four thousand kilometres of road and around ninety-three thousand street lights, with recent Hucknall works including carriageway patching and a new toucan crossing on Watnall Road near the A611. Former-colliery regeneration sites around Annesley support local employment.",
   "National Highways operates the M1 with junction 27 to the north-west the strategic access, while the council-managed A611 Hucknall bypass runs the Annesley-to-Nottingham corridor and the A6009 links into the town. Motorway-adjacent and bypass work alike mean fast roads and busy roundabout junctions.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Hucknall crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bypass-corridor and winter-maintenance work",
  "s2_intro":"Across Hucknall's Via East Midlands carriageway work and the National Highways M1 and A611",
 },
 "rayleigh": {
  "region":"Rayleigh and Essex",
  "nearby":["Southend-on-Sea","Wickford","Basildon"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Rayleigh's highway maintenance teams and roadworks contractors, from Essex County Council's Essex Highways partnership with Ringway Jacobs to the A127 Southend arterial, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Rayleigh area's roads running",
  "s1loc":[
   "Rayleigh sits on the A127 Southend arterial commuter corridor, one of south Essex's busiest routes, with the Rayleigh Weir junction where the A127 meets the A129 a recognised pinch point. Essex County Council is the highway authority, and its gangs work in Class 3 hi-vis along that heavy peak-hour route.",
   "The council delivers through the Essex Highways integrated partnership with Ringway Jacobs, in place since 2012 and running under an extension with a successor being procured, covering around five thousand miles of carriageway and a quarter of a million street lights. The Rawreth and Brook Road industrial areas anchor local trade.",
   "National Highways operates the wider strategic network, while the council-managed A127 Southend Arterial Road is the dominant spine meeting the A129 at Rayleigh Weir and the A1245 Fairglen interchange near the A130, with recent signals and barrier schemes at the Weir. Arterial and junction work alike mean busy roads and peak-time management.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Rayleigh crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, arterial-corridor and winter-maintenance work",
  "s2_intro":"Across Rayleigh's Ringway Jacobs carriageway work and the A127 Southend arterial",
 },
 "loughton": {
  "region":"Loughton and Essex",
  "nearby":["Harlow","Romford","Ilford"],
  "snapshot":"iNeedWorkwear kits Loughton's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Essex County Council's Essex Highways partnership with Ringway Jacobs to National Highways work on the M11, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Loughton area's roads running",
  "s1loc":[
   "Loughton borders Epping Forest on the London fringe, so highway works face Conservators and ancient-woodland sensitivities along forest-edge roads. Essex County Council is the highway authority, and its gangs work in Class 3 hi-vis on that commuter-belt network served by the Central line.",
   "The council delivers through the Essex Highways partnership with Ringway Jacobs, the county-wide integrated term contract running under an extension with a successor being procured. Commercial and light-industrial activity around the Langston Road retail and trade parks and the Oakwood Hill estate supports local works.",
   "National Highways operates the M11 along the eastern edge with junction 5 at Debden serving the town, while the council-managed A121 Loughton High Road and the A1168 link toward Epping and Buckhurst Hill. Motorway and forest-edge work alike mean fast roads and woodland constraints.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Loughton crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, forest-edge and winter-maintenance work",
  "s2_intro":"Across Loughton's Ringway Jacobs carriageway work and the National Highways M11",
 },
 "rutherglen": {
  "region":"Rutherglen and South Lanarkshire",
  "nearby":["Glasgow","Hamilton","East Kilbride"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Rutherglen's highway maintenance teams and roadworks contractors, from South Lanarkshire Council to Transport Scotland trunk roads on the M74, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Rutherglen area's roads running",
  "s1loc":[
   "Rutherglen sits on the south-east edge of Glasgow beside the River Clyde and the M74, an urban-fringe location where council roads, Glasgow boundary traffic and the trunk motorway meet. South Lanarkshire Council is the unitary roads authority, and its gangs work in Class 3 hi-vis at that busy A724 and M74 interface.",
   "The council maintains adopted roads, footways, lighting and structures in house through its Roads and Transportation service from the East Kilbride and Cambuslang area office, with recent resurfacing on the A724 Cambuslang Road corridor. Rutherglen and Cambuslang industrial estates along the Clyde serve the construction and plant trades.",
   "In Scotland trunk roads are Transport Scotland's responsibility, maintained in the south-west unit by Amey, with the M74 carrying traffic around the south-east of Glasgow, the A724 linking to the M74 slips and the A730 Glasgow Road toward the city. Motorway-interface and urban work alike mean fast roads and night-closure activity.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Rutherglen crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-interface and winter-maintenance work",
  "s2_intro":"Across Rutherglen's South Lanarkshire carriageway work and the Transport Scotland M74",
 },
 "epsom": {
  "region":"Epsom and Surrey",
  "nearby":["Sutton","Kingston upon Thames","Esher"],
  "snapshot":"iNeedWorkwear kits Epsom's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Surrey County Council's Ringway contract to the A24 and Epsom Downs, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Epsom area's roads running",
  "s1loc":[
   "Epsom is defined by Epsom Downs Racecourse and the Derby, whose meeting drives major seasonal traffic management and road closures across the Downs, alongside the A24 spine through the town. Surrey County Council is the highway authority, and its gangs work in Class 3 hi-vis managing those event-period works.",
   "The county's term maintenance contract has been held by Ringway since April 2022, taking over from Kier on a long-term deal covering reactive repairs, resurfacing, structures, drainage and winter service. The Longmead Industrial Estate and Kiln Lane anchor local trade in Epsom and Ewell.",
   "National Highways operates the wider motorway network with the M25 reached at junctions 8 and 9, while the council-managed A24 London-to-Worthing corridor is the principal route and the A240 and A232 carry town traffic. Race-day and A-road work alike mean tightly managed closures and busy commuter flows.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Epsom crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, event-route and winter-maintenance work",
  "s2_intro":"Across Epsom's Ringway carriageway work and the A24 and Epsom Downs",
 },
 "staines": {
  "region":"Staines and Surrey",
  "nearby":["Feltham","Windsor","Slough"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Staines highway maintenance teams and roadworks contractors, from Surrey County Council's Ringway contract to National Highways work on the M25, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Staines area's roads running",
  "s1loc":[
   "Staines-upon-Thames sits at the confluence of the Thames and the River Colne beside M25 junction 13 and close to Heathrow, a high-traffic logistics and commuter hub. Surrey County Council is the highway authority, and its gangs work in Class 3 hi-vis along the A30 and A308 corridor and the Thames crossings.",
   "The county's term maintenance contract has been held by Ringway since April 2022, taking over from Kier, covering resurfacing, structural works, drainage and winter service. The Two Rivers commercial zone and industrial estates off London Road support strong Heathrow-driven logistics demand.",
   "National Highways operates the M25 with junction 13 at Runnymede immediately west linked by the A30, while the council-managed A308 Staines Road carries traffic toward the M3 and A316 and Staines Bridge crosses the Thames. Motorway and river-crossing work alike mean fast roads and flood and bridge-asset considerations.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Staines crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, river-crossing and winter-maintenance work",
  "s2_intro":"Across Staines Ringway carriageway work and the National Highways M25",
 },
 "chichester": {
  "region":"Chichester and West Sussex",
  "nearby":["Bognor Regis","Littlehampton","Havant"],
  "snapshot":"iNeedWorkwear kits Chichester's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from West Sussex County Council's VolkerHighways contract to National Highways work on the A27, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Chichester area's roads running",
  "s1loc":[
   "Chichester is a cathedral city where the A27 bypass with its chronically congested roundabout junctions, and the air quality areas around them, defines the highway profile. West Sussex County Council is the highway authority, and its gangs work in Class 3 hi-vis along that bypass and the rural network.",
   "The county's core highways contract passed from Balfour Beatty to VolkerHighways from April 2025 at around sixteen and a half million pounds a year, with FM Conway on drainage. Goodwood with its motor circuit, racecourse and Festival of Speed drives major seasonal traffic onto the A286 and surrounding roads, with the Terminus Road estate anchoring local trade.",
   "National Highways operates the A27 Chichester bypass, a dual carriageway with five roundabout junctions south of the city, the long-discussed improvement scheme still in the pipeline, while the A286 runs north to the South Downs and the A259 is the coastal corridor. Bypass and event work alike mean fast roads and congested junctions.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Chichester crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bypass-corridor and winter-maintenance work",
  "s2_intro":"Across Chichester's VolkerHighways carriageway work and the National Highways A27",
 },
 "deal": {
  "region":"Deal and Kent",
  "nearby":["Dover","Canterbury","Ramsgate"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Deal's highway maintenance teams and roadworks contractors, from Kent County Council's Ringway term contract to the A258 coast road, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Deal area's roads running",
  "s1loc":[
   "Deal is a historic Cinque Ports town on the east Kent coast, with the coastal A258 its defining route toward Sandwich and Dover. Kent County Council is the highway authority for the roughly five-thousand-four-hundred-mile Kent network, and its gangs work in Class 3 hi-vis on salt-exposed seafront roads.",
   "Kent signed a new twenty-one-year Highways Term Maintenance Contract with Ringway, a Vinci subsidiary, taking over from Amey from May 2026 at around fifty million pounds a year, drawing also on the Local Highways Maintenance Support Contracts framework. Commercial provision sits around Sandwich and the Dover and Whitfield industrial areas.",
   "National Highways operates the inland trunk network on the A2, M2 and M20, while the council-managed A258 is the coastal road linking Deal north to Sandwich and south to Dover and the A256 heads toward Canterbury. Coastal and county A-road work alike mean exposed conditions and verge and drainage demand.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Deal crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, coast-road and winter-maintenance work",
  "s2_intro":"Across Deal's Ringway carriageway work and the A258 coast road",
 },
 "sevenoaks": {
  "region":"Sevenoaks and Kent",
  "nearby":["Tonbridge","Tunbridge Wells","Orpington"],
  "snapshot":"iNeedWorkwear kits Sevenoaks highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Kent County Council's Ringway term contract to National Highways work on the M25 and A21, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Sevenoaks area's roads running",
  "s1loc":[
   "Sevenoaks is a major junction town in west Kent, sitting at M25 junction 5 where the orbital meets the A21 trunk route to Hastings and the M26 east to the M20. Kent County Council is the highway authority, and its gangs work in Class 3 hi-vis amid heavy motorway and trunk traffic.",
   "Kent's county term maintenance contract moved to Ringway, a Vinci company, taking over from Amey from May 2026 on the twenty-one-year, roughly fifty-million-pounds-a-year deal, with National Highways running A21 safety and A25 refurbishment schemes in recent years. The Vestry and Bat and Ball estates anchor local trade.",
   "National Highways operates the M25 at junction 5, the M26 link and the A21 trunk corridor, while the council-managed A25 runs east-west through the district. Orbital, trunk and county work alike mean fast roads and Chapter 8 traffic management near live carriageways.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Sevenoaks crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, interchange and winter-maintenance work",
  "s2_intro":"Across Sevenoaks Ringway carriageway work and the National Highways M25 and A21",
 },
 "tonbridge": {
  "region":"Tonbridge and Kent",
  "nearby":["Sevenoaks","Tunbridge Wells","Maidstone"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Tonbridge's highway maintenance teams and roadworks contractors, from Kent County Council's Ringway term contract to National Highways work on the A21, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Tonbridge area's roads running",
  "s1loc":[
   "Tonbridge sits on the River Medway with its medieval castle, defined by the A21 Tonbridge Bypass and the A26 and A227 county corridors. Kent County Council is the highway authority, and its gangs work in Class 3 hi-vis around those river crossings and the busy trunk bypass.",
   "Kent's county term maintenance contract moved to Ringway from Amey from May 2026 on the twenty-one-year deal, with National Highways running A21 resurfacing and safety-barrier renewal on the Tonbridge Bypass northbound and the council programming surface renewal on the A26 at Hadlow Road. The Vale Road area anchors local trade.",
   "National Highways operates the A21 Tonbridge Bypass, while the council-managed A26 runs through the town toward Tunbridge Wells and Maidstone and the A227 heads north toward Wrotham and the A20. Bypass and river-crossing work alike mean fast roads and bridge and barrier maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Tonbridge crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, bypass-corridor and winter-maintenance work",
  "s2_intro":"Across Tonbridge's Ringway carriageway work and the National Highways A21",
 },
 "camberley": {
  "region":"Camberley and Surrey",
  "nearby":["Sandhurst","Farnborough","Aldershot"],
  "snapshot":"iNeedWorkwear kits Camberley's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Surrey County Council's Ringway contract to National Highways work on the M3 and the A331, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Camberley area's roads running",
  "s1loc":[
   "Camberley is defined by the M3 at junction 4 and the A331 Blackwater Valley Route, with the Royal Military Academy Sandhurst nearby giving the town its character. Surrey County Council is the highway authority, and its gangs work in Class 3 hi-vis along that motorway and valley corridor.",
   "The county's term maintenance contract has been held by Ringway since April 2022, taking over from Kier, while the A331 straddles the Surrey and Hampshire boundary so some sections fall under Hampshire. The Yorktown Industrial Estate and the Blackwater Valley employment land anchor local trade.",
   "National Highways operates the M3 to the south with junction 4 serving the town, the A30 running roughly parallel and the A331 Blackwater Valley Route the key relief road connecting at junction 4 with a tunnel section under the M3 on a fifty mile per hour limit. Motorway and dual-carriageway work alike mean fast roads and shared-boundary management.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Camberley crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, valley-route and winter-maintenance work",
  "s2_intro":"Across Camberley's Ringway carriageway work and the National Highways M3 and A331",
 },
 "kendal": {
  "region":"Kendal and Cumbria",
  "nearby":["Lancaster","Penrith","Ulverston"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Kendal's highway maintenance teams and roadworks contractors, from Westmorland and Furness Council to National Highways work on the M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Kendal area's roads running",
  "s1loc":[
   "Kendal is the southern gateway to the Lake District, the point where M6 and A591 traffic funnels toward the national park, and one of the busiest year-round tourist corridors in the North West. Westmorland and Furness Council, the unitary created in 2023 from the former Cumbria County Council, is the highway authority, and its gangs work in Class 3 hi-vis on that gateway network.",
   "The council delivers a substantial annual highways and pavement programme reported at around thirty-seven million pounds, managing and procuring works through framework and term arrangements, with the Mintsfeet and Shap Road industrial estates on the northern edge. Flood-resilience and drainage works have been a recurring theme since the 2015 Storm Desmond floods.",
   "National Highways operates the M6 with junction 36 the main access from the south and junction 37 to the north, while the A591 runs through Kendal to Windermere and Keswick, the A590 links to Barrow and the A6 is the critical diversion route whenever the M6 is closed. Motorway, gateway and diversion work alike mean fast roads and severe winters.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Kendal crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, gateway-route and winter-maintenance work",
  "s2_intro":"Across Kendal's Westmorland and Furness carriageway work and the National Highways M6",
 },
 "redhill": {
  "region":"Redhill and Surrey",
  "nearby":["Reigate","Horley","Caterham"],
  "snapshot":"iNeedWorkwear kits Redhill's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Surrey County Council's Ringway contract to National Highways work on the M25 and M23, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Redhill area's roads running",
  "s1loc":[
   "Redhill's highway identity centres on M25 junction 8 and the M23 to Gatwick Airport, with the A23 London-to-Brighton spine running through the town. Surrey County Council is the highway authority, and its gangs work in Class 3 hi-vis along that strategic interchange and airport-bound corridor.",
   "The county's term maintenance contract has been held by Ringway since April 2022, taking over from Kier, covering resurfacing, reactive repairs, structures, drainage and winter service across Reigate and Banstead. The Holmethorpe Industrial Estate anchors local trade.",
   "National Highways operates the M25 with junction 8 at Merstham and the M25 and M23 four-level stack interchange, the M23 running south past Redhill to Gatwick, while the council-managed A23 runs through the town and the A25 carries cross-county movement. Orbital, motorway and airport work alike mean fast roads and a heavily managed interchange.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Redhill crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, interchange and winter-maintenance work",
  "s2_intro":"Across Redhill's Ringway carriageway work and the National Highways M25 and M23",
 },
 "ruislip": {
  "region":"Ruislip and West London",
  "nearby":["Uxbridge","Harrow","Hayes"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Ruislip's highway maintenance teams and roadworks contractors, from the London Borough of Hillingdon to National Highways work on the A40 and HS2, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Ruislip area's roads running",
  "s1loc":[
   "Ruislip is on the Metropolitan line and the A40 corridor and is a focal point for HS2 works, with the railway surfacing at West Ruislip before crossing the Colne Valley on viaduct toward the Northolt Tunnel. The London Borough of Hillingdon is the highway authority for around seven hundred kilometres of borough road, and its gangs work in Class 3 hi-vis amid that construction activity.",
   "Hillingdon delivers highways and street lighting through borough term service contracts, the street-lighting contract awarded to J McCann from April 2026, maintaining some thirty-one thousand lighting assets and around two hundred and sixty structures. HS2 main-works contractors have driven realignments such as Harvil Road and A40 diversions.",
   "National Highways operates the A40 Western Avenue on the southern side and the wider motorway network, while Transport for London manages red routes and the council holds borough roads including the A4180 and A4090 feeding the A40 toward Northolt. Trunk, HS2 and borough work alike mean fast roads and major construction diversions.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Ruislip crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, HS2-corridor and winter-maintenance work",
  "s2_intro":"Across Ruislip's Hillingdon carriageway work and the National Highways A40",
 },
 "newark": {
  "region":"Newark and Nottinghamshire",
  "nearby":["Grantham","Lincoln","Mansfield"],
  "snapshot":"iNeedWorkwear kits Newark's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Nottinghamshire County Council's Via East Midlands company to National Highways work on the A1 and A46, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Newark area's roads running",
  "s1loc":[
   "Newark-on-Trent is defined by the A1 and A46 crossing of the River Trent, a long-standing strategic gateway, with English Civil War heritage as a Royalist stronghold. Nottinghamshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that freight crossroads.",
   "The county delivers highways through Via East Midlands, its wholly-owned company managing the network since 2016 with an extension toward the early 2030s, covering carriageways, lighting, signals and winter service. Industrial and distribution estates serve the A1, A46 and A17 crossroads, with major water and flood schemes also driving works.",
   "National Highways operates the A1 as the town's strategic north-south bypass and the A46 cross-country route toward Lincoln, with a major A46 Newark Bypass upgrade progressing near the A1 at Winthorpe including the Trent crossings, while the A17 heads east toward Sleaford. Trunk and bypass work alike mean fast roads and major structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Newark crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, trunk-crossroads and winter-maintenance work",
  "s2_intro":"Across Newark's Via East Midlands carriageway work and the National Highways A1 and A46",
 },
 "pontefract": {
  "region":"Pontefract and West Yorkshire",
  "nearby":["Castleford","Normanton","Featherstone"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Pontefract's highway maintenance teams and roadworks contractors, from Wakefield Council to National Highways work on the M62 and A1(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Pontefract area's roads running",
  "s1loc":[
   "Pontefract sits close to M62 junction 32 and the A1(M) at Ferrybridge, where the two meet at the major Ferrybridge interchange, and is known for its racecourse and its liquorice heritage. Wakefield Council is the West Yorkshire metropolitan highway authority, and its gangs work in Class 3 hi-vis amid that dense interchange country.",
   "The council runs a permit scheme controlling street works and a highways investment programme, delivering maintenance through a combination of in-house teams and framework contractors with regional collaboration via the Yorkshire highways alliance. The Ferrybridge and Knottingley area along the A1 and M62 hosts significant logistics estates.",
   "National Highways operates the M62 at junction 32 and the A1(M) at Ferrybridge, while the council-managed A645 and the A639 Park Road, the subject of a corridor improvement scheme, are local strategic routes. Motorway-interchange and corridor work alike mean fast roads and heavy traffic management.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Pontefract crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, interchange and winter-maintenance work",
  "s2_intro":"Across Pontefract's Wakefield carriageway work and the National Highways M62 and A1(M)",
 },
 "rushden": {
  "region":"Rushden and Northamptonshire",
  "nearby":["Wellingborough","Kettering","Bedford"],
  "snapshot":"iNeedWorkwear kits Rushden's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from North Northamptonshire Council's Kier term contract to National Highways work on the A45, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Rushden area's roads running",
  "s1loc":[
   "Rushden sits on the A45 with the large Rushden Lakes retail and leisure destination just off the road in the Nene valley, a major traffic generator, and carries a strong boot-and-shoe manufacturing heritage. North Northamptonshire Council, the unitary created in 2021, is the highway authority, and its gangs work in Class 3 hi-vis along that corridor.",
   "The council delivers highway maintenance through Kier on a term contract from September 2022 at roughly thirty million pounds a year, covering routine, reactive and cyclical work, winter service and surface dressing with an extension keeping Kier in place toward 2030. The wider North Northamptonshire logistics belt drives heavy goods traffic.",
   "National Highways operates the wider trunk network, while the council-managed A45 dual carriageway links toward Northampton and the A14 and the A6 corridor runs north-south through Rushden and Higham Ferrers toward Bedford and Kettering. Dual-carriageway and retail-corridor work alike mean fast roads and Nene valley structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Rushden crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, retail-corridor and winter-maintenance work",
  "s2_intro":"Across Rushden's Kier carriageway work and the National Highways A45",
 },
 "spalding": {
  "region":"Spalding and Lincolnshire",
  "nearby":["Boston","Peterborough","Stamford"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Spalding's highway maintenance teams and roadworks contractors, from Lincolnshire County Council's Balfour Beatty contract to the A16 corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Spalding area's roads running",
  "s1loc":[
   "Spalding is the heart of the Fens flower-and-food industry, long famous for the bulb and tulip trade and for large-scale vegetable and food processing, with its network centred on the A16. Lincolnshire County Council is the highway authority, and its gangs work in Class 3 hi-vis on a low-lying network built to move produce into national distribution.",
   "The county delivers core highways through Balfour Beatty Living Places, holding the contract since April 2020 with a substantial extension into the early 2030s, covering drainage and gully cleaning, winter gritting and reactive repairs through an operational control hub. The Springfields and A16 and A151 estates generate very high HGV movements.",
   "National Highways operates the wider trunk network, while the council-managed A16 links south toward Peterborough and the A1 and north toward Boston, the A151 runs east-west through the town and the A1073 heads toward Crowland. Fenland and freight work alike mean causeway and drain structures and heavy haulage.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Spalding crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, Fenland-corridor and winter-maintenance work",
  "s2_intro":"Across Spalding's Balfour Beatty carriageway work and the A16 corridor",
 },
 "malvern": {
  "region":"Malvern and Worcestershire",
  "nearby":["Worcester","Hereford","Droitwich"],
  "snapshot":"iNeedWorkwear kits Malvern's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Worcestershire County Council's Ringway contract to National Highways work on the M5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Malvern area's roads running",
  "s1loc":[
   "Malvern sits at the northern end of the Malvern Hills, a designated Area of Outstanding Natural Beauty, and has reinvented itself as a science and technology centre around the QinetiQ research site. Worcestershire County Council is the highway authority, and its gangs work in Class 3 hi-vis on hill-constrained roads feeding the A449.",
   "The county delivers highways through Ringway, its long-standing term contractor since the mid-2000s, covering carriageways, bridges, drainage, signs and markings, cyclical and winter maintenance plus fleet, at around twenty to thirty million pounds a year. The Malvern Technology Centre anchors local employment.",
   "National Highways operates the M5, reached toward Worcester at junction 7, while the council-managed A449 runs through Malvern toward Worcester and the dualled A4440 Worcester Southern Link Road and the A4538 improve journeys toward the M5. Hill-terrain and link-road work alike mean conservation constraints and corridor maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Malvern crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, hill-corridor and winter-maintenance work",
  "s2_intro":"Across Malvern's Ringway carriageway work and the National Highways M5 and A449",
 },
 "bromsgrove": {
  "region":"Bromsgrove and Worcestershire",
  "nearby":["Redditch","Droitwich","Kidderminster"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Bromsgrove's highway maintenance teams and roadworks contractors, from Worcestershire County Council's Ringway contract to National Highways work on the M5 and M42, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bromsgrove area's roads running",
  "s1loc":[
   "Bromsgrove sits between M5 junction 4 and M42 junction 1, with the A38 carrying the strategic flow between them as the town's main distributor. Worcestershire County Council is the highway authority, and its gangs work in Class 3 hi-vis at that motorway-junction location north of Worcester.",
   "The county delivers highways through Ringway, its long-standing term contractor since the mid-2000s, covering carriageways, structures, drainage, cyclical and winter service plus fleet, at around twenty to thirty million pounds a year. The Bromsgrove Enterprise Park and estates off the A38 toward the motorway junctions anchor local logistics.",
   "National Highways operates the M5 at junction 4 and the M42 at junction 1, with the A38 Bromsgrove Route Enhancement Programme improving junctions including Barley Mow Lane in recent years. Motorway-junction and A38 work alike mean fast roads and corridor enhancement schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Bromsgrove crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-junction and winter-maintenance work",
  "s2_intro":"Across Bromsgrove's Ringway carriageway work and the National Highways M5 and M42",
 },
 "stratford-upon-avon": {
  "region":"Stratford-upon-Avon and Warwickshire",
  "nearby":["Warwick","Leamington Spa","Evesham"],
  "snapshot":"iNeedWorkwear kits Stratford-upon-Avon's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Warwickshire County Council's Balfour Beatty contract to National Highways work on the A46, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Stratford-upon-Avon area's roads running",
  "s1loc":[
   "Stratford-upon-Avon is a major Shakespeare tourism destination, the Royal Shakespeare Theatre and birthplace sites drawing heavy seasonal visitor traffic onto the A46 and A3400 corridors. Warwickshire County Council is the highway authority, and its gangs work in Class 3 hi-vis managing roadworks around those peak tourist flows.",
   "The county delivers highways through Balfour Beatty Living Places in a joint contract with Coventry and Solihull, the seven-year deal covering over five thousand kilometres of road and tens of thousands of street lights. The Avenue Farm and Timothy's Bridge Road estates anchor local trade.",
   "National Highways operates the A46, which runs as Stratford's northern bypass linking the M40 toward Alcester, Evesham and the M5, while the A3400 Birmingham Road is the main route into the town centre meeting the A46 at Oversley Mill, with River Avon crossings such as Clopton Bridge. Bypass and tourist-route work alike mean fast roads and seasonal management.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Stratford crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, tourist-route and winter-maintenance work",
  "s2_intro":"Across Stratford-upon-Avon's Balfour Beatty carriageway work and the National Highways A46",
 },
 "bramhall": {
  "region":"Bramhall and Greater Manchester",
  "nearby":["Stockport","Wilmslow","Macclesfield"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Bramhall's highway maintenance teams and roadworks contractors, from Stockport Council to the A555 Manchester Airport Relief Road, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bramhall area's roads running",
  "s1loc":[
   "Bramhall's standout highways feature is the A555 Manchester Airport Relief Road on its southern edge, a modern dual carriageway opened in 2018 linking the A6 at Hazel Grove toward the airport and the A34. Stockport Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis along that new corridor under the Bee Network.",
   "The council delivers highways largely through its own highways and transport service with framework contractors, collaborating on shared Greater Manchester frameworks via the Combined Authority and Transport for Greater Manchester. The A555 added a significant new asset of carriageway, structures, drainage and lighting requiring ongoing maintenance.",
   "National Highways operates the wider trunk network, while the A555 Airport Relief Road runs south of the village, the A5102 Bramhall Lane runs through it, the A6 lies east through Hazel Grove and the A34 corridor to the west. Relief-road and distributor work alike mean fast roads and modern structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Bramhall crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, relief-road and winter-maintenance work",
  "s2_intro":"Across Bramhall's Stockport carriageway work and the A555 Manchester Airport Relief Road",
 },
 "ashton-in-makerfield": {
  "region":"Ashton-in-Makerfield and Greater Manchester",
  "nearby":["Wigan","St Helens","Leigh"],
  "snapshot":"iNeedWorkwear kits Ashton-in-Makerfield's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Wigan Council's in-house highways service to National Highways work on the M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Ashton-in-Makerfield area's roads running",
  "s1loc":[
   "Ashton-in-Makerfield's position at M6 junction 24 makes it a logistics and through-traffic hub, with the A49 and A58 carrying heavy local and goods movements feeding the motorway. Wigan Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis along that junction corridor under the Bee Network.",
   "The council delivers highway infrastructure in house through its Highways and Network Management group, maintaining around eleven hundred and sixty kilometres of road and over four hundred structures, and collaborating on shared Greater Manchester frameworks. Industrial estates around Ashton, Bryn and the junction 24 corridor anchor local trade.",
   "National Highways operates the M6 immediately east with junction 24 the key access fed by the A58, having completed corridor upgrade works around the junction, while the A49 Wigan Road is the main north-south spine and the A58 links eastward. Motorway and spine-road work alike mean fast roads and diversion pressure when the M6 closes.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Ashton crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, junction-corridor and winter-maintenance work",
  "s2_intro":"Across Ashton-in-Makerfield's Wigan carriageway work and the National Highways M6",
 },
 "heywood": {
  "region":"Heywood and Greater Manchester",
  "nearby":["Rochdale","Bury","Middleton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Heywood's highway maintenance teams and roadworks contractors, from Rochdale Council's in-house highways service to National Highways work on the M62 and M66, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Heywood area's roads running",
  "s1loc":[
   "Heywood sits between the M62 and M66 at the junction 19 interchange, anchored by the major Heywood Distribution Park, one of the North West's largest logistics parks generating intense HGV traffic. Rochdale Borough Council is the highway authority, and its gangs work in Class 3 hi-vis along that logistics gateway under the Bee Network.",
   "The council brought highways maintenance in house from 2022, delivering works directly through its own service with framework and utility support and collaborating on shared Greater Manchester frameworks. The Heywood Distribution Park drives pavement wear and roadworks demand on the local network and motorway feeders.",
   "National Highways operates the M62 with junction 19 the M62 and M66 interchange immediately to the south-east and the M66 along the eastern side toward Bury and the M60, while the council-managed A58 connects Bury, Heywood and Rochdale. Motorway-interchange and distribution work alike mean fast roads and heavy goods traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Heywood crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, logistics-corridor and winter-maintenance work",
  "s2_intro":"Across Heywood's Rochdale carriageway work and the National Highways M62 and M66",
 },
 "harpenden": {
  "region":"Harpenden and Hertfordshire",
  "nearby":["St Albans","Luton","Hemel Hempstead"],
  "snapshot":"iNeedWorkwear kits Harpenden's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Hertfordshire County Council's Ringway contract to National Highways work on the M1, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Harpenden area's roads running",
  "s1loc":[
   "Harpenden is a commuter town defined by the M1 at junction 9 and the A1081 commuter corridor toward St Albans and Luton, with heavy commuter and airport-related traffic. Hertfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that busy corridor.",
   "Hertfordshire retained Ringway, part of Vinci, as its term maintenance contractor on the new deal from October 2025, continuous since 2012 at a minimum of around fifty-five million pounds a year, covering potholes, lighting, drainage, gritting and grass cutting across roughly five thousand kilometres of road. Commercial provision around St Albans and Luton serves the area.",
   "National Highways operates the M1 with junction 9 at Redbourn the access and the A1(M) to the east, while the council-managed A1081 St Albans Road is the principal route through Harpenden toward Luton Airport and St Albans and the A5183 has seen safety works. Motorway and commuter-corridor work alike mean fast roads and daytime traffic management.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Harpenden crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, commuter-corridor and winter-maintenance work",
  "s2_intro":"Across Harpenden's Ringway carriageway work and the National Highways M1",
 },
 "littlehampton": {
  "region":"Littlehampton and West Sussex",
  "nearby":["Bognor Regis","Worthing","Chichester"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Littlehampton's highway maintenance teams and roadworks contractors, from West Sussex County Council's VolkerHighways contract to the A259 coastal corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Littlehampton area's roads running",
  "s1loc":[
   "Littlehampton sits on the A259 coastal corridor at the mouth of the River Arun, with its harbour and marina defining the town. West Sussex County Council is the highway authority, and its gangs work in Class 3 hi-vis along that coastal route and the seafront.",
   "The county's core highways contract moved from Balfour Beatty to VolkerHighways from April 2025 at around sixteen and a half million pounds a year, with FM Conway on drainage, while recent A259 improvements widened around two kilometres to dual carriageway with a new path. The Littlehampton Marina and Rustington Retail Park areas anchor local trade.",
   "National Highways operates the wider trunk network, while the council-managed A259 coastal corridor runs through the town toward Bognor Regis and Worthing and the A284 connects north, the A284 Lyminster Bypass having opened in May 2025. Coastal and bypass work alike mean exposed conditions and new structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Littlehampton crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, coastal-corridor and winter-maintenance work",
  "s2_intro":"Across Littlehampton's VolkerHighways carriageway work and the A259 coastal corridor",
 },
 "wishaw": {
  "region":"Wishaw and North Lanarkshire",
  "nearby":["Motherwell","Hamilton","Bellshill"],
  "snapshot":"iNeedWorkwear kits Wishaw's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from North Lanarkshire Council's Amey partnership to Transport Scotland trunk roads on the M74, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Wishaw area's roads running",
  "s1loc":[
   "Wishaw lies in the Lanarkshire hospital and industrial corridor close to the M74, anchored by the major University Hospital Wishaw off the A721 between the Craigneuk industrial area and Netherton. North Lanarkshire Council is the unitary roads authority, and its gangs work in Class 3 hi-vis blending NHS-site access and industrial traffic.",
   "Distinctively, the council has delivered local roads maintenance through a long-standing partnership with Amey since around 2000, covering carriageways, footways, lighting and winter service, separate from the trunk-road contracts. The Craigneuk industrial area and the wider Motherwell and Wishaw belt retain significant industrial and distribution estates.",
   "In Scotland trunk roads are Transport Scotland's responsibility, maintained in the south-west unit by Amey, with the M74 to the south and west the strategic link, the A721 Glasgow Road through Wishaw past the hospital and the A71 toward Edinburgh and Kilmarnock. Motorway and hospital-corridor work alike mean fast roads and a dual Amey presence.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Wishaw crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, hospital-corridor and winter-maintenance work",
  "s2_intro":"Across Wishaw's North Lanarkshire and Amey carriageway work and the Transport Scotland M74",
 },
 "colwyn bay": {
  "region":"Colwyn Bay and North Wales",
  "nearby":["Llandudno","Rhyl","Prestatyn"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Colwyn Bay's highway maintenance teams and roadworks contractors, from Conwy County Borough Council to Welsh Government trunk roads on the A55 North Wales Expressway, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Colwyn Bay area's roads running",
  "s1loc":[
   "Colwyn Bay sits on the A55 North Wales Expressway coastal corridor, where the trunk route runs tight between the sea and the hills as the town bypass. Conwy County Borough Council is the Welsh unitary highway authority, and its gangs work in Class 3 hi-vis on local roads where coastal exposure and landslip add retaining-wall and drainage demand.",
   "The council maintains adopted local roads, footways, drainage, lighting and structures, while the former coastal route through the town is now the A547 Conway Road. Local employment and trade estates serve the Colwyn Bay and Mochdre area off the A55 junctions.",
   "Trunk roads in Wales are the Welsh Government's responsibility via Traffic Wales and the North and Mid Wales Trunk Road Agent managing roughly a thousand and eighty kilometres including the A55 tunnels, with the A55 the Colwyn Bay bypass dual carriageway and the Conwy immersed-tube tunnel to the west. Coastal-trunk and local work alike mean sea-defence resilience and tourist and freight flows.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Colwyn Bay crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, coastal-corridor and winter-maintenance work",
  "s2_intro":"Across Colwyn Bay's council carriageway work and the Welsh Government A55",
 },
 "pontypridd": {
  "region":"Pontypridd and South Wales",
  "nearby":["Cardiff","Caerphilly","Merthyr Tydfil"],
  "snapshot":"iNeedWorkwear kits Pontypridd's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Rhondda Cynon Taf County Borough Council to Welsh Government trunk roads on the A470, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Pontypridd area's roads running",
  "s1loc":[
   "Pontypridd lies in the A470 Taff Valley with the trunk road threading the narrow valley floor, and is home to a major campus of the University of South Wales. Rhondda Cynon Taf County Borough Council is the Welsh unitary highway authority, and its gangs work in Class 3 hi-vis on the valley-side roads and flood-prone river crossings.",
   "The council maintains local carriageways, footways and the numerous valley-side structures and retaining walls in house, while the Treforest Industrial Estate just south is one of the largest in south Wales, served off the A470 and A4054 and generating substantial commercial traffic. Valley-floor congestion at junctions such as Upper Boat is a recurring focus.",
   "Trunk roads in Wales are the Welsh Government's responsibility via Traffic Wales and the South Wales Trunk Road Agent, with the A470 the spine route up the Taff toward Merthyr Tydfil and mid Wales, the A4054 the older valley road and the A4058 toward the Rhondda. Trunk and valley work alike mean constrained junctions and flood resilience.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Pontypridd crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, valley-corridor and winter-maintenance work",
  "s2_intro":"Across Pontypridd's council carriageway work and the Welsh Government A470",
 },
 "darwen": {
  "region":"Darwen and Lancashire",
  "nearby":["Blackburn","Bolton","Accrington"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Darwen's highway maintenance teams and roadworks contractors, from Blackburn with Darwen Council to National Highways work on the M65, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Darwen area's roads running",
  "s1loc":[
   "Darwen sits amid the West Pennine Moors south of Blackburn, connected to the M65 at junction 4 on its northern boundary, with the A666 Bolton Road the main north-south corridor. Blackburn with Darwen Borough Council is the unitary highway authority, and its gangs work in Class 3 hi-vis spanning urban corridor and exposed moorland routes.",
   "The council maintains adopted roads, footways, drainage, lighting and structures in house with term and framework contractor support, the moorland fringe adding gritting and embankment considerations. Industrial and trade estates along the A666 and toward the M65 junction 4 corridor serve manufacturing and distribution.",
   "National Highways operates the M65 along the northern edge with junction 4 at Earcroft and the Extra services, while the council-managed A666 Bolton Road runs toward Blackburn and Bolton and the A6177 forms part of the orbital network. Motorway and moorland work alike mean fast roads and weather-driven winter service.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Darwen crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, moorland-route and winter-maintenance work",
  "s2_intro":"Across Darwen's Blackburn with Darwen carriageway work and the National Highways M65",
 },
 "brentwood": {
  "region":"Brentwood and Essex",
  "nearby":["Romford","Upminster","Billericay"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Brentwood's highway maintenance teams and roadworks contractors, from Essex County Council's Essex Highways partnership with Ringway Jacobs to National Highways work on the A12 and M25, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Brentwood area's roads running",
  "s1loc":[
   "Brentwood sits where the A12 trunk road meets the M25 at junction 28, long a congested capacity pinch point on the south-west Essex fringe. Essex County Council is the highway authority, and its gangs work in Class 3 hi-vis around that busy interchange and the town's commuter routes.",
   "The council delivers through the Essex Highways integrated partnership with Ringway Jacobs, in place since 2012 and running under an extension with a successor being procured, covering around five thousand miles of carriageway, while National Highways has built the M25 junction 28 free-flow loop scheme with contractor Graham. The Childerditch and West Horndon estates anchor local trade.",
   "National Highways operates the A12 and the M25 meeting at junction 28, where the new two-lane free-flow loop eases anticlockwise M25 to eastbound A12 movements, with Brentwood reached via the A1023 and the A128 the key local north-south county route. Trunk, orbital and interchange work alike mean fast roads and major junction schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Brentwood crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, interchange and winter-maintenance work",
  "s2_intro":"Across Brentwood's Ringway Jacobs carriageway work and the National Highways A12 and M25",
 },
 "nelson": {
  "region":"Nelson and Lancashire",
  "nearby":["Colne","Burnley","Accrington"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Nelson's highway maintenance teams and roadworks contractors, from Lancashire County Council to the M65 Pennine corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Nelson area's roads running",
  "s1loc":[
   "Nelson is a Pendle cotton-weaving town in east Lancashire whose dense Victorian terraced streets feed onto the M65, the council-maintained section of which runs through the town. Lancashire County Council is the highway authority for around four thousand six hundred miles of road, and its gangs work in Class 3 hi-vis across that mix of tight terraces and motorway-standard junctions.",
   "The county delivers highway maintenance largely in house with around a hundred and sixty winter-service staff and seven operational depots, drawing on repairs and asset-management frameworks for specific works. Notably National Highways operates the M65 only as far as junction 10 at Burnley, so the Nelson and Colne junctions 12 to 14 are maintained by Lancashire County Council.",
   "From junction 10 east the council maintains the M65, while the A682 runs from Nelson toward Barrowford and the Pennines and the A56 meets it near junction 13, with resurfacing around junction 13 unlocking the A682 growth corridor. Council-motorway and A-road work alike mean fast roads and Pennine exposure.",
   "Surfacing, lining, drainage, lighting and winter gritting are all handled by Nelson crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, motorway-spur and winter-maintenance work",
  "s2_intro":"Across Nelson's Lancashire carriageway work and the M65 Pennine corridor",
 },
 "radcliffe": {
  "region":"Radcliffe and Greater Manchester",
  "nearby":["Bury","Whitefield","Bolton"],
  "snapshot":"iNeedWorkwear kits Radcliffe's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Bury Council to National Highways work on the M60 and M66, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Radcliffe area's roads running",
  "s1loc":[
   "Radcliffe sits in the M60 and M66 corridor on the River Irwell, on the Metrolink East Lancashire line built on the former railway alignment. Bury Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis across a multi-authority picture of council roads, Metrolink and motorways.",
   "The council maintains the adopted network and structures, carrying out general inspections of bridges and retaining walls on a rolling cycle, with strategic transport and the tram run by Transport for Greater Manchester. Bury has delivered flood-alleviation work in Radcliffe including a flood-gate scheme at Hardy's Gate Bridge.",
   "National Highways operates the M60 Manchester orbital and the M66 Bury link, while the council-managed A665 is the principal route through Radcliffe toward Manchester and Whitefield, with Irwell river crossings significant local structures. Orbital and river-crossing work alike mean fast roads and flood-resilient structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Radcliffe crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, river-crossing and winter-maintenance work",
  "s2_intro":"Across Radcliffe's Bury carriageway work and the National Highways M60 and M66",
 },
 "farnworth": {
  "region":"Farnworth and Greater Manchester",
  "nearby":["Bolton","Radcliffe","Horwich"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Farnworth's highway maintenance teams and roadworks contractors, from Bolton Council to National Highways work on the M61, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Farnworth area's roads running",
  "s1loc":[
   "Farnworth is a dense former cotton-and-coal town tightly embedded in the Bolton conurbation, sitting on the A6 and A575 corridor with the M61 close by. Bolton Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis on that tight urban network under the Bee Network.",
   "The council maintains the borough's adopted carriageways, footways and structures, publishing a classified road list and maintenance programme, with strategic transport via Transport for Greater Manchester. Overnight maintenance on the A666 St Peter's Way routinely diverts through Farnworth and the A575.",
   "National Highways operates the M61 on the western flank toward Preston and the M6, while the A6 is the historic Manchester-to-Preston corridor, the A575 Manchester Road runs through Farnworth and Kearsley and the A666 St Peter's Way links to the M61. Motorway and diversion-route work alike mean fast roads and tightly managed urban sites.",
   "Surfacing, lining, drainage, lighting and winter gritting are all handled by Farnworth crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, diversion-route and winter-maintenance work",
  "s2_intro":"Across Farnworth's Bolton carriageway work and the National Highways M61",
 },
 "fleetwood": {
  "region":"Fleetwood and Lancashire",
  "nearby":["Thornton Cleveleys","Poulton-le-Fylde","Blackpool"],
  "snapshot":"iNeedWorkwear kits Fleetwood's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Lancashire County Council to National Highways work on the A585, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Fleetwood area's roads running",
  "s1loc":[
   "Fleetwood is a planned Victorian fishing port at the very end of the Fylde peninsula, its single dominant arterial dependence on the A585 to reach the M55 making that corridor critical. Lancashire County Council is the highway authority, and its gangs work in Class 3 hi-vis on that peninsula network.",
   "The county delivers highway maintenance largely in house with directly-employed crews, seven depots and county-wide winter service, supported by repairs and asset-management frameworks. Fleetwood retains port and fish-handling facilities and a Fish Dock with slipway, adding dock-access road maintenance.",
   "The A585 is the primary access corridor, its National Highways trunk section improved by the Windy Harbour to Skippool bypass around Little Singleton that opened in 2024 at around a hundred and fifty million pounds, while the A587 runs through Cleveleys. Trunk and peninsula work alike mean single-corridor reliance and coastal exposure.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Fleetwood crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the port town's carriageway, peninsula-route and winter-maintenance work",
  "s2_intro":"Across Fleetwood's Lancashire carriageway work and the National Highways A585",
 },
 "congleton": {
  "region":"Congleton and Cheshire",
  "nearby":["Macclesfield","Sandbach","Biddulph"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Congleton's highway maintenance teams and roadworks contractors, from Cheshire East Council's Ringway Jacobs partnership to the A34 and the Congleton Link Road, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Congleton area's roads running",
  "s1loc":[
   "Congleton is a historic silk-and-textile town on the A34 corridor, where the new Congleton Link Road has reshaped local traffic by taking through-movements off the constrained town centre. Cheshire East Council is the highway authority, and its gangs work in Class 3 hi-vis across that older network and the fresh link-road asset.",
   "The council delivers highways through Cheshire East Highways, its long-running integrated partnership with Ringway Jacobs since 2011, renewed on a contract reported at around six hundred million pounds over about fifteen years covering more than sixteen hundred miles of road. The Congleton Link Road, Wolstenholme Elmy Way, opened in 2021 at around ninety million pounds, built by Graham.",
   "National Highways operates the wider strategic network, while the council-managed A34 is the historic north-south corridor, the A54 runs toward Buxton and the A536 toward Macclesfield, the new link road connecting the A534 to the A536. A-road and link-road work alike mean busy corridors and a modern highway asset to maintain.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Congleton crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, link-road and winter-maintenance work",
  "s2_intro":"Across Congleton's Ringway Jacobs carriageway work and the A34 and Congleton Link Road",
 },
 "kingswinford": {
  "region":"Kingswinford and the Black Country",
  "nearby":["Dudley","Stourbridge","Brierley Hill"],
  "snapshot":"iNeedWorkwear kits Kingswinford's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Dudley Council and the Black Country highways framework to the A491, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Kingswinford area's roads running",
  "s1loc":[
   "Kingswinford sits on the western edge of the Black Country in the historic Stourbridge Glass Quarter, with the A491 Market Street its main spine through a dense urban grid. Dudley Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis in built-up, kerbed streets.",
   "Dudley procures carriageway surfacing and minor works through the collaborative Black Country highways framework with Sandwell, Walsall and Wolverhampton, with Colas among the appointed contractors and a successor four-year framework running from April 2026. The Pensnett Trading Estate just east generates heavy goods movements feeding the A4101 and A491.",
   "National Highways operates the wider strategic network with no motorway through the town, while the council-managed A491 links toward Stourbridge and Wolverhampton and the A4101 connects east toward Dudley and Brierley Hill. Urban-grid and trading-estate work alike mean kerbed streets and heavy local freight.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Kingswinford crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, urban-grid and winter-maintenance work",
  "s2_intro":"Across Kingswinford's Black Country framework carriageway work and the A491",
 },
 "burntwood": {
  "region":"Burntwood and Staffordshire",
  "nearby":["Lichfield","Cannock","Rugeley"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Burntwood's highway maintenance teams and roadworks contractors, from Staffordshire County Council's Amey Infrastructure Plus partnership to National Highways work on the A5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Burntwood area's roads running",
  "s1loc":[
   "Burntwood sits beside Chasewater reservoir and country park on the southern fringe of Cannock Chase, with the A5 Watling Street a major freight route just to the south. Staffordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis across that mix of bypass, semi-rural lanes and AONB edge.",
   "Highways run through the Infrastructure Plus partnership with Amey, in place since 2014 and extended from October 2024, covering maintenance, structures, transport planning and environmental services. The Burntwood Business Park and industrial areas off the A5195 feed the A5 corridor.",
   "National Highways operates the A5 toward the M6 Toll at junction T6, while the council-managed A5195 Burntwood Bypass skirts the southern edge, the A5190 runs east toward the A461 and Lichfield and the A460 lies to the west toward Cannock. Trunk and bypass work alike mean fast roads and AONB-edge constraints.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Burntwood crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bypass-corridor and winter-maintenance work",
  "s2_intro":"Across Burntwood's Amey carriageway work and the National Highways A5",
 },
 "melton mowbray": {
  "region":"Melton Mowbray and Leicestershire",
  "nearby":["Leicester","Loughborough","Grantham"],
  "snapshot":"iNeedWorkwear kits Melton Mowbray's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Leicestershire County Council's Aggregate Industries patching contract to the Melton Mowbray Distributor Road, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Melton Mowbray area's roads running",
  "s1loc":[
   "Melton Mowbray is the rural capital of food, home to the Melton Mowbray pork pie and a centre of Stilton cheese production, with the distributor road relief scheme aimed at taking through-traffic out of the historic centre. Leicestershire County Council is the highway authority for around three thousand miles of road, and its gangs work in Class 3 hi-vis across the Leicestershire Wolds.",
   "Carriageway patching and pothole repair are delivered through the joint contract with Leicester City awarded to Aggregate Industries, while the North and East Melton Mowbray Distributor Road, the council's largest-ever scheme at around a hundred and thirty-four million pounds and built by Galliford Try, adds six roundabouts, four bridges and a rerouted section of the River Eye. Food-manufacturing sites generate the freight it is designed to relieve.",
   "National Highways operates the wider trunk network, while the council-managed A606 runs the Nottingham-to-Oakham axis through the town, the A607 the Leicester-to-Grantham road and the A6006 east-west, with the new distributor road around the east. A-road and distributor work alike mean busy roads and major new structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Melton crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, distributor-road and winter-maintenance work",
  "s2_intro":"Across Melton Mowbray's Aggregate Industries carriageway work and the Melton Mowbray Distributor Road",
 },
 "daventry": {
  "region":"Daventry and Northamptonshire",
  "nearby":["Northampton","Rugby","Banbury"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Daventry's highway maintenance teams and roadworks contractors, from West Northamptonshire Council's Kier contract to National Highways work at the DIRFT rail freight terminal, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Daventry area's roads running",
  "s1loc":[
   "Daventry sits at the heart of the golden triangle logistics corridor, defined by DIRFT, the Daventry International Rail Freight Terminal at the junction of the M1, A5 and A428 with links to the West Coast Main Line. West Northamptonshire Council, the unitary created in 2021, is the highway authority, and its gangs work in Class 3 hi-vis beside that heavy HGV traffic.",
   "The council delivers highway services through Kier on a contract at roughly thirty million pounds a year from September 2022, with an initial seven-year term and options to extend. DIRFT and its successive expansion phases add millions of square feet of warehousing, with major logistics occupiers driving freight volumes.",
   "National Highways operates the M1, A5 Watling Street and A14 nearby, while the council-managed A45 is the main east-west corridor toward Northampton and the M1, with the A361 and A425 serving the town. Motorway-cluster and freight-route work alike mean fast roads and intense HGV movement.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Daventry crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, freight-corridor and winter-maintenance work",
  "s2_intro":"Across Daventry's Kier carriageway work and the National Highways M1 and A45",
 },
 "frome": {
  "region":"Frome and Somerset",
  "nearby":["Trowbridge","Bath","Bridgwater"],
  "snapshot":"iNeedWorkwear kits Frome's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Somerset Council's Kier term contract to the A361, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Frome area's roads running",
  "s1loc":[
   "Frome is a historic Somerset market town on uneven high ground at the eastern end of the Mendip Hills, a former woollen-cloth town now known for its independent centre. Somerset Council, the unitary formed in 2023, is the highway authority for around four thousand miles of road, and its gangs work in Class 3 hi-vis on hilly, semi-rural roads.",
   "The council appointed Kier on a new eight-year core maintenance contract at around two hundred and twenty-five million pounds from April 2024, replacing Milestone Infrastructure, covering road repairs, drainage, verge cutting and winter gritting with further firms on surfacing lots. Industrial and trading estates off the A361 and A362 generate town traffic.",
   "National Highways operates the wider trunk network, while the council-managed A361 forms the Frome bypass around the southern and eastern edges toward Trowbridge and Ilchester and the A362 runs through the centre toward Radstock and Warminster. Bypass and through-route work alike mean hilly terrain and market-town sites.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Frome crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, bypass-corridor and winter-maintenance work",
  "s2_intro":"Across Frome's Kier carriageway work and the A361",
 },
 "willenhall": {
  "region":"Willenhall and the Black Country",
  "nearby":["Walsall","Wolverhampton","Wednesbury"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Willenhall's highway maintenance teams and roadworks contractors, from Walsall Council and the Black Country highways framework to National Highways work on the M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Willenhall area's roads running",
  "s1loc":[
   "Willenhall is historically the lock-making capital of Britain, preserved at the Locksmith's House, and sits right on the M6 at junction 10, making it a key freight and commuter gateway for the Black Country. Walsall Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis beside that motorway junction.",
   "Walsall runs a Highway Infrastructure Services Contract measured by performance indicators and procures works through the Wolverhampton-led Black Country highways framework with Colas among the contractors, while its street lighting runs through a PFI with Amey. The M6 junction 10 four-lane roundabout upgrade was completed in 2024 by John Sisk.",
   "National Highways operates the M6 at junction 10, while the council-managed A454 Wolverhampton Road and the A462 toward Wednesfield serve the town. Motorway-junction and arterial work alike mean fast roads and freight-heavy corridors.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Willenhall crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, junction-corridor and winter-maintenance work",
  "s2_intro":"Across Willenhall's Black Country framework carriageway work and the National Highways M6",
 },
 "bilston": {
  "region":"Bilston and the Black Country",
  "nearby":["Wolverhampton","Wednesbury","Sedgley"],
  "snapshot":"iNeedWorkwear kits Bilston's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from the City of Wolverhampton Council and the Black Country highways framework to the A463 Black Country Route, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bilston area's roads running",
  "s1loc":[
   "Bilston is a major stop on the West Midlands Metro, its Bilston Central tram stop in a brick-lined former railway cutting, and sits on the A463 Black Country Route. The City of Wolverhampton Council is the highway authority and the lead authority for the Black Country highways framework, and its gangs work in Class 3 hi-vis along that tram-and-route corridor.",
   "Wolverhampton procures the Black Country Highways Works Framework on behalf of the four boroughs with Colas among the contractors, and runs a multi-million-pound capital programme, maintaining around four hundred and eighty miles of road, with recent works on the Black Country Route islands and Bilston Urban Village. The planned Wednesbury-to-Brierley Hill Metro extension will reshape tram-road interfaces nearby.",
   "National Highways operates the wider motorway network, while the council-managed A463 Black Country Route runs through with recent resurfacing at the Coseley Road roundabout and the A41 Black Country New Road links toward the M6. Route and tram-corridor work alike mean busy roads and close-packed infrastructure.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Bilston crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, tram-corridor and winter-maintenance work",
  "s2_intro":"Across Bilston's Black Country framework carriageway work and the A463 Black Country Route",
 },
 "sedgley": {
  "region":"Sedgley and the Black Country",
  "nearby":["Dudley","Wolverhampton","Bilston"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Sedgley's highway maintenance teams and roadworks contractors, from Dudley Council and the Black Country highways framework to the A463 and A4123 corridors, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Sedgley area's roads running",
  "s1loc":[
   "Sedgley stands on a prominent ridge above Dudley, crowned by Sedgley Beacon at around two hundred and thirty-seven metres, one of the highest points in the West Midlands. Dudley Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis on hilly roads where topography shapes drainage and surfacing demand.",
   "Dudley repairs roads and pavements and runs a maintenance programme and street-works register, procuring works in recent years through the Wolverhampton-led Black Country highways framework with Colas among the contractors. Sedgley is largely residential on the ridge with light-industrial pockets served from borough depots.",
   "National Highways operates the wider motorway network, while the council-managed A459 runs through the town past Upper Gornal, the A463 Black Country Route crosses toward Bilston and the M6, and the A4123 Birmingham New Road passes close by as a primary corridor. Ridge-road and route work alike mean drainage-heavy maintenance and busy arterials.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Sedgley crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, ridge-road and winter-maintenance work",
  "s2_intro":"Across Sedgley's Black Country framework carriageway work and the A459 and A4123 corridors",
 },
 "tipton": {
  "region":"Tipton and the Black Country",
  "nearby":["West Bromwich","Wednesbury","Dudley"],
  "snapshot":"iNeedWorkwear kits Tipton's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Sandwell Council and the Black Country highways framework to the A461 corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Tipton area's roads running",
  "s1loc":[
   "Tipton once had the most extensive canal network in the country and was nicknamed the Venice of the Midlands, its dense Black Country canals shaping bridges, embankments and constrained road corridors. Sandwell Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis across that canal-threaded network.",
   "Sandwell maintains its network through a risk-based asset management plan and procures works through the Wolverhampton-led Black Country highways framework with Colas among the contractors, having delivered around two point two million pounds of A461 improvements between Great Bridge and Peake Drive. The future Wednesbury-to-Brierley Hill Metro extension is routed through Tipton.",
   "National Highways operates the wider motorway network with M5 and M6 access via the Black Country, while the council-managed A461 Dudley Port corridor and the A4037 serve the town. Canal-side and arterial work alike mean bridge and embankment structures and busy local roads.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Tipton crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, canal-side and winter-maintenance work",
  "s2_intro":"Across Tipton's Black Country framework carriageway work and the A461 corridor",
 },
 "bloxwich": {
  "region":"Bloxwich and the Black Country",
  "nearby":["Walsall","Willenhall","Wolverhampton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Bloxwich's highway maintenance teams and roadworks contractors, from Walsall Council and the Black Country highways framework to the A34 and M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bloxwich area's roads running",
  "s1loc":[
   "Bloxwich grew up on the A34, the Southampton-to-Manchester road that runs straight through the town as its High Street, surrounded by the Wyrley and Essington and Walsall canals. Walsall Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis along that A34 spine and the Walsall corridor.",
   "Walsall runs its Highway Infrastructure Services Contract governed by performance indicators, procures works through the Wolverhampton-led Black Country highways framework with Colas among the contractors, and delivers street lighting through a PFI with Amey. Industrial estates served by the A34 and the M6 junction 10 corridor anchor local trade.",
   "National Highways operates the M6 at junction 10 nearby, recently upgraded with a four-lane roundabout, while the council-managed A34 runs through the town and the A4124 serves the Bloxwich-to-Walsall area. Trunk-spine and motorway-corridor work alike mean fast roads and busy through-traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Bloxwich crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, A34-corridor and winter-maintenance work",
  "s2_intro":"Across Bloxwich's Black Country framework carriageway work and the A34 and M6",
 },
 "ashington": {
  "region":"Ashington and Northumberland",
  "nearby":["Blyth","Bedlington","Morpeth"],
  "snapshot":"iNeedWorkwear kits Ashington's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Northumberland County Council's in-house highways service to the A189 Spine Road, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Ashington area's roads running",
  "s1loc":[
   "Ashington is a former pit town, once billed as the world's largest mining village, strung along the A189 South East Northumberland Spine Road built to regenerate the historic coalfield. Northumberland County Council is the unitary highway authority, and its gangs work in Class 3 hi-vis across that dual-carriageway corridor.",
   "The council delivers highway maintenance largely in house, its own teams handling resurfacing, cyclic maintenance, lighting and pothole repair with framework contractors for larger programmes. The standout recent change is the Northumberland Line, a roughly two-hundred-and-ninety-eight-million-pound rail reopening with Ashington station opening in December 2024, with Wansbeck Business Park and North Seaton estate among local employment.",
   "National Highways operates the A1 and A19 trunk roads to the south and west, while the council-managed A189 Spine Road links Ashington, Blyth and Newbiggin to Tyneside and the A197 is the main route through the town. Spine-road and town work alike mean fast roads and regeneration-driven schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Ashington crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, spine-road and winter-maintenance work",
  "s2_intro":"Across Ashington's Northumberland carriageway work and the A189 Spine Road",
 },
 "gosforth": {
  "region":"Gosforth and Newcastle upon Tyne",
  "nearby":["Newcastle upon Tyne","Whitley Bay","North Shields"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Gosforth's highway maintenance teams and roadworks contractors, from Newcastle City Council to National Highways work on the A1 Western Bypass, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Gosforth area's roads running",
  "s1loc":[
   "Gosforth is a Newcastle suburb defined by its position between the A1 Newcastle Western Bypass to the west and the A167 Great North Road through its centre, with the Regent Centre business and transport interchange a key node. Newcastle City Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the High Street and those arterial corridors.",
   "The council manages and maintains local roads directly, inspecting main shopping streets including Gosforth High Street on a roughly monthly cycle with an annual works programme agreed with ward councillors. The Regent Centre on the A167 and Metro corridor is the major office hub.",
   "National Highways operates the A1 Newcastle-Gateshead Western Bypass immediately west, one of the busiest A1 sections in the North East and the subject of congestion-relief study, while the council-managed A189 links toward the Spine Road and the A167 is the former Great North Road. Bypass and arterial work alike mean fast roads and persistent congestion pressure.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Gosforth crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bypass-corridor and winter-maintenance work",
  "s2_intro":"Across Gosforth's Newcastle carriageway work and the National Highways A1 Western Bypass",
 },
 "jarrow": {
  "region":"Jarrow and South Tyneside",
  "nearby":["South Shields","Gateshead","Washington"],
  "snapshot":"iNeedWorkwear kits Jarrow's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from South Tyneside Council to National Highways work on the A19 and the Tyne Tunnel, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Jarrow area's roads running",
  "s1loc":[
   "Jarrow combines deep shipbuilding and industrial heritage, and its place in the history of the 1936 Jarrow March, with its modern role as a gateway to the Tyne Tunnel on the A19. South Tyneside Council is the unitary highway authority, and its gangs work in Class 3 hi-vis beside the tunnel approaches and the A19.",
   "The council invests up to around four and a half million pounds a year on road and footpath maintenance through council teams and contractors, with a recent roughly nine-hundred-thousand-pound programme improving traffic signals and lane markings on the A185 between Jarrow and Hebburn. Industrial sites around Bede and Monkton and the riverside anchor local logistics.",
   "National Highways operates the A19 trunk road and the Tyne Tunnel crossing under the river, with strengthening at Testo's and Lindisfarne roundabouts and a tunnel-approach lane gain, while the council-managed A185 links to the tunnel approaches and Hebburn. Trunk and tunnel-approach work alike mean fast roads and junction and signalling maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Jarrow crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, tunnel-approach and winter-maintenance work",
  "s2_intro":"Across Jarrow's South Tyneside carriageway work and the National Highways A19",
 },
 "clydebank": {
  "region":"Clydebank and West Dunbartonshire",
  "nearby":["Glasgow","Dumbarton","Renfrew"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Clydebank's highway maintenance teams and roadworks contractors, from West Dunbartonshire Council to Transport Scotland trunk roads on the A82, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Clydebank area's roads running",
  "s1loc":[
   "Clydebank is shaped by its shipbuilding past, above all the former John Brown shipyard that built the Queen Mary and QE2, marked today by the preserved Titan Crane at Queens Quay. West Dunbartonshire Council is the unitary roads authority, and its gangs work in Class 3 hi-vis along the A814 and the riverside regeneration.",
   "The council maintains local adopted roads including the A814 Glasgow Road through the town, running winter gritting and roadworks coordination, with Clydebank Business Park and the Queens Quay former-shipyard area the main employment sites. Riverside regeneration drives recent local highway activity.",
   "In Scotland trunk roads are Transport Scotland's responsibility, with the A82 the strategic route maintained from the Erskine Bridge to Stoneymollan by Amey in the south-west unit and by BEAR Scotland further north, while the A814 Great Western Road is the principal council artery. Trunk and local work alike mean fast roads and a split operator picture.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Clydebank crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, riverside-corridor and winter-maintenance work",
  "s2_intro":"Across Clydebank's West Dunbartonshire carriageway work and the Transport Scotland A82",
 },
 "shipley": {
  "region":"Shipley and West Yorkshire",
  "nearby":["Bingley","Keighley","Guiseley"],
  "snapshot":"iNeedWorkwear kits Shipley's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Bradford Council and the Yorkshire Alliance framework to the A650 Airedale corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Shipley area's roads running",
  "s1loc":[
   "Shipley adjoins Saltaire, the Victorian model village and UNESCO World Heritage Site whose protective buffer zone constrains road and bypass planning along the Airedale corridor. The City of Bradford Metropolitan District Council is the highway authority, and its gangs work in Class 3 hi-vis along the A650 through that heritage-sensitive valley.",
   "Bradford procures highways works through the Yorkshire Highway Alliance, the multi-authority framework whose contractors include Colas, for planned surfacing and improvement programmes, with major corridor schemes delivered with the West Yorkshire Combined Authority. The Bradford-Shipley Route Improvement Scheme at around forty-seven million pounds upgrades the A650 corridor.",
   "National Highways operates the wider strategic network with no trunk road through the town, while the council-managed A650 runs the Airedale corridor from Keighley toward Bradford and Bingley past the improved Saltaire roundabout and the A657 links toward Leeds. Airedale-corridor and heritage work alike mean busy roads and conservation constraints.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Shipley crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, Airedale-corridor and winter-maintenance work",
  "s2_intro":"Across Shipley's Yorkshire Alliance carriageway work and the A650 Airedale corridor",
 },
 "pontypool": {
  "region":"Pontypool and Torfaen",
  "nearby":["Cwmbran","Newport","Caerphilly"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Pontypool's highway maintenance teams and roadworks contractors, from Torfaen County Borough Council to Welsh Government trunk roads on the A4042, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Pontypool area's roads running",
  "s1loc":[
   "Pontypool sits on the A4042 trunk corridor through the Eastern Valley, with historic ironworks heritage and Pontypool Park and its Italianate gateway and ski-slope hillside defining the town. Torfaen County Borough Council is the Welsh unitary highway authority, based at the Civic Centre in Pontypool, and its gangs work in Class 3 hi-vis on those steep valley roads.",
   "The council manages the local network largely in house through its Neighbourhood Services and Highways teams, coordinating roadworks, winter service and a Highway Asset Management Plan with external plant contractors for snow clearance. The New Inn and Mamhilad area provides local depot and industrial capacity.",
   "Trunk roads in Wales are the Welsh Government's responsibility via Traffic Wales and the South Wales Trunk Road Agent, with the A4042 the Newport-to-Abergavenny trunk road past Pontypool and the A472 the cross-valley route, the Pontypool roundabout improved in recent years. Trunk and valley work alike mean steep slopes and roundabout schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Pontypool crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, valley-corridor and winter-maintenance work",
  "s2_intro":"Across Pontypool's council carriageway work and the Welsh Government A4042",
 },
 "penarth": {
  "region":"Penarth and the Vale of Glamorgan",
  "nearby":["Cardiff","Barry","Cwmbran"],
  "snapshot":"iNeedWorkwear kits Penarth's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from the Vale of Glamorgan Council to Welsh Government trunk roads near the M4, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Penarth area's roads running",
  "s1loc":[
   "Penarth is defined by Cardiff Bay, the Barrage with its locks and the road link across to Cardiff Bay, and Penarth Marina inside the impounded bay. The Vale of Glamorgan Council is the Welsh unitary highway authority, and its gangs work in Class 3 hi-vis on the seafront and waterfront roads of this commuter town adjoining the capital.",
   "The council's Highway Maintenance Division is responsible for all adopted highways in the Vale, delivered largely in house with supporting contractors, with the marina and barrage corridor focal points for access and active-travel schemes. Industrial and depot capacity is shared with the wider Vale toward Barry.",
   "Trunk roads in Wales are the Welsh Government's responsibility via Traffic Wales and the South Wales Trunk Road Agent, with the M4 reached at junction 33 onto the A4232 peripheral distributor and the A4160 the historic road into Penarth, while the Cardiff Bay Barrage carries the link to Cardiff Bay. Trunk-access and waterfront work alike mean barrage structures and busy commuter flows.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Penarth crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, waterfront-corridor and winter-maintenance work",
  "s2_intro":"Across Penarth's council carriageway work and the Welsh Government A4232 and A4160",
 },
 "fleet": {
  "region":"Fleet and Hampshire",
  "nearby":["Farnborough","Aldershot","Farnham"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Fleet's highway maintenance teams and roadworks contractors, from Hampshire County Council's M Group Highways contract to National Highways work on the M3, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Fleet area's roads running",
  "s1loc":[
   "Fleet is a Hampshire commuter-belt town defined by M3 junction 4a access and the Fleet motorway services between junctions 4a and 5, with the A323 and A287 carrying local through-traffic. Hampshire County Council is the highway authority for one of the largest networks in England, and its gangs work in Class 3 hi-vis in that north-east Hampshire corridor.",
   "Hampshire Highways runs through the partnership with Milestone Infrastructure, now trading as M Group Highways, in place since 2017 and extended to 2029, covering over eight thousand five hundred kilometres of carriageway, with a separate large civils framework for major schemes. Depot capacity sits around Fleet and the neighbouring Farnborough and Aldershot employment areas.",
   "National Highways operates the M3 with junction 4a the principal access and the Fleet services on the mainline, while the council-managed A323 Fleet Road runs toward Aldershot and Guildford and the A287 toward Farnham and Odiham. Motorway and distributor work alike mean fast roads and commuter-belt flows.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Fleet crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, commuter-corridor and winter-maintenance work",
  "s2_intro":"Across Fleet's M Group Highways carriageway work and the National Highways M3",
 },
 "totton": {
  "region":"Totton and Hampshire",
  "nearby":["Southampton","Eastleigh","Winchester"],
  "snapshot":"iNeedWorkwear kits Totton's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Hampshire County Council's M Group Highways contract to National Highways work on the M27, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Totton area's roads running",
  "s1loc":[
   "Totton sits on the New Forest edge where the Waterside meets Southampton, with the A326 carrying Fawley refinery and Waterside traffic south and the A35 and M27 forming the strategic link at Redbridge. Hampshire County Council is the highway authority, and its gangs work in Class 3 hi-vis on that forest-edge and Waterside corridor.",
   "Hampshire Highways runs through the partnership with Milestone Infrastructure, now trading as M Group Highways, in place since 2017 and extended to 2029, with the county's large civils framework for major schemes. The council has been developing the A326 North Waterside improvement scheme between west Totton and Dibden.",
   "National Highways operates the M27 reached via the A35 and A326 at junction 2 via the Redbridge corridor, while the A326 is the Waterside dual carriageway south toward Fawley and the A35 runs toward the New Forest. Motorway and Waterside-freight work alike mean fast roads and refinery traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Totton crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, Waterside-corridor and winter-maintenance work",
  "s2_intro":"Across Totton's M Group Highways carriageway work and the National Highways M27 and A326",
 },
 "east grinstead": {
  "region":"East Grinstead and West Sussex",
  "nearby":["Crawley","Haywards Heath","Crowborough"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to East Grinstead's highway maintenance teams and roadworks contractors, from West Sussex County Council's VolkerHighways contract to the A22 and A264, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the East Grinstead area's roads running",
  "s1loc":[
   "East Grinstead lies on the Surrey-Sussex border near Gatwick, defined by the A22 and A264 junction and their shared single-carriageway stretch to Felbridge. West Sussex County Council is the highway authority, and its gangs work in Class 3 hi-vis along those border corridors.",
   "The county's core highways contract moved from Balfour Beatty to VolkerHighways from April 2025 at around sixteen and a half million pounds a year, with FM Conway on drainage, while West Sussex and Surrey have jointly developed the A22 and A264 Godstone-to-East Grinstead improvements. The Mid Sussex and Crawley-Gatwick employment area provides depot capacity.",
   "National Highways operates the M23 and Gatwick corridor to the west, while the council-managed A22 runs north toward Godstone and south through Ashurst Wood and the A264 runs west toward Copthorne and Crawley. Border-junction and corridor work alike mean a single-carriageway pinch point and Gatwick-bound traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by East Grinstead crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, border-corridor and winter-maintenance work",
  "s2_intro":"Across East Grinstead's VolkerHighways carriageway work and the A22 and A264",
 },
 "witney": {
  "region":"Witney and Oxfordshire",
  "nearby":["Oxford","Abingdon","Bicester"],
  "snapshot":"iNeedWorkwear kits Witney's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Oxfordshire County Council's M Group Highways contract to the A40 Oxford corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Witney area's roads running",
  "s1loc":[
   "Witney is defined by the A40 Oxford corridor, with ongoing congestion management and improvement works, and by its historic blanket-making heritage on the River Windrush. Oxfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that east-west artery.",
   "The county runs its term maintenance through Milestone, now trading as M Group Highways and the incumbent since 2010, reappointed in 2025 on a contract reported at around eight hundred and forty million pounds over an initial eight years. The A40 corridor works have added bus lanes, park-and-ride and junction improvements, with the Range Road and Windrush Industrial Park estates anchoring local trade.",
   "National Highways operates the wider strategic network, while the A40 between Witney and Oxford is managed by Oxfordshire County Council, the A4095 runs through the town with Bridge Street a congestion pinch point and the B4022 Shores Green junction is the focus of the Access to Witney scheme. Corridor and junction work alike mean busy roads and air-quality-sensitive sites.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Witney crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, A40-corridor and winter-maintenance work",
  "s2_intro":"Across Witney's M Group Highways carriageway work and the A40 Oxford corridor",
 },
 "didcot": {
  "region":"Didcot and Oxfordshire",
  "nearby":["Oxford","Abingdon","Newbury"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Didcot's highway maintenance teams and roadworks contractors, from Oxfordshire County Council's M Group Highways contract to National Highways work on the A34, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Didcot area's roads running",
  "s1loc":[
   "Didcot is shaped by the former power station whose cooling towers were a regional landmark, by the Science Vale innovation cluster at Harwell, Milton Park and Culham, and by Didcot Parkway on the Great Western main line. Oxfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis around the A34 and the growth corridors.",
   "The county runs its term maintenance through Milestone, now trading as M Group Highways, reappointed in 2025 on the roughly eight-hundred-and-forty-million-pound contract, while the Didcot Science Bridge, a new crossing over the A4130, the railway and Milton Road built by VolkerFitzpatrick, is a flagship Housing Infrastructure Fund scheme. Milton Park near the A34 Milton Interchange anchors local employment.",
   "National Highways operates the A34 with the Milton Interchange the key junction, while the council-managed A4130 is the principal local route being dualled east of the interchange. Trunk and growth-scheme work alike mean fast roads and major new structures.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Didcot crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, growth-corridor and winter-maintenance work",
  "s2_intro":"Across Didcot's M Group Highways carriageway work and the National Highways A34",
 },
 "hertford": {
  "region":"Hertford and Hertfordshire",
  "nearby":["Hoddesdon","Welwyn Garden City","Stevenage"],
  "snapshot":"iNeedWorkwear kits Hertford's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Hertfordshire County Council's Ringway contract to National Highways work on the A10, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Hertford area's roads running",
  "s1loc":[
   "Hertford is the historic county town of Hertfordshire, sited where the rivers Lea, Beane, Mimram and Rib meet, defined by the A414 east-west corridor and the A10 to its east. Hertfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis around the Bluecoats Roundabout and the town's river crossings.",
   "Hertfordshire retained Ringway, part of Vinci, on a new term contract from October 2025, continuous since 2012 and reported at around three hundred and eighty-five million pounds over the initial term, covering potholes, lighting, signals, gritting and grass cutting across roughly five thousand kilometres of road. The Mead Lane industrial area and Foxholes Business Park anchor local trade.",
   "National Highways operates the A10 just east of the town, including the Kingsmead Viaduct with its structural works, while the council-managed A414 is the main east-west corridor and the A119 Ware Road links into the town, meeting at the Bluecoats Roundabout. Trunk and county-town work alike mean fast roads and a congested central junction.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Hertford crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the county town's carriageway, river-crossing and winter-maintenance work",
  "s2_intro":"Across Hertford's Ringway carriageway work and the National Highways A10",
 },
 "bushey": {
  "region":"Bushey and Hertfordshire",
  "nearby":["Watford","Borehamwood","Harrow"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Bushey's highway maintenance teams and roadworks contractors, from Hertfordshire County Council's Ringway contract to National Highways work on the M1, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bushey area's roads running",
  "s1loc":[
   "Bushey sits beside the M1 to the west and Watford immediately north, near the Elstree and Borehamwood film studios cluster. Hertfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis on the A411 and the routes feeding the motorway in south Hertfordshire.",
   "Hertfordshire retained Ringway, part of Vinci, on the new term contract from October 2025, continuous since 2012, covering potholes, lighting, drainage, gritting and grass cutting across the county. The A411 has seen routine and emergency works managed by Hertfordshire Highways, with the Bushey Hall and Bushey Mill Lane corridor and nearby Watford industrial areas anchoring local trade.",
   "National Highways operates the M1 immediately west with junction 5 the nearest interchange also serving the A41, while the council-managed A411 London Road runs through Bushey and the A4140 links toward Harrow. Motorway and arterial work alike mean fast roads and busy commuter routes.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Bushey crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, motorway-corridor and winter-maintenance work",
  "s2_intro":"Across Bushey's Ringway carriageway work and the National Highways M1",
 },
 "thatcham": {
  "region":"Thatcham and West Berkshire",
  "nearby":["Newbury","Reading","Wokingham"],
  "snapshot":"iNeedWorkwear kits Thatcham's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from West Berkshire Council's term contract to National Highways work on the M4 and A4, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Thatcham area's roads running",
  "s1loc":[
   "Thatcham sits in the valley of the River Kennet about three miles east of Newbury, on the A4 Bath Road and close to the M4, with the Kennet and Avon Canal and Thatcham's reed-bed nature reserves part of its valley setting. West Berkshire Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that Kennet valley corridor.",
   "The council retendered its highways term maintenance contract in recent years, with Marlborough Highways awarded the successor at around a hundred and fifty million pounds taking over from VolkerHighways, covering routine maintenance, winter gritting, inspections and asset management. The Colthrop and Station Road estates and Greenham Business Park anchor local industry.",
   "National Highways operates the M4 with junction 13 at Chieveley the nearest interchange and junction 12 near Theale to the east, while the A4 Bath Road runs through Thatcham and the A339 heads south toward Basingstoke. Motorway and A4 work alike mean fast roads and Kennet valley sites.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Thatcham crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, valley-corridor and winter-maintenance work",
  "s2_intro":"Across Thatcham's council carriageway work and the National Highways M4 and A4",
 },
 "newton abbot": {
  "region":"Newton Abbot and Devon",
  "nearby":["Torquay","Paignton","Exeter"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Newton Abbot's highway maintenance teams and roadworks contractors, from Devon County Council's M Group Highways contract to National Highways work on the A380 South Devon Highway, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Newton Abbot area's roads running",
  "s1loc":[
   "Newton Abbot sits at the south Devon road hinge where the A380 South Devon Highway and the heavily trafficked Penn Inn flyover funnel Torbay-bound traffic. Devon County Council is the highway authority for over eight thousand miles of road, and its gangs work in Class 3 hi-vis along that dual-carriageway corridor in Teignbridge.",
   "The county delivers highways through Devon Highways, the term partnership held by Milestone Infrastructure now trading as M Group Highways, in place since 2017 and extended toward 2029 with a larger successor in procurement. The Brunel and Heathfield estates near Drumbridges anchor local trade.",
   "National Highways operates the A38 Devon Expressway, while the council-managed A380 South Devon Highway crosses on the Penn Inn flyover, the A381 runs to Totnes and the A382 toward Bovey Tracey is under upgrade at Forches Cross. Trunk-link and A-road work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Newton Abbot crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, highway-corridor and winter-maintenance work",
  "s2_intro":"Across Newton Abbot's M Group Highways carriageway work and the National Highways A380",
 },
 "st austell": {
  "region":"St Austell and Cornwall",
  "nearby":["Truro","Newquay","Bodmin"],
  "snapshot":"iNeedWorkwear kits St Austell's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Cornwall Council's CORMAC company to National Highways work on the A30, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the St Austell area's roads running",
  "s1loc":[
   "St Austell is the heart of Cornwall's china clay country, its A391 link climbing to the A30 through a landscape of clay tips and Imerys works. Cornwall Council is the unitary highway authority for around four thousand five hundred miles of road, one of the longest networks in England, and its gangs work in Class 3 hi-vis on those clay-country routes.",
   "Cornwall delivers highways through CORMAC Solutions, its wholly-owned company, on a long-term term service contract covering surfacing, design and maintenance, an in-house-style arrangement. The A391 Carluddon Highway, partly built using china clay waste aggregate, and the Eco-business park anchor local works.",
   "National Highways operates the A30 strategic spine, while the council-managed A390 runs east-west through the town toward Truro and Lostwithiel and the A391 is the principal link up to the A30 via Bugle. Trunk and clay-country work alike mean fast roads and works-traffic-worn surfaces.",
   "Resurfacing, lining, drainage, lighting and winter gritting put St Austell crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, clay-country and winter-maintenance work",
  "s2_intro":"Across St Austell's CORMAC carriageway work and the National Highways A30",
 },
 "portishead": {
  "region":"Portishead and North Somerset",
  "nearby":["Clevedon","Bristol","Weston-super-Mare"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Portishead's highway maintenance teams and roadworks contractors, from North Somerset Council and its NSEC company to National Highways work on the M5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Portishead area's roads running",
  "s1loc":[
   "Portishead is a regenerated coastal town west of Bristol, its marina and the A369 Portbury Hundred linking it from M5 junction 19 toward the city and the Royal Portbury Dock. North Somerset Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that single main link and the marina roads.",
   "The council delivers highways and civils through the North Somerset Environment Company, its council-owned company handling pothole repair through to full carriageway reconstruction, alongside framework contractors. The reopening of the Portishead rail line has brought associated highway works off Harbour Road and the A369.",
   "National Highways operates the M5 with junction 19 the town's gateway, while the council-managed A369 Portbury Hundred is the principal link toward Bristol. Motorway-gateway and marina work alike mean fast roads and regeneration-driven schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Portishead crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, marina-corridor and winter-maintenance work",
  "s2_intro":"Across Portishead's NSEC carriageway work and the National Highways M5",
 },
 "ferndown": {
  "region":"Ferndown and Dorset",
  "nearby":["Bournemouth","Poole","Christchurch"],
  "snapshot":"iNeedWorkwear kits Ferndown's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Dorset Council's Hanson term service contract to National Highways work on the A31, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Ferndown area's roads running",
  "s1loc":[
   "Ferndown sits in east Dorset near the Bournemouth and Poole conurbation, defined by the A31 trunk corridor running past the town and the large Ferndown Industrial Estate. Dorset Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that corridor and the A348.",
   "The council maintains its roads under the Dorset Highways Term Service Contract with Hanson Contracting, the long-standing supply partner since 2002, with a successor contract worth around two hundred million pounds due to start in 2027. The Ferndown Industrial Estate is one of the largest in the conurbation and a major traffic generator.",
   "National Highways operates the A31 trunk dual carriageway past the town toward the M27 and the A35, while the council-managed A348 Ringwood Road links Ferndown to Poole and Longham and the A347 also serves the area. Trunk and distributor work alike mean fast roads and an industrial-estate junction focus.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Ferndown crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, industrial-estate and winter-maintenance work",
  "s2_intro":"Across Ferndown's Hanson carriageway work and the National Highways A31",
 },
 "new milton": {
  "region":"New Milton and Hampshire",
  "nearby":["Christchurch","Bournemouth","Poole"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to New Milton's highway maintenance teams and roadworks contractors, from Hampshire County Council's M Group Highways contract to National Highways work on the A35, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the New Milton area's roads running",
  "s1loc":[
   "New Milton sits on the New Forest coast in south-west Hampshire, where maintenance must respect National Park constraints on verges, animals and restricted widths. Hampshire County Council is the highway authority for one of the largest networks in England, and its gangs work in Class 3 hi-vis along the A337 coastal corridor.",
   "Hampshire Highways runs through the partnership with Milestone Infrastructure, now trading as M Group Highways, in place since 2017 and extended to 2029, with a separate civils framework for major schemes. Local trade sits around the Gore Road area toward Christchurch.",
   "National Highways operates the A35 through the New Forest via Lyndhurst toward Southampton and Dorset, while the council-managed A337 is the principal Christchurch-to-Lymington coastal corridor through New Milton feeding Barton on Sea. Trunk and coastal work alike mean fast roads and National Park constraints.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by New Milton crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, coastal-corridor and winter-maintenance work",
  "s2_intro":"Across New Milton's M Group Highways carriageway work and the National Highways A35",
 },
 "thornton cleveleys": {
  "region":"Thornton Cleveleys and the Fylde coast",
  "nearby":["Fleetwood","Poulton-le-Fylde","Blackpool"],
  "snapshot":"iNeedWorkwear kits Thornton Cleveleys highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Lancashire County Council to National Highways work on the A585, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Thornton Cleveleys area's roads running",
  "s1loc":[
   "Thornton Cleveleys sits on the exposed Fylde coast, where wind-blown sand on coastal roads is a recurring maintenance issue and the A585 carries traffic off the coast to the M55. Lancashire County Council is the highway authority for around four thousand six hundred miles of road, and its gangs work in Class 3 hi-vis on those seafront and arterial routes.",
   "The county delivers routine maintenance largely in house, supported by surfacing and dayworks frameworks for larger schemes, with the Hillhouse International industrial estate at Burn Naze a major local site. Congestion on the A585 corridor has been a long-standing concern.",
   "National Highways operates the A585 with the Windy Harbour to Skippool bypass relieving the corridor to the M55, while the council-managed A587 runs the Thornton and Cleveleys frontage toward Fleetwood. Trunk and coastal work alike mean fast roads and wind-blown-sand clearance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Thornton Cleveleys crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, coastal-corridor and winter-maintenance work",
  "s2_intro":"Across Thornton Cleveleys Lancashire carriageway work and the National Highways A585",
 },
 "ormskirk": {
  "region":"Ormskirk and West Lancashire",
  "nearby":["Skelmersdale","Southport","Preston"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Ormskirk's highway maintenance teams and roadworks contractors, from Lancashire County Council to the A570 and A59 corridors, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Ormskirk area's roads running",
  "s1loc":[
   "Ormskirk is a West Lancashire market town and home to Edge Hill University, so the A570 and town-centre routes carry heavy student, commuter and market-day traffic. Lancashire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that corridor and the Derby Street railway bridge.",
   "The county delivers highway maintenance principally in house, supported by frameworks for surfacing and structures, having carried out a major Derby Street bridge safety scheme worth around two million pounds and the Ormskirk Eastern Gateway works. Industrial estates along the A570 toward Skelmersdale anchor local trade.",
   "National Highways operates the wider motorway network, while the council-managed A570 is the main route linking Southport with the M58 and Skelmersdale and the A59 the major Preston-to-Liverpool corridor east of the town. Market-town and corridor work alike mean busy roads and a key town-centre bridge.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Ormskirk crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, market-town and winter-maintenance work",
  "s2_intro":"Across Ormskirk's Lancashire carriageway work and the A570 and A59 corridors",
 },
 "fulwood": {
  "region":"Fulwood and Lancashire",
  "nearby":["Preston","Leyland","Chorley"],
  "snapshot":"iNeedWorkwear kits Fulwood's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Lancashire County Council to National Highways work on the M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Fulwood area's roads running",
  "s1loc":[
   "Fulwood is a major Preston suburb sitting right by M6 junction 31a, at the convergence of the M6, M55 and A6, with the Broughton bypass nearby. Lancashire County Council is the highway authority, and its gangs work in Class 3 hi-vis at that busy strategic gateway.",
   "The county delivers highway maintenance largely in house, supported by civils and surfacing frameworks, with the Broughton bypass relieving the village of through traffic in the wider Preston programme. Business parks and offices off the A6 and around the M6 and M55 junctions drive maintenance demand.",
   "National Highways operates the M6 close by at junction 31a and the M55 to the west, with bridge maintenance schemes in the Broughton and Fulwood area, while the council-managed A6 is the principal local arterial toward central Preston. Motorway and arterial work alike mean fast roads and tight junction management.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Fulwood crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-gateway and winter-maintenance work",
  "s2_intro":"Across Fulwood's Lancashire carriageway work and the National Highways M6",
 },
 "formby": {
  "region":"Formby and Sefton",
  "nearby":["Crosby","Southport","Bootle"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Formby's highway maintenance teams and roadworks contractors, from Sefton Council and its Dowhigh contract to the A565 coast road, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Formby area's roads running",
  "s1loc":[
   "Formby is a Sefton coast town known for its National Trust pinewoods, sand dunes and red squirrel reserve, with the A565 coast road its principal artery between Southport and Crosby. Sefton Council is the metropolitan highway authority, and its gangs work in Class 3 hi-vis along that commuter coastal route.",
   "Sefton delivers highway and footway maintenance through term and annual service contracts, with Dowhigh of Netherton acting as a prime contractor and the Liverpool City Region Combined Authority supporting schemes, including major A565 corridor works. The borough's industrial areas are concentrated south around Netherton and Bootle.",
   "National Highways operates the wider strategic network with motorway access via the M57 and M58, while the council-managed A565 coast road links Liverpool, Crosby, Formby and Southport. Coastal-corridor and dune-proximity work alike mean salt-laden surfaces and commuter flows.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Formby crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, coastal-corridor and winter-maintenance work",
  "s2_intro":"Across Formby's Dowhigh carriageway work and the A565 coast road",
 },
 "wilmslow": {
  "region":"Wilmslow and Cheshire",
  "nearby":["Macclesfield","Stockport","Altrincham"],
  "snapshot":"iNeedWorkwear kits Wilmslow's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Cheshire East Council's Ringway Jacobs partnership to National Highways work on the M56, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Wilmslow area's roads running",
  "s1loc":[
   "Wilmslow is an affluent Cheshire commuter town close to Manchester Airport, with the A34 Wilmslow-Handforth bypass carrying north-south traffic and the A538 the airport route through the centre. Cheshire East Council is the highway authority, and its gangs work in Class 3 hi-vis along those commuter and airport corridors.",
   "The council delivers highways through Cheshire East Highways, its long-term integrated contract with Ringway Jacobs from October 2018, managing more than sixteen hundred miles of road. The Handforth Dean retail park on the A34 bypass and airport employment drive heavy traffic.",
   "National Highways operates the M56 to the north toward the airport and Manchester, while the council-managed A34 bypass connects toward the A555 and the A538 runs through Wilmslow under the railway viaduct to the airport. Bypass and airport-route work alike mean fast roads and development-driven flows.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Wilmslow crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, airport-corridor and winter-maintenance work",
  "s2_intro":"Across Wilmslow's Ringway Jacobs carriageway work and the National Highways M56",
 },
 "rhyl": {
  "region":"Rhyl and North Wales",
  "nearby":["Prestatyn","Colwyn Bay","Llandudno"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Rhyl's highway maintenance teams and roadworks contractors, from Denbighshire County Council to Welsh Government trunk roads on the A55, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Rhyl area's roads running",
  "s1loc":[
   "Rhyl is a classic North Wales seaside resort at the mouth of the River Clwyd, sitting on the A55 coastal corridor with Prestatyn adjoining to the east. Denbighshire County Council is the Welsh unitary highway authority, and its gangs work in Class 3 hi-vis on salt-exposed seafront and promenade routes.",
   "The council maintains adopted roads, footways, drainage, lighting and winter service in house with term contractors for resurfacing, running an annual major road maintenance programme including surfacing around Rhyl and the A547 corridor near Rhuddlan. St Asaph Business Park is the main larger employment park in the corridor.",
   "Trunk roads in Wales are the Welsh Government's responsibility via Traffic Wales and the North and Mid Wales Trunk Road Agent managing the A55 and its tunnels, the expressway running just inland of Rhyl, while the council-managed A548 is the coast road and the A525 heads south to Rhuddlan and Ruthin. Coastal-trunk and resort work alike mean exposed conditions and tourist flows.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Rhyl crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, coastal-corridor and winter-maintenance work",
  "s2_intro":"Across Rhyl's council carriageway work and the Welsh Government A55",
 },
 "blackwood": {
  "region":"Blackwood and the Sirhowy Valley",
  "nearby":["Caerphilly","Pontypool","Cwmbran"],
  "snapshot":"iNeedWorkwear kits Blackwood's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Caerphilly County Borough Council to Welsh Government trunk roads near the M4, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Blackwood area's roads running",
  "s1loc":[
   "Blackwood sits on the Sirhowy River in the South Wales Valleys, a former coal-mining town where mining-related ground subsidence remains a design consideration. Caerphilly County Borough Council is the Welsh unitary highway authority, and its gangs work in Class 3 hi-vis on steep valley terrain and former-coalfield ground.",
   "The council maintains the borough's adopted network under its Highways Maintenance Plan through in-house teams and schedule-of-rates term contracts, with the A4048 Sirhowy Enterprise Way linking Blackwood, Oakdale and Pontllanfraith. Oakdale Business Park and Pen-y-Fan Industrial Estate anchor local employment.",
   "Trunk roads in Wales are the Welsh Government's responsibility via Traffic Wales and the South Wales Trunk Road Agent, with the nearest link the M4 around junction 28 at Newport, while the council-managed A4048 runs through Blackwood and the A472 the Newbridge-to-Nelson corridor. Valley and enterprise-road work alike mean steep terrain and subsidence-tolerant design.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Blackwood crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, valley-corridor and winter-maintenance work",
  "s2_intro":"Across Blackwood's council carriageway work and the Welsh Government A4048 and M4",
 },
 "arbroath": {
  "region":"Arbroath and Angus",
  "nearby":["Dundee","Perth","Aberdeen"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Arbroath's highway maintenance teams and roadworks contractors, from Angus Council to Transport Scotland trunk roads on the A92, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Arbroath area's roads running",
  "s1loc":[
   "Arbroath is a historic Angus fishing port on the A92 coastal road, famous for the Arbroath smokie still produced in family smokehouses around the Fit o' the Toon harbour area. Angus Council is the unitary roads authority, and its gangs work in Class 3 hi-vis on coastal roads beside the rebuilt harbour.",
   "The council delivers local adopted roads, footways, lighting and winter service in house with capital contractors, while distinctively the A92 Dundee-to-Arbroath dual carriageway is maintained by BEAR Scotland on behalf of Claymore Roads under a DBFO-style arrangement for Angus and Dundee councils. The Elliot and Dens industrial estates anchor local trade.",
   "In Scotland trunk roads are Transport Scotland's responsibility, with BEAR Scotland operating the north-east network, the A92 continuing north as single carriageway to Montrose and the A933 running to Brechin. Coastal and DBFO-corridor work alike mean exposed conditions and an unusual non-trunk concession.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Arbroath crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, harbour-route and winter-maintenance work",
  "s2_intro":"Across Arbroath's Angus Council carriageway work and the A92 corridor",
 },
 "elgin": {
  "region":"Elgin and Moray",
  "nearby":["Inverness","Aberdeen","Arbroath"],
  "snapshot":"iNeedWorkwear kits Elgin's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Moray Council to Transport Scotland trunk roads on the A96, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Elgin area's roads running",
  "s1loc":[
   "Elgin is the administrative capital of Moray, sitting squarely on the A96 Aberdeen-to-Inverness corridor in the heart of Speyside whisky country. Moray Council is the unitary roads authority, and its gangs work in Class 3 hi-vis on the town's roads and the routes out to the distillery belt.",
   "The council's Roads Maintenance service, based in Elgin, covers statutory public roads, footways, lighting and winter service in house with capital contractors, while the A96 dualling between Inverness and Aberdeen is a long-standing Transport Scotland commitment. Business and industrial parks serve the wider Moray economy.",
   "In Scotland trunk roads are Transport Scotland's responsibility, with BEAR Scotland operating the north-east network and the A96 running through the town, while the council-managed A941 links south to Rothes and north to Lossiemouth. Trunk through-route and local work alike mean overnight surfacing campaigns and dualling aspirations.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Elgin crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, trunk-corridor and winter-maintenance work",
  "s2_intro":"Across Elgin's Moray Council carriageway work and the Transport Scotland A96",
 },
 "whitehaven": {
  "region":"Whitehaven and Cumbria",
  "nearby":["Workington","Carlisle","Penrith"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Whitehaven's highway maintenance teams and roadworks contractors, from Cumberland Council to National Highways work on the A595 and A66, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Whitehaven area's roads running",
  "s1loc":[
   "Whitehaven is a planned Georgian harbour town on the west Cumbria coast, once England's second-busiest port, where the A595 is the critical artery serving heavy commuter and freight movements to the Sellafield nuclear site. Cumberland Council, the unitary created in 2023 from the former Cumbria County Council, is the highway authority, and its gangs work in Class 3 hi-vis on that coastal route.",
   "The council runs the annual road maintenance and improvement programme covering local adopted roads, including the A595 sections through the town, in house with term and capital contractors. The Distington bypass carries the A595 past Lillyhall, with the Lillyhall industrial estate a major local employment site and Sellafield the dominant regional employer.",
   "National Highways operates the strategic A66 and the retained trunk A595 from Sellafield to the A66, while within and around Whitehaven the A595 is a Cumberland Council road and the Loop Road routes traffic past Hensingham. Trunk and coastal work alike mean a constrained single carriageway and heavy nuclear-site freight.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Whitehaven crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, coastal-route and winter-maintenance work",
  "s2_intro":"Across Whitehaven's Cumberland carriageway work and the A595 and National Highways A66",
 },
 "consett": {
  "region":"Consett and County Durham",
  "nearby":["Stanley","Chester-le-Street","Bishop Auckland"],
  "snapshot":"iNeedWorkwear kits Consett's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Durham County Council to National Highways work on the A1(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Consett area's roads running",
  "s1loc":[
   "Consett was one of the world's most prominent steel-making towns until the Consett Iron Company works closed in 1980, its old steelworks land now regenerated under Project Genesis. Durham County Council is the unitary highway authority for around three thousand eight hundred kilometres of road, and its gangs work in Class 3 hi-vis on the upland routes above the Derwent valley.",
   "The council delivers local highway maintenance largely in house backed by surfacing frameworks, with a recent programme of around seventeen million pounds resurfacing roughly a hundred locations. Modern employment land at Number One Industrial Estate and Berry Edge sits off the A691 and A692.",
   "National Highways operates the A1(M) to the east, while the council-managed A691 links Consett toward Durham city and the motorway, the A692 heads to Gateshead and the A693 serves the area, the hilltop setting making drainage and structures notable. Trunk-link and upland work alike mean fast roads and demanding drainage.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Consett crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, upland-route and winter-maintenance work",
  "s2_intro":"Across Consett's Durham carriageway work and the National Highways A1(M)",
 },
 "newton aycliffe": {
  "region":"Newton Aycliffe and County Durham",
  "nearby":["Bishop Auckland","Spennymoor","Darlington"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Newton Aycliffe's highway maintenance teams and roadworks contractors, from Durham County Council to National Highways work on the A1(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Newton Aycliffe area's roads running",
  "s1loc":[
   "Newton Aycliffe was the North East's first post-war new town, anchored by Aycliffe Business Park beside A1(M) junction 59 and the Hitachi Rail train factory opened in 2015. Durham County Council is the unitary highway authority, and its gangs work in Class 3 hi-vis around that motorway interchange and the business park.",
   "The council delivers local highway maintenance largely in house with county-wide frameworks, maintaining around three thousand eight hundred kilometres of road and some eighty thousand street lights. Aycliffe Business Park and Merchant Park, with occupiers including Hitachi Rail, Gestamp and 3M, drive heavy goods movement onto the A1(M).",
   "National Highways operates the A1(M) with junction 59 the Aycliffe interchange the key node, while the council-managed A167 Great North Road corridor and the A689 toward Bishop Auckland and Sedgefield serve the town. Motorway-junction and distributor work alike mean fast roads and freight-heavy slip roads.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Newton Aycliffe crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the new town's carriageway, business-park and winter-maintenance work",
  "s2_intro":"Across Newton Aycliffe's Durham carriageway work and the National Highways A1(M)",
 },
 "thornaby-on-tees": {
  "region":"Thornaby-on-Tees and the Tees Valley",
  "nearby":["Stockton-on-Tees","Middlesbrough","Billingham"],
  "snapshot":"iNeedWorkwear kits Thornaby-on-Tees highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Stockton-on-Tees Borough Council to National Highways work on the A19 and A66, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Thornaby-on-Tees area's roads running",
  "s1loc":[
   "Thornaby-on-Tees sits on the south bank of the Tees within the industrialised Teesside conurbation, much of the modern town built on the former Thornaby airfield from the 1960s. Stockton-on-Tees Borough Council is the unitary highway authority, and its gangs work in Class 3 hi-vis beside that process and manufacturing industry.",
   "The council maintains the great majority of local roads through its own highways service plus term frameworks for surfacing and civils, with the Teesside Industrial Estate of around three hundred acres on the southern edge and Teesside Park retail off the A66. The A19 corridor carries the area's freight.",
   "National Highways operates the A19 trunk road to the east and the A66 to the north, run under a long-standing Autolink concession, meeting near Teesside Park, while the council-managed A1045 Thornaby Road is the local distributor. Trunk and industrial-estate work alike mean fast roads and heavy process traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Thornaby crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, industrial-corridor and winter-maintenance work",
  "s2_intro":"Across Thornaby-on-Tees Stockton carriageway work and the National Highways A19 and A66",
 },
 "rothwell": {
  "region":"Rothwell and West Yorkshire",
  "nearby":["Leeds","Castleford","Normanton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Rothwell's highway maintenance teams and roadworks contractors, from Leeds City Council and the Yorkshire Alliance framework to National Highways work on the M62, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Rothwell area's roads running",
  "s1loc":[
   "Rothwell sits between Leeds and Wakefield within the motorway ring south of Leeds, immediately served by M62 junction 30 and close to the M1 and M621. Leeds City Council is the West Yorkshire metropolitan highway authority, and its gangs work in Class 3 hi-vis on those high-traffic junction and slip-road routes.",
   "Leeds procures highway works through the Yorkshire Highways Alliance frameworks, the multi-council arrangement on which Colas holds places, alongside its own teams and a minor-works framework. The South Leeds and Lofthouse employment corridor with its M62 and M1 access drives heavy traffic.",
   "National Highways operates the M62 at junction 30, the M1 and the M621 around south Leeds, while the council-managed A639 runs toward Wakefield and Pontefract and the A654 and A642 serve the area. Motorway-ring and distributor work alike mean fast roads and structures maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Rothwell crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, motorway-ring and winter-maintenance work",
  "s2_intro":"Across Rothwell's Yorkshire Alliance carriageway work and the National Highways M62",
 },
 "alfreton": {
  "region":"Alfreton and Derbyshire",
  "nearby":["Ripley","Belper","Chesterfield"],
  "snapshot":"iNeedWorkwear kits Alfreton's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Derbyshire County Council's ALLRoads service to National Highways work on the A38, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Alfreton area's roads running",
  "s1loc":[
   "Alfreton was historically the chief coal-mining centre in Derbyshire on the eastern coalfield, its former colliery land at Cotes Park reclaimed for industry. Derbyshire County Council is the highway authority for over three thousand five hundred miles of road, and its gangs work in Class 3 hi-vis along the A38 corridor and the town's A-roads.",
   "The county maintains local roads largely in house through ALLRoads, its direct labour organisation with a turnover above twenty million pounds, supplemented by framework partners for major schemes. The Cotes Park Industrial Estate just off the A38 is the area's main modern employment land.",
   "National Highways operates the trunk A38 dual carriageway through the area linking to M1 junction 28, while the council-managed A61 runs the Derby-to-Chesterfield corridor and the A615 heads toward Matlock, the three meeting around Alfreton. Trunk and coalfield-corridor work alike mean fast roads and reclaimed-land sites.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Alfreton crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, A38-corridor and winter-maintenance work",
  "s2_intro":"Across Alfreton's Derbyshire ALLRoads carriageway work and the National Highways A38",
 },
 "bognor regis": {
  "region":"Bognor Regis and West Sussex",
  "nearby":["Chichester","Littlehampton","Worthing"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Bognor Regis highway maintenance teams and roadworks contractors, from West Sussex County Council's VolkerHighways contract to the A29 and A259, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bognor Regis area's roads running",
  "s1loc":[
   "Bognor Regis is a traditional Sussex seaside resort, home to Butlin's off the A29, with a seafront bordering the South Downs National Park. West Sussex County Council is the highway authority, and its gangs work in Class 3 hi-vis along the resort corridors carrying seasonal holiday traffic.",
   "The county's core highways contract passed from Balfour Beatty to VolkerHighways from April 2025 at around sixteen and a half million pounds a year, with FM Conway on drainage. The Rowan Way and Oldlands Way industrial areas in the Arun district anchor local trade.",
   "National Highways operates the A27 strategic route to the north, while the council-managed A29 runs north from the town toward the A27 at Fontwell and the A259 is the coastal road toward Chichester and Littlehampton. Resort-approach and coastal work alike mean seasonal flows and exposed conditions.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Bognor Regis crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the resort's carriageway, coastal-corridor and winter-maintenance work",
  "s2_intro":"Across Bognor Regis VolkerHighways carriageway work and the A29 and A259",
 },
 "seaford": {
  "region":"Seaford and East Sussex",
  "nearby":["Eastbourne","Brighton","Hailsham"],
  "snapshot":"iNeedWorkwear kits Seaford's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from East Sussex Highways and Balfour Beatty Living Places to the A259 south coast road, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Seaford area's roads running",
  "s1loc":[
   "Seaford is a Sussex coastal town between the chalk of the Seven Sisters and the port of Newhaven, with the A259 its lifeline along the south coast. East Sussex County Council is the highway authority, and its gangs work in Class 3 hi-vis along that coastal corridor.",
   "The East Sussex Highways partnership is delivered by Balfour Beatty Living Places, which began its seven-year contract worth around two hundred and ninety-seven million pounds in May 2023, covering roads, drainage, lighting, signals, bridges and gritting. The Newhaven-to-Seaford A259 section is a recognised congestion and safety focus.",
   "National Highways operates the wider strategic network, while the council-managed A259 south coast road runs through Seaford toward Newhaven, Brighton and Eastbourne as part of the Major Road Network and the A26 provides the inland link via Newhaven, with the Exceat Bridge over the Cuckmere a notable structure. Coastal and bridge work alike mean exposed conditions and structures schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Seaford crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, coastal-corridor and winter-maintenance work",
  "s2_intro":"Across Seaford's East Sussex Highways carriageway work and the A259 south coast road",
 },
 "broadstairs": {
  "region":"Broadstairs and Kent",
  "nearby":["Margate","Ramsgate","Canterbury"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Broadstairs highway maintenance teams and roadworks contractors, from Kent County Council's Ringway term contract to the A255 and A256, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Broadstairs area's roads running",
  "s1loc":[
   "Broadstairs is a Thanet coastal town on the chalk cliffs between Margate and Ramsgate, with the A256 the principal corridor south to Ramsgate and the wider east Kent network. Kent County Council is the highway authority, and its gangs work in Class 3 hi-vis on those coastal and retail-corridor routes.",
   "Kent moved its term maintenance contract to Ringway, a Vinci subsidiary, taking over from Amey from May 2026 on a twenty-one-year deal worth around fifty million pounds a year, covering gritting, repairs, bridges and emergency response. The Westwood Cross retail area and the A256 Haine Road corridor are the main commercial focus.",
   "National Highways operates the A299 Thanet Way and M2 corridor feeding the island, while the council-managed A255 is the winding Margate-to-Ramsgate route through Broadstairs and the A256 runs south toward Ramsgate and the Lord of the Manor junction. Coastal and retail-corridor work alike mean seasonal tourism traffic and busy junctions.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Broadstairs crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, coastal-corridor and winter-maintenance work",
  "s2_intro":"Across Broadstairs Ringway carriageway work and the A255 and A256",
 },
 "hoddesdon": {
  "region":"Hoddesdon and Hertfordshire",
  "nearby":["Cheshunt","Hertford","Harlow"],
  "snapshot":"iNeedWorkwear kits Hoddesdon's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Hertfordshire County Council's Ringway contract to National Highways work on the A10, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Hoddesdon area's roads running",
  "s1loc":[
   "Hoddesdon is a Lee Valley town on the River Lea and the New River, with the A10 corridor its spine and notable industrial and logistics activity in the valley. Hertfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis on the A10 and the routes feeding the Pindar Road estates.",
   "Hertfordshire retained Ringway, a Vinci company, on a new term contract from October 2025, continuous for around twelve years and worth roughly fifty-five million pounds a year, covering potholes, lighting, signals, gritting and grass cutting. The New River Bridge on Essex Road is a recent industrial-corridor crossing.",
   "National Highways operates the wider motorway network, while the council-managed A10 dual carriageway runs through the Lee Valley past Hoddesdon toward Cambridge and the A1170 Dinant Link Road connects to the A10 at the Hoddesdon Interchange. Arterial and industrial-corridor work alike mean heavy goods traffic and busy junctions.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Hoddesdon crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, valley-corridor and winter-maintenance work",
  "s2_intro":"Across Hoddesdon's Ringway carriageway work and the National Highways A10",
 },
 "upminster": {
  "region":"Upminster and East London",
  "nearby":["Hornchurch","Romford","Brentwood"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Upminster's highway maintenance teams and roadworks contractors, from the London Borough of Havering's Marlborough partnership to National Highways work on the M25 and the A127, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Upminster area's roads running",
  "s1loc":[
   "Upminster is an outer east London district on the Essex border, the eastern terminus of the District line, sitting beside M25 junction 29 with the A127 to the north. The London Borough of Havering is the highway authority, and its gangs work in Class 3 hi-vis on borough roads under commuter and strategic through-traffic pressure.",
   "Havering delivers its highways and street lighting through Marlborough Highways on a contract worth around a hundred and seventy million pounds over an initial six years, covering maintenance, capital works, winter maintenance and gully cleaning. Employment and logistics activity across the borough toward Rainham and Romford feeds the corridors.",
   "National Highways operates the M25 at junction 29 about a mile and a half east, while Transport for London runs the A127 Southend Arterial Road to the north and the council holds the A124 St Mary's Lane through the town toward Hornchurch. Orbital, arterial and borough work alike mean fast roads and a transport-gateway role.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Upminster crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, arterial-edge and winter-maintenance work",
  "s2_intro":"Across Upminster's Marlborough carriageway work, the M25 and the TfL A127",
 },
 "droitwich": {
  "region":"Droitwich and Worcestershire",
  "nearby":["Worcester","Bromsgrove","Redditch"],
  "snapshot":"iNeedWorkwear kits Droitwich's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Worcestershire County Council's Ringway contract to National Highways work on the M5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Droitwich area's roads running",
  "s1loc":[
   "Droitwich Spa is built on some of the strongest natural brine springs in the world, with over two thousand years of salt-production heritage, and its highway pinch point is the A38 corridor feeding M5 junction 5. Worcestershire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that junction-fed route in Wychavon.",
   "The county delivers highways through Ringway, operating as Worcestershire Highways since 2005, on a combined highways-and-fleet contract covering around four thousand kilometres of carriageway and some thirteen hundred structures. The Berry Hill estate and the Hampton Lovett and Stonebridge Cross areas near M5 junction 5 draw HGV and contractor movement.",
   "National Highways operates the M5 at junction 5, the Rashwood Interchange, while the council-managed A38 is the main route from the junction into the town toward Bromsgrove and Worcester. Motorway-junction and A38 work alike mean fast roads and concentrated contractor traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Droitwich crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, junction-corridor and winter-maintenance work",
  "s2_intro":"Across Droitwich's Ringway carriageway work and the National Highways M5",
 },
 "evesham": {
  "region":"Evesham and Worcestershire",
  "nearby":["Worcester","Stratford-upon-Avon","Cheltenham"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Evesham's highway maintenance teams and roadworks contractors, from Worcestershire County Council's Ringway contract to National Highways work on the A46, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Evesham area's roads running",
  "s1loc":[
   "Evesham sits in the Vale of Evesham, historically the heart of England's market-gardening industry, with seasonal produce haulage feeding the A46 and A44 junction. Worcestershire County Council is the highway authority, and its gangs work in Class 3 hi-vis along those corridors and the town routes around the bend of the River Avon.",
   "The county delivers highways through Ringway as Worcestershire Highways, covering carriageways, footways, structures, drainage and winter service county-wide. The Vale Park and Worcester Road industrial areas anchor local works, with agricultural and produce haulage adding to the loading.",
   "National Highways operates the A46 the main north-south route toward the M5 and Worcester and toward Stratford and the M40, meeting the A44 east-west route at Evesham, while the in-town network including river crossings is council-managed. Trunk and produce-corridor work alike mean fast roads and seasonal haulage.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Evesham crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, produce-corridor and winter-maintenance work",
  "s2_intro":"Across Evesham's Ringway carriageway work and the National Highways A46",
 },
 "rugeley": {
  "region":"Rugeley and Staffordshire",
  "nearby":["Cannock","Lichfield","Stafford"],
  "snapshot":"iNeedWorkwear kits Rugeley's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Staffordshire County Council's Amey Infrastructure Plus partnership to the A51 and A460, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Rugeley area's roads running",
  "s1loc":[
   "Rugeley sits in the Cannock Chase district on the River Trent, its skyline once dominated by the Rugeley B power station whose cooling towers were demolished in 2021. Staffordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along the A51 and A460 serving the town.",
   "Highways run through the Infrastructure Plus partnership with Amey, in place since 2014 and extended thereafter, covering maintenance, structures, transport planning and environmental services, with recent A51 Lea Hall Way works providing a third access for the power-station regeneration. Towers Business Park and the Brereton and Armitage areas add local works traffic.",
   "National Highways operates the strategic network regionally, while the council-managed A51 links toward Lichfield and Stone and the A460 connects toward Cannock and the M6 and M6 Toll. Regeneration-access and A-road work alike mean fast roads and major site-driven schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Rugeley crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, regeneration-access and winter-maintenance work",
  "s2_intro":"Across Rugeley's Amey carriageway work and the A51 and A460",
 },
 "oadby": {
  "region":"Oadby and Leicestershire",
  "nearby":["Leicester","Market Harborough","Loughborough"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Oadby's highway maintenance teams and roadworks contractors, from Leicestershire County Council's Aggregate Industries patching contract to the A6 corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Oadby area's roads running",
  "s1loc":[
   "Oadby is an affluent commuter suburb on Leicester's south-east edge, strung along the A6 with university halls and golf courses nearby. Leicestershire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that A6 corridor into the city.",
   "The county uses in-house management with framework and term contractors, with carriageway patching and pothole repair delivered through the joint contract with Leicester City awarded to Aggregate Industries, supplied from the Bardon Hill and Croft plants. The A6 The Parade CYCLOPS junction upgrade in Oadby is a recent scheme.",
   "National Highways operates the M1 and M69 to the west and south-west via Leicester, while the council-managed A6 Leicester Road runs toward Market Harborough and the A5199 Welford Road corridor lies close by. Suburban-corridor and junction work alike mean busy roads feeding the Leicester network.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Oadby crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, suburban-corridor and winter-maintenance work",
  "s2_intro":"Across Oadby's Aggregate Industries carriageway work and the A6 corridor",
 },
 "grays thurrock": {
  "region":"Grays Thurrock and Essex",
  "nearby":["Basildon","Brentwood","Dartford"],
  "snapshot":"iNeedWorkwear kits Grays Thurrock highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Thurrock Council to National Highways work on the M25 and the Dartford Crossing, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Grays Thurrock area's roads running",
  "s1loc":[
   "Grays is the administrative centre of Thurrock, beside Lakeside Shopping Centre at the A126 interchange off the A13 and with the M25 Dartford Crossing immediately to the south-west. Thurrock Council is the unitary highway authority, and its gangs work in Class 3 hi-vis where retail, logistics and the crossing concentrate traffic.",
   "The council maintains its own local network, including A13 sections and distributors through Grays, West Thurrock and Chafford Hundred, through its highways service and supporting contractors, noting that incidents on the M25 and A13 and at the crossing frequently spill onto local roads. West Thurrock, Lakeside and Purfleet generate very high HGV traffic.",
   "National Highways operates the M25 meeting the A13 at junctions 30 and 31 and the Dartford Crossing under the Thames, while the council-managed A13 London-to-Southend corridor and the A126 Lakeside link are the key local strategic roads. Orbital, crossing and retail-corridor work alike mean fast roads and one of the most maintenance-intensive corridors in the region.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Grays crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, crossing-corridor and winter-maintenance work",
  "s2_intro":"Across Grays Thurrock council carriageway work and the National Highways M25 and Dartford Crossing",
 },
 "kidsgrove": {
  "region":"Kidsgrove and Staffordshire",
  "nearby":["Newcastle-under-Lyme","Stoke-on-Trent","Biddulph"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Kidsgrove's highway maintenance teams and roadworks contractors, from Staffordshire County Council's long-running Amey term partnership to National Highways work on the M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Kidsgrove area's roads running",
  "s1loc":[
   "Kidsgrove sits on the Cheshire border at the northern edge of the Potteries, where the Trent and Mersey Canal threads through the Harecastle Tunnel and the A50 cuts north-west to south-east through the town. Staffordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that border corridor.",
   "The county has delivered highways through Amey under its Infrastructure+ contract in recent years, an arrangement covering around six thousand kilometres of network and extended for a further period, while wider trade is anchored by the industrial estates around Chatterley Valley and the A500 corridor. Kidsgrove falls in the Newcastle-under-Lyme borough but county-level roads are the council's responsibility.",
   "National Highways operates the M6 to the west, reached via the A500 dual carriageway between junctions 15 and 16, with the A34 and the A50 feeding the Potteries conurbation. Motorway-link and town-corridor work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Kidsgrove crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-link and winter-maintenance work",
  "s2_intro":"Across Kidsgrove's Amey term-contract carriageway work and the National Highways M6 and A500",
 },
 "bishop auckland": {
  "region":"Bishop Auckland and County Durham",
  "nearby":["Spennymoor","Newton Aycliffe","Darlington"],
  "snapshot":"iNeedWorkwear kits Bishop Auckland's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Durham County Council's in-house highways operation to the A688 corridor and the A1(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bishop Auckland area's roads running",
  "s1loc":[
   "Bishop Auckland stands where the River Wear meets the Gaunless at the southern edge of the Durham coalfield, a market town built around Auckland Castle and now the focus of The Auckland Project regeneration. Durham County Council is the highway authority, and its gangs work in Class 3 hi-vis along the town's bypass and valley routes.",
   "The council maintains its network largely through its own highways workforce in recent years, directly running inspection and works teams across roughly three thousand eight hundred kilometres of road, around five hundred bridges and tens of thousands of street lights, with external frameworks brought in for major schemes. Local trade follows the A688 and the town-centre regeneration sites.",
   "National Highways operates the A1(M) to the east, while the council-managed A688 carries the Bishop Auckland bypass and the A689 runs the east-west route across County Durham, the two meeting near the town. Bypass and county-route work alike mean fast roads and junction-capacity schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Bishop Auckland crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's bypass, county-route and winter-maintenance work",
  "s2_intro":"Across Bishop Auckland's in-house carriageway work and the A688 and A1(M)",
 },
 "chapeltown": {
  "region":"Chapeltown and South Yorkshire",
  "nearby":["Sheffield","Rotherham","Barnsley"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Chapeltown's highway maintenance teams and roadworks contractors, from Sheffield City Council's Streets Ahead PFI with Amey to National Highways work on the M1, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Chapeltown area's roads running",
  "s1loc":[
   "Chapeltown sits in the far north of Sheffield, a former steel and coal township roughly midway between the city and Barnsley on the A6135. Sheffield City Council is the highway authority, and its gangs work in Class 3 hi-vis along that northern corridor and the motorway-junction approaches.",
   "The council maintains the network through the twenty-five-year Streets Ahead PFI with Amey, signed in 2012 and running into the late 2030s, covering resurfacing, street lighting, structures and pothole repairs across Sheffield, with contract performance terms tightened in recent years. The Thorncliffe Industrial Estate and the Junction 35a Business Park anchor local trade.",
   "National Highways operates the M1, reached via junctions 35a and 36 through the A616, while the council-managed A6135 and A629 carry the town's local traffic. Motorway-junction and township-corridor work alike mean fast roads and busy estate access.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Chapeltown crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, business-park and winter-maintenance work",
  "s2_intro":"Across Chapeltown's Streets Ahead carriageway work and the National Highways M1",
 },
 "stalybridge": {
  "region":"Stalybridge and Greater Manchester",
  "nearby":["Ashton-under-Lyne","Hyde","Denton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Stalybridge's highway maintenance teams and roadworks contractors, from Tameside Council's in-house highways teams to National Highways work on the M67 and the A57 Mottram bypass, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Stalybridge area's roads running",
  "s1loc":[
   "Stalybridge sits where the River Tame leaves the Pennine foothills at the eastern edge of Greater Manchester, a former cotton town on the Huddersfield Narrow Canal. Tameside Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis along the town's valley routes and the motorway approaches.",
   "The council runs daily inspection and some direct delivery in-house, and in recent times has been procuring a multi-lot highways maintenance framework covering resurfacing, drainage, lighting and traffic management, designed to support collaboration across Greater Manchester. Local trade follows the A635 and the Tame valley corridors.",
   "National Highways operates the M67 terminating near Mottram just east of the town and the trunk A57, where the long-awaited A57 Link Roads and Mottram bypass scheme is under construction, with the signed diversion route running through Stalybridge on the A6018 and A635. Motorway and trunk-scheme work alike mean fast roads and major traffic management.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Stalybridge crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, trunk-scheme and winter-maintenance work",
  "s2_intro":"Across Stalybridge's in-house carriageway work and the National Highways M67 and A57",
 },
 "workington": {
  "region":"Workington and Cumberland",
  "nearby":["Whitehaven","Carlisle","Penrith"],
  "snapshot":"iNeedWorkwear kits Workington's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Cumberland Council's highways service to National Highways work on the A66, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Workington area's roads running",
  "s1loc":[
   "Workington is a west Cumbrian port and former steel town where the River Derwent meets the Solway coast, served by the A66 trunk route and a working harbour. Cumberland Council, the unitary authority created in 2023 from the former county and district councils, is the highway authority, and its gangs work in Class 3 hi-vis along the coast road and industrial approaches.",
   "The council runs a highways service from its depot at Lillyhall and has used surfacing contractors including DSD Construction on recent schemes such as the A597 Mossbay Road, while a thirty-three-million-pound town-centre regeneration programme has drawn contractors into the centre. The Clay Flatts Industrial Estate and the Port of Workington anchor local trade.",
   "National Highways operates the A66, the trunk route east toward Penrith and Scotch Corner now confirmed for the major Northern Trans-Pennine dualling, while the council-managed A595, A596 and A597 carry the local coast and town traffic. Trunk and coast-road work alike mean fast roads and large highway schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Workington crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, port-access and winter-maintenance work",
  "s2_intro":"Across Workington's Cumberland Council carriageway work and the National Highways A66",
 },
 "walton-on-thames": {
  "region":"Walton-on-Thames and Surrey",
  "nearby":["Esher","Kingston upon Thames","Staines"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Walton-on-Thames's highway maintenance teams and roadworks contractors, from Surrey County Council's Ringway term contract to National Highways work on the M25 and A3, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Walton-on-Thames area's roads running",
  "s1loc":[
   "Walton-on-Thames sits on the south bank of the river in the Elmbridge commuter belt south-west of London, linked across the water by Walton Bridge to Shepperton. Surrey County Council is the highway authority, and its gangs work in Class 3 hi-vis along the riverside routes and the busy approaches to the M25.",
   "The county delivers highways through a long-term term-maintenance contract with Ringway, in place since 2022 when it took over from Kier, with design and professional services held separately, covering reactive and planned works across Surrey's network. Local trade follows the town's commercial estates and the river crossings.",
   "National Highways operates the M25 to the south, reached via junction 10 on the A3, and the A3 trunk road itself, while the council-managed A244 carries traffic over Walton Bridge and the A3050 runs east to west. Orbital and trunk-road work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Walton-on-Thames crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, river-crossing and winter-maintenance work",
  "s2_intro":"Across Walton-on-Thames's Ringway carriageway work and the National Highways M25 and A3",
 },
 "esher": {
  "region":"Esher and Surrey",
  "nearby":["Walton-on-Thames","Kingston upon Thames","Epsom"],
  "snapshot":"iNeedWorkwear kits Esher's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Surrey County Council's Ringway term contract to National Highways work on the A3 Esher bypass, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Esher area's roads running",
  "s1loc":[
   "Esher sits in the Elmbridge commuter belt south-west of London, defined by the A3 corridor and the landmark Scilly Isles junction where the A307 and A309 meet. Surrey County Council is the highway authority, and its gangs work in Class 3 hi-vis around that interchange and the Esher bypass.",
   "The county delivers highways through its Ringway term-maintenance contract, running since 2022 after the changeover from Kier, with professional services held separately, covering planned and reactive works across the Surrey network. Sandown Park Racecourse and the town's commercial parades anchor local trade.",
   "National Highways operates the A3, where the Esher bypass section carries through-traffic past the town and the Scilly Isles junction handles the A307 and A309 movements, with the M25 reachable to the south and west. Trunk-road and interchange work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Esher crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, interchange and winter-maintenance work",
  "s2_intro":"Across Esher's Ringway carriageway work and the National Highways A3",
 },
 "whitefield": {
  "region":"Whitefield and Greater Manchester",
  "nearby":["Bury","Radcliffe","Middleton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Whitefield's highway maintenance teams and roadworks contractors, from Bury Council's in-house highways service to National Highways work on the M60 and M66, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Whitefield area's roads running",
  "s1loc":[
   "Whitefield sits on Bury New Road between Manchester and Bury, built tight against the Whitefield interchange where the M60 orbital meets the M66. Bury Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis around that motorway junction and the town's commuter routes.",
   "The council delivers highways through its own in-house team working with Transport for Greater Manchester, outsourcing specialist works such as road markings and drainage, and in recent times has been procuring a new multi-lot highways and civil engineering framework. The estates along Bury New Road and the Radcliffe fringe anchor local trade.",
   "National Highways operates the M60 and the M66 meeting at junction 17, the Whitefield interchange, the defining feature of the town, with the council-managed Bury New Road carrying local traffic alongside. Motorway-interchange and town-road work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Whitefield crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, interchange and winter-maintenance work",
  "s2_intro":"Across Whitefield's in-house carriageway work and the National Highways M60 and M66",
 },
 "potters bar": {
  "region":"Potters Bar and Hertfordshire",
  "nearby":["Barnet","Borehamwood","Hatfield"],
  "snapshot":"iNeedWorkwear kits Potters Bar's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Hertfordshire County Council's Ringway term contract to National Highways work on the M25 and A1(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Potters Bar area's roads running",
  "s1loc":[
   "Potters Bar sits on the Hertfordshire fringe just north of the Greater London boundary, hemmed by the M25 to the south and the A1(M) to the west. Hertfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along the commuter routes and the busy motorway approaches.",
   "The county delivers highways through Ringway, part of Vinci, which has held the contract since 2012 and saw it renewed in 2025 with the new term commencing that October, covering reactive and planned maintenance across the Hertfordshire network. The town's commercial estates and the South Mimms corridor anchor local trade.",
   "National Highways operates the M25, reached via junctions 23 at South Mimms and 24 at Potters Bar, and the A1(M) running close to the western edge, with South Mimms services at the interchange. Orbital and motorway-corridor work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Potters Bar crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-corridor and winter-maintenance work",
  "s2_intro":"Across Potters Bar's Ringway carriageway work and the National Highways M25 and A1(M)",
 },
 "kenilworth": {
  "region":"Kenilworth and Warwickshire",
  "nearby":["Leamington Spa","Warwick","Coventry"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Kenilworth's highway maintenance teams and roadworks contractors, from Warwickshire County Council's Balfour Beatty Living Places term contract to National Highways work on the A46, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Kenilworth area's roads running",
  "s1loc":[
   "Kenilworth sits between Coventry and Warwick on the A452, a castle town on the edge of the Warwickshire countryside with the A46 bypass sweeping to the south and west. Warwickshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that trunk-road corridor and the town approaches.",
   "The county delivers highways through Balfour Beatty Living Places, re-appointed under a new term contract running from 2026 jointly with Coventry and Solihull, its third consecutive Warwickshire term, covering planned and reactive works across the network. The town's business parks and the A46 corridor anchor local trade.",
   "National Highways operates the A46 Kenilworth bypass on the Warwick-to-Coventry corridor, where major HS2 works including a box structure have driven road closures, while the council-managed A452 passes through Kenilworth via Thickthorn Island. Trunk-road and major-scheme work alike mean fast roads and heavy traffic management.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Kenilworth crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, trunk-corridor and winter-maintenance work",
  "s2_intro":"Across Kenilworth's Balfour Beatty Living Places carriageway work and the National Highways A46",
 },
 "buxton": {
  "region":"Buxton and Derbyshire",
  "nearby":["Glossop","Macclesfield","Chesterfield"],
  "snapshot":"iNeedWorkwear kits Buxton's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Derbyshire County Council's ALLRoads in-house operation to the A6 Peak District corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Buxton area's roads running",
  "s1loc":[
   "Buxton is a spa town high in the Peak District where the A6, A53 and A515 converge, surrounded by limestone quarries and exposed Pennine moorland. Derbyshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along those upland routes through some of England's harshest road weather.",
   "The county maintains its network largely in-house through Derbyshire Highways and its ALLRoads direct labour organisation, handling construction, reinstatements, drainage, street lighting and sign manufacture, under a capital programme of tens of millions of pounds in recent years. Quarrying and limestone haulage from sites such as Dove Holes anchor local trade.",
   "The council manages the A6 Luton-to-Carlisle route through the town, the A53 toward Leek and Macclesfield and the A515 toward Ashbourne, while National Highways operates the strategic motorway network beyond the Peak. Upland-corridor and quarry-haulage work alike mean exposed roads and heavy HGV wear.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Buxton crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, upland-corridor and winter-maintenance work",
  "s2_intro":"Across Buxton's ALLRoads carriageway work and the A6 Peak District corridor",
 },
 "market harborough": {
  "region":"Market Harborough and Leicestershire",
  "nearby":["Oadby","Kettering","Corby"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Market Harborough's highway maintenance teams and roadworks contractors, from Leicestershire County Council's in-house highways service to National Highways work on the A14, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Market Harborough area's roads running",
  "s1loc":[
   "Market Harborough is a Welland-valley market town in the far south of Leicestershire, close to the Northamptonshire border and bypassed by the A6. Leicestershire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that bypass and the town's commuter routes.",
   "The county delivers highways largely in-house in recent years, procuring specific surfacing and patching packages on top of its own delivery rather than running a single county-wide term contractor, and maintains a dedicated A6 bypass project. The town's business parks and the commuter corridor toward the A14 anchor local trade.",
   "National Highways operates the A14 to the south, the Catthorpe-to-Felixstowe trunk route reached via junction 3, while the council-managed A6 carries the Market Harborough bypass around the town. Trunk-link and bypass work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Market Harborough crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bypass and winter-maintenance work",
  "s2_intro":"Across Market Harborough's in-house carriageway work and the National Highways A14",
 },
 "garforth": {
  "region":"Garforth and West Yorkshire",
  "nearby":["Leeds","Castleford","Pontefract"],
  "snapshot":"iNeedWorkwear kits Garforth's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Leeds City Council and the Yorkshire Highways Alliance framework to National Highways work on the M1, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Garforth area's roads running",
  "s1loc":[
   "Garforth sits east of Leeds where the M1 swings past the city, a former mining town now ringed by logistics and business development around junctions 46 and 47. Leeds City Council is the West Yorkshire metropolitan highway authority, and its gangs work in Class 3 hi-vis along those motorway approaches and the A63 corridor.",
   "The council maintains its network through frameworks under the Yorkshire Highways Alliance, on which it tenders large minor-works and carriageway packages on behalf of the West Yorkshire authorities, alongside its own highways teams. The Thorpe Park development and the light-industrial estates, home to firms such as Ginetta, anchor local trade.",
   "National Highways operates the M1 with junction 46 at Thorpe Park and junction 47 flanking the town, while the council-managed A63 Leeds-to-Selby road and the A642 toward Wakefield cross at Garforth. Motorway and logistics-corridor work alike mean fast roads and heavy junction traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Garforth crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, logistics-corridor and winter-maintenance work",
  "s2_intro":"Across Garforth's Yorkshire Highways Alliance carriageway work and the National Highways M1",
 },
 "droylsden": {
  "region":"Droylsden and Greater Manchester",
  "nearby":["Ashton-under-Lyne","Denton","Failsworth"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Droylsden's highway maintenance teams and roadworks contractors, from Tameside Council's in-house highways teams to National Highways work on the M60, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Droylsden area's roads running",
  "s1loc":[
   "Droylsden sits on the A662 Ashton New Road between Manchester and Ashton-under-Lyne, the only Tameside town to lie inside the M60 orbital, with the Metrolink tram line running through its centre. Tameside Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis along that tram-and-road corridor.",
   "The council delivers highways in-house as a metropolitan authority, coordinating with Transport for Greater Manchester on the key route network, and a recent town-centre masterplan proposes a new canal park alongside a revamped centre. The Metrolink corridor and the A662 trade estates anchor local work.",
   "National Highways operates the M60, reached via junction 23, while the council-managed A662 Ashton New Road carries the tram line and traffic through the town and the A635 runs toward Ashton. Orbital and tram-corridor work alike mean fast roads and central-reservation maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Droylsden crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, tram-corridor and winter-maintenance work",
  "s2_intro":"Across Droylsden's in-house carriageway work and the National Highways M60",
 },
 "newquay": {
  "region":"Newquay and Cornwall",
  "nearby":["Truro","St Austell","Bodmin"],
  "snapshot":"iNeedWorkwear kits Newquay's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Cornwall Council's CORMAC company to National Highways work on the A30, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Newquay area's roads running",
  "s1loc":[
   "Newquay is Cornwall's surf and tourism capital on the Atlantic coast, its seasonal traffic swelling the A392 and A3058 approaches each summer. Cornwall Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along those coast roads and the airport corridor.",
   "The council delivers highways through CORMAC, its own company within the Corserv group, maintaining around seven thousand five hundred kilometres of Cornish road under term service contracts covering routine maintenance, drainage, signs and vegetation. Cornwall Airport Newquay and the Aerohub Enterprise Zone, home to a growing aerospace and spaceport cluster, anchor local trade.",
   "National Highways operates the A30, the strategic spine of Cornwall, reached from the town via the A392, A3058 and the A3059 airport road. Trunk-link and coast-road work alike mean fast roads and heavy seasonal traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Newquay crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, airport-corridor and seasonal-traffic work",
  "s2_intro":"Across Newquay's CORMAC carriageway work and the National Highways A30",
 },
 "truro": {
  "region":"Truro and Cornwall",
  "nearby":["Falmouth","Camborne","St Austell"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Truro's highway maintenance teams and roadworks contractors, from Cornwall Council's CORMAC company to National Highways work on the A30, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Truro area's roads running",
  "s1loc":[
   "Truro is Cornwall's cathedral city and administrative capital, sitting at the head of the Fal estuary where the A39 and A390 meet just south of the A30. Cornwall Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along those city approaches and the trunk-road junctions.",
   "The council delivers highways through CORMAC, its own company in the Corserv group, maintaining around seven thousand five hundred kilometres of road under term service contracts, with the Langarth development link road being built on the city's western edge. The county-administrative and retail economy anchors local trade.",
   "National Highways operates the A30 just north of the city, where the major Chiverton to Carland Cross dualling scheme has been completed, while the council-managed A39 and A390 carry the city's local traffic. Trunk-scheme and city-corridor work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Truro crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, trunk-junction and winter-maintenance work",
  "s2_intro":"Across Truro's CORMAC carriageway work and the National Highways A30",
 },
 "falmouth": {
  "region":"Falmouth and Cornwall",
  "nearby":["Truro","Camborne","St Austell"],
  "snapshot":"iNeedWorkwear kits Falmouth's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Cornwall Council's CORMAC company to the A39 corridor and the working port, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Falmouth area's roads running",
  "s1loc":[
   "Falmouth sits on one of the world's largest natural harbours at the mouth of the Fal, a port and university town at the southern terminus of the A39. Cornwall Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the harbour approaches and the Penryn corridor.",
   "The council delivers highways through CORMAC, its own Corserv-group company, maintaining the Cornish network under term service contracts, with the Penryn bypass diverting through-traffic around the neighbouring town. Falmouth Docks, the largest port in Cornwall and a working cargo, bunkering and ship-repair yard, anchors local trade.",
   "National Highways operates the A30 strategic route to the north, reached via the A39 through Penryn and Truro, while the council-managed A39 carries the town's traffic to its terminus. Port-access and corridor work alike mean busy roads and heavy goods movements.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Falmouth crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, port-access and winter-maintenance work",
  "s2_intro":"Across Falmouth's CORMAC carriageway work and the A39 corridor",
 },
 "camborne": {
  "region":"Camborne and Cornwall",
  "nearby":["Truro","Falmouth","St Austell"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Camborne's highway maintenance teams and roadworks contractors, from Cornwall Council's CORMAC company to National Highways work on the A30, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Camborne area's roads running",
  "s1loc":[
   "Camborne anchors the western end of the Camborne-Pool-Redruth conurbation, the heart of Cornwall's old tin and copper mining country, with the A30 sweeping past as its northern bypass. Cornwall Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that trunk-road corridor and the town routes.",
   "The council delivers highways through CORMAC, its own company in the Corserv group, maintaining the Cornish network under term service contracts, while the long-running CPR regeneration around the former South Crofty mine has driven schemes such as the East-West Link road removing traffic from Pool. The old A3047 trade corridor anchors local work.",
   "National Highways operates the A30, bypassing the conurbation with junctions at Treswithian and Tolvaddon, while the council-managed A3047 carries the original through-route past the towns. Trunk-bypass and regeneration work alike mean fast roads and major link-road schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Camborne crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, regeneration-corridor and winter-maintenance work",
  "s2_intro":"Across Camborne's CORMAC carriageway work and the National Highways A30",
 },
 "tiverton": {
  "region":"Tiverton and Devon",
  "nearby":["Exeter","Barnstaple","Newton Abbot"],
  "snapshot":"iNeedWorkwear kits Tiverton's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Devon County Council's term maintenance contract to National Highways work on the M5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Tiverton area's roads running",
  "s1loc":[
   "Tiverton stands in the Exe valley in Mid Devon, a former wool town close to the M5 and the gateway to the North Devon Link Road. Devon County Council is the highway authority, and its gangs work in Class 3 hi-vis along the link road and the motorway approaches.",
   "The county delivers highways through an outsourced term maintenance contract, held by Milestone in recent years, with engagement under way on a successor deal for the end of the decade, covering reactive and planned works across the Devon network. Tiverton Business Park and the eastern urban extension anchor local trade.",
   "National Highways operates the M5 to the east, with junction 27 at Tiverton Parkway the gateway and Tiverton services alongside, while the council-managed A361 North Devon Link Road runs west toward Barnstaple and the A396 follows the Exe valley. Motorway-link and link-road work alike mean fast roads and heavy freight traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Tiverton crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, link-road and winter-maintenance work",
  "s2_intro":"Across Tiverton's term-maintenance carriageway work and the National Highways M5 and A361",
 },
 "stamford": {
  "region":"Stamford and Lincolnshire",
  "nearby":["Peterborough","Spalding","Grantham"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Stamford's highway maintenance teams and roadworks contractors, from Lincolnshire County Council's Balfour Beatty Living Places contract to National Highways work on the A1, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Stamford area's roads running",
  "s1loc":[
   "Stamford is a stone-built conservation market town in the far south of Lincolnshire, close to the Rutland and Cambridgeshire borders and bypassed by the A1. Lincolnshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that trunk-road bypass and the town's historic streets.",
   "The county delivers highways through Balfour Beatty Living Places, whose contract was extended to run into the early 2030s, covering gritting, drainage, reactive repairs and traffic management across roughly nine thousand kilometres of carriageway from a dedicated operational hub. The town's commercial estates and the A1 corridor anchor local trade.",
   "National Highways operates the A1 immediately west of the town, a dualled strategic north-south route, while the council-managed A43 terminates at Stamford via the grade-separated Carpenter's Lodge junction and the A47 runs to the east. Trunk-road and bypass work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Stamford crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bypass and winter-maintenance work",
  "s2_intro":"Across Stamford's Balfour Beatty Living Places carriageway work and the National Highways A1",
 },
 "retford": {
  "region":"Retford and Nottinghamshire",
  "nearby":["Worksop","Gainsborough","Doncaster"],
  "snapshot":"iNeedWorkwear kits Retford's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Nottinghamshire County Council's Via East Midlands company to National Highways work on the A1, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Retford area's roads running",
  "s1loc":[
   "Retford is a Bassetlaw market town between the A1 and the East Coast Main Line, its East Retford bypass carrying the A57 around the centre. Nottinghamshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that bypass and the trunk-road junctions.",
   "The county delivers highways through Via East Midlands, its wholly-owned company, on a contract extended for a further five years in recent times, running a programme of tens of millions of pounds part-funded through the East Midlands Combined County Authority. The Manton Wood Enterprise Zone and the A1 corridor estates anchor local trade.",
   "National Highways operates the A1 just west of the town, with the grade-separated Apleyhead junction handling the A1, A57 and A614, while the A57 itself was detrunked in 2003 and is now a council-managed principal road. Trunk-road and bypass work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Retford crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, bypass and winter-maintenance work",
  "s2_intro":"Across Retford's Via East Midlands carriageway work and the National Highways A1",
 },
 "belper": {
  "region":"Belper and Derbyshire",
  "nearby":["Ripley","Alfreton","Ilkeston"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Belper's highway maintenance teams and roadworks contractors, from Derbyshire County Council's ALLRoads in-house operation to the A6 Derwent valley corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Belper area's roads running",
  "s1loc":[
   "Belper sits in the Derwent valley north of Derby, a mill town at the heart of the Derwent Valley Mills World Heritage Site with the A6 running through its centre as Derby Road. Derbyshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that valley corridor.",
   "The county maintains its network in-house through Derbyshire Highways and its ALLRoads direct labour organisation, handling construction, drainage, street lighting and sign manufacture under a capital programme of tens of millions of pounds, with a recent active-travel masterplan for the town. The Amber Valley estates anchor local trade.",
   "The council manages the A6 Derby Road through Belper and up the Derwent valley toward Matlock, while the nearest National Highways trunk route is the A38 at the Palm Court roundabout north of Derby. Valley-corridor and trunk-link work alike mean busy roads and heritage-town congestion.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Belper crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, valley-corridor and winter-maintenance work",
  "s2_intro":"Across Belper's ALLRoads carriageway work and the A6 Derwent valley corridor",
 },
 "dronfield": {
  "region":"Dronfield and Derbyshire",
  "nearby":["Chesterfield","Sheffield","Chapeltown"],
  "snapshot":"iNeedWorkwear kits Dronfield's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Derbyshire County Council's ALLRoads in-house operation to the A61 corridor and the M1, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Dronfield area's roads running",
  "s1loc":[
   "Dronfield sits in the River Drone valley between Sheffield and Chesterfield, with the A61 bypass running along its western side as the main route between the two. Derbyshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that bypass and the town's valley streets.",
   "The county maintains its network in-house through Derbyshire Highways and its ALLRoads direct labour organisation, covering construction, drainage, lighting and sign manufacture, with the Callywhite Lane Industrial Estate at the eastern end of town a major employment and distribution area. That estate and the A61 corridor anchor local trade.",
   "The council manages the A61 Dronfield to Unstone bypass, a dual carriageway that is a principal road rather than a trunk route, while the nearest National Highways asset is the M1 at junction 29 a few miles to the east. Bypass and motorway-link work alike mean fast roads and busy estate access.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Dronfield crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, bypass and winter-maintenance work",
  "s2_intro":"Across Dronfield's ALLRoads carriageway work and the A61 corridor and M1",
 },
 "guiseley": {
  "region":"Guiseley and West Yorkshire",
  "nearby":["Yeadon","Horsforth","Shipley"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Guiseley's highway maintenance teams and roadworks contractors, from Leeds City Council and the Yorkshire Highways Alliance framework to the A65 corridor and Leeds Bradford Airport, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Guiseley area's roads running",
  "s1loc":[
   "Guiseley sits on the A65 Otley-to-Leeds corridor on the Aireborough edge of the Leeds district, next to Leeds Bradford Airport in neighbouring Yeadon. Leeds City Council is the West Yorkshire metropolitan highway authority, and its gangs work in Class 3 hi-vis along that airport-and-commuter corridor.",
   "The council maintains its network through frameworks under the Yorkshire Highways Alliance, tendering large minor-works and carriageway packages on behalf of the West Yorkshire authorities, alongside its own highways teams resurfacing well over a hundred kilometres a year. The airport and the A65 trade estates anchor local work.",
   "The council manages the A65 New Road through the town and the A658 airport link, while National Highways operates the M62 and M621 to the south as the strategic network. Airport-corridor and commuter-route work alike mean busy roads and heavy traffic generation.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Guiseley crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, airport-corridor and winter-maintenance work",
  "s2_intro":"Across Guiseley's Yorkshire Highways Alliance carriageway work and the A65 corridor",
 },
 "rawtenstall": {
  "region":"Rawtenstall and Lancashire",
  "nearby":["Accrington","Bury","Burnley"],
  "snapshot":"iNeedWorkwear kits Rawtenstall's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Lancashire County Council's highways service to National Highways work on the M66, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Rawtenstall area's roads running",
  "s1loc":[
   "Rawtenstall sits in the Rossendale valley north of Manchester, a former cotton town where the A56 Haslingden and Edenfield bypass links the upland towns to the motorway network. Lancashire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that bypass and the valley routes.",
   "The county delivers highways largely in-house and in recent years has reorganised toward a streamlined single-provider maintenance arrangement, reporting large reductions in defects, alongside a separate dayworks framework for repairs. The New Hall Hey business and retail park on former mill land anchors local trade.",
   "National Highways operates the M66 to the south toward Bury and Manchester and the M65 to the north, both reached via the A56 bypass beside the town. Motorway-link and valley-bypass work alike mean fast roads and exposed upland weather.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Rawtenstall crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, valley-bypass and winter-maintenance work",
  "s2_intro":"Across Rawtenstall's Lancashire County Council carriageway work and the National Highways M66 and A56",
 },
 "hindley": {
  "region":"Hindley and Greater Manchester",
  "nearby":["Wigan","Leigh","Atherton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Hindley's highway maintenance teams and roadworks contractors, from Wigan Council's in-house highways operation to National Highways work on the M61 and M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Hindley area's roads running",
  "s1loc":[
   "Hindley sits east of Wigan on the A58, a former mining township between the M61 and M6 on the Manchester-to-Southport rail line. The Metropolitan Borough of Wigan is the highway authority, and its gangs work in Class 3 hi-vis along the A578 Leigh Road and the motorway approaches.",
   "The council runs a predominantly in-house highways operation for inspections, reactive works and the planned programme, supported by specialist framework contractors for discrete packages such as road lining and carriageway resurfacing on the key route network. Hindley Green Business Park on Leigh Road anchors local trade.",
   "National Highways operates the M61 to the north-east toward Westhoughton and the M6 to the south-west, while the council-managed A58, A577 and A578 carry the town's traffic, with a long-mooted east-west link road serving the wider area. Motorway-corridor and township-route work alike mean fast roads and busy estate access.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Hindley crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, motorway-corridor and winter-maintenance work",
  "s2_intro":"Across Hindley's in-house carriageway work and the National Highways M61 and M6",
 },
 "royton": {
  "region":"Royton and Greater Manchester",
  "nearby":["Oldham","Middleton","Rochdale"],
  "snapshot":"iNeedWorkwear kits Royton's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Oldham Council's in-house highways service to National Highways work on the M62, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Royton area's roads running",
  "s1loc":[
   "Royton sits on the Pennine foothills north of Oldham town centre, with the A627(M) spur running immediately to its west linking Oldham and Rochdale to the M62. The Metropolitan Borough of Oldham is the highway authority, and its gangs work in Class 3 hi-vis along that motorway-spur corridor.",
   "The council brought its highways service back in-house in recent years after winding down its Unity Partnership company, now running delivery through its own teams with framework contractors used for larger schemes. The A663 Broadway trade estates anchor local work.",
   "National Highways operates the M62 to the north, reached via junction 20, and the A627(M) spur beside the town, while the council-managed A663 Broadway and A671 carry local traffic toward the Slattocks interchange. Motorway and spur-corridor work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Royton crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-spur and winter-maintenance work",
  "s2_intro":"Across Royton's in-house carriageway work and the National Highways M62 and A627(M)",
 },
 "clevedon": {
  "region":"Clevedon and North Somerset",
  "nearby":["Portishead","Weston-super-Mare","Bristol"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Clevedon's highway maintenance teams and roadworks contractors, from North Somerset Council's NSEC company to National Highways work on the M5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Clevedon area's roads running",
  "s1loc":[
   "Clevedon is a Victorian seaside town on the Severn estuary, its seafront and pier set just west of the M5 at junction 20. North Somerset Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the coast roads and the motorway approaches.",
   "The council delivers reactive and cyclical highways work through the North Somerset Environment Company, its own company that took on the contract in recent years covering potholes, gullies, drainage, gritting, signs and road markings across roughly eleven hundred kilometres of network. The town's commercial estates and the A370 corridor anchor local trade.",
   "National Highways operates the M5, with junction 20 the gateway to the town and the split-level Gordano valley section climbing toward junction 19 and Gordano services, while the council-managed A370 runs toward Bristol and Weston. Motorway and coast-road work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Clevedon crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, coast-road and winter-maintenance work",
  "s2_intro":"Across Clevedon's NSEC carriageway work and the National Highways M5",
 },
 "reigate": {
  "region":"Reigate and Surrey",
  "nearby":["Redhill","Horley","Epsom"],
  "snapshot":"iNeedWorkwear kits Reigate's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Surrey County Council's Ringway term contract to National Highways work on the M25 and M23, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Reigate area's roads running",
  "s1loc":[
   "Reigate sits beneath the North Downs escarpment in east Surrey, twinned with neighbouring Redhill and overlooked by the M25 at junction 8 on Reigate Hill. Surrey County Council is the highway authority, and its gangs work in Class 3 hi-vis around that interchange and the A217 corridor.",
   "The county delivers highways through its Ringway term-maintenance contract, in place since 2022 after the changeover from Kier, covering planned and reactive works across the Surrey network. The town's commercial centre and the A23 and A217 corridors anchor local trade.",
   "National Highways operates the M25 at junction 8, the Reigate Hill interchange on the A217, and the rare four-level stack where the M25 meets the M23 just to the south-east, with the A23 running the Redhill corridor. Orbital and interchange work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Reigate crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, interchange and winter-maintenance work",
  "s2_intro":"Across Reigate's Ringway carriageway work and the National Highways M25 and M23",
 },
 "horley": {
  "region":"Horley and Surrey",
  "nearby":["Reigate","Redhill","Crawley"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Horley's highway maintenance teams and roadworks contractors, from Surrey County Council's Ringway term contract to National Highways work on the M23 and Gatwick approaches, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Horley area's roads running",
  "s1loc":[
   "Horley sits at the southern edge of Surrey immediately north of Gatwick Airport, where the M23 and the A23 run side by side toward the Sussex border. Surrey County Council is the highway authority, and its gangs work in Class 3 hi-vis along those airport approaches and the A23 corridor.",
   "The county delivers highways through its Ringway term-maintenance contract, running since 2022 after the changeover from Kier, covering reactive and planned works across the Surrey network. London Gatwick Airport, the dominant local employer and traffic generator, anchors the town's trade.",
   "National Highways operates the M23, with junction 9 and the 9A spur running directly into Gatwick, alongside the parallel A23, while Surrey-managed roads carry the town's local traffic. Motorway and airport-access work alike mean fast roads and heavy traffic management.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Horley crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, airport-access and winter-maintenance work",
  "s2_intro":"Across Horley's Ringway carriageway work and the National Highways M23",
 },
 "godalming": {
  "region":"Godalming and Surrey",
  "nearby":["Guildford","Farnham","Aldershot"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Godalming's highway maintenance teams and roadworks contractors, from Surrey County Council's Ringway term contract to National Highways work on the A3, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Godalming area's roads running",
  "s1loc":[
   "Godalming is a historic Wey-valley market town south of Guildford, set between the A3 trunk road and the railway in the Surrey Hills. Surrey County Council is the highway authority, and its gangs work in Class 3 hi-vis along the old Portsmouth Road and the trunk-road approaches.",
   "The county delivers highways through its Ringway term-maintenance contract, in place since 2022 after the changeover from Kier, covering planned and reactive works across the Surrey network. The Catteshall Lane commercial estate and the town's riverside trade anchor local work.",
   "National Highways operates the A3, where the Milford bypass carries the London-to-Portsmouth route past the town toward its meeting with the A31 near Guildford, while the council-managed A3100 follows the old through-route. Trunk-road and town-corridor work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Godalming crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, trunk-corridor and winter-maintenance work",
  "s2_intro":"Across Godalming's Ringway carriageway work and the National Highways A3",
 },
 "sandhurst": {
  "region":"Sandhurst and Berkshire",
  "nearby":["Camberley","Farnborough","Bracknell"],
  "snapshot":"iNeedWorkwear kits Sandhurst's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Bracknell Forest Council's Ringway term contract to National Highways work on the M3, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Sandhurst area's roads running",
  "s1loc":[
   "Sandhurst sits on the Berkshire border with Surrey and Hampshire along the River Blackwater, best known for the Royal Military Academy on Yorktown Road. Bracknell Forest Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the A30 corridor and the academy approaches.",
   "The council delivers highways through Ringway under a long-running term-services contract, an arrangement covering planned and reactive maintenance across the borough's network. The Yorktown commercial area and the Blackwater valley estates anchor local trade.",
   "National Highways operates the M3, reached a few miles north at junction 4, and the trunk sections of the A30 London Road that runs through the town, while the council manages the local distributor network. Motorway-link and trunk-corridor work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Sandhurst crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-link and winter-maintenance work",
  "s2_intro":"Across Sandhurst's Ringway carriageway work and the National Highways M3 and A30",
 },
 "woodley": {
  "region":"Woodley and Berkshire",
  "nearby":["Reading","Wokingham","Bracknell"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Woodley's highway maintenance teams and roadworks contractors, from Wokingham Borough Council's VolkerHighways term contract to National Highways work on the M4 and A329(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Woodley area's roads running",
  "s1loc":[
   "Woodley sits on the eastern edge of Reading in the Thames valley, a former aerodrome town now built tight against the A329(M) spur. Wokingham Borough Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that motorway-spur corridor and the town's estates.",
   "The council delivers highways through VolkerHighways under the Wokingham Highways Alliance with professional services support, covering term maintenance and construction across the borough network in recent years. The Headley Road industrial estates and Thames Valley Park anchor local trade.",
   "National Highways operates the M4 at junction 10 and the A329(M) spur that runs past Woodley to Bracknell, with dedicated town exits, while the council manages the A4 Bath Road and local distributors. Motorway and spur-corridor work alike mean fast roads and heavy commuter traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Woodley crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, motorway-spur and winter-maintenance work",
  "s2_intro":"Across Woodley's VolkerHighways carriageway work and the National Highways M4 and A329(M)",
 },
 "crowborough": {
  "region":"Crowborough and East Sussex",
  "nearby":["Tunbridge Wells","Hailsham","Eastbourne"],
  "snapshot":"iNeedWorkwear kits Crowborough's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from East Sussex Highways and its Balfour Beatty Living Places partnership to the A26 High Weald corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Crowborough area's roads running",
  "s1loc":[
   "Crowborough is one of the highest towns in the South East, set on a High Weald ridge near Ashdown Forest with the A26 as its spine. East Sussex County Council is the highway authority, and its gangs work in Class 3 hi-vis along that hilly, rural network of steep approaches and ridge roads.",
   "The county delivers highways through the East Sussex Highways partnership, run with Balfour Beatty Living Places since 2023, covering roads, drainage, lighting, structures and winter gritting, with recent overnight patching on the A26 Beacon Road. The town's commercial parades and Weald employment sites anchor local trade.",
   "The council manages the A26 Beacon Road and Eridge Road corridor between Tunbridge Wells and Lewes, a principal county route rather than a trunk road, with no motorway reaching the town. Ridge-road and rural-corridor work alike mean exposed roads and weather-driven repairs.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Crowborough crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, ridge-corridor and winter-maintenance work",
  "s2_intro":"Across Crowborough's East Sussex Highways carriageway work and the A26 High Weald corridor",
 },
 "caterham": {
  "region":"Caterham and Surrey",
  "nearby":["Redhill","Reigate","Croydon"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Caterham's highway maintenance teams and roadworks contractors, from Surrey County Council's Ringway term contract to National Highways work on the M25, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Caterham area's roads running",
  "s1loc":[
   "Caterham sits in a dry valley below the North Downs in east Surrey, split between Caterham-on-the-Hill and Caterham Valley with the M25 running along the foot of the escarpment. Surrey County Council is the highway authority, and its gangs work in Class 3 hi-vis along the A22 bypass and the downland routes.",
   "The county delivers highways through its Ringway term-maintenance contract, in place since 2022 after the changeover from Kier, covering planned and reactive works across the Surrey network. The former barracks redevelopment and the valley commercial centre anchor local trade.",
   "National Highways operates the M25, reached where the A22 crosses at junction 6 near Godstone, while the council-managed A22 Caterham bypass runs from the Wapses Lodge roundabout and the A25 Oxted Road crosses Tandridge. Orbital and bypass work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Caterham crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bypass and winter-maintenance work",
  "s2_intro":"Across Caterham's Ringway carriageway work and the National Highways M25",
 },
 "wellington": {
  "region":"Wellington and Somerset",
  "nearby":["Taunton","Bridgwater","Tiverton"],
  "snapshot":"iNeedWorkwear kits Wellington's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Somerset Council's term contractors to National Highways work on the M5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Wellington area's roads running",
  "s1loc":[
   "Wellington is a Somerset market town south-west of Taunton, close to the Devon border and the M5 in the Vale of Taunton Deane. Somerset Council, the unitary authority created in 2023, is the highway authority, and its gangs work in Class 3 hi-vis along the A38 and the motorway approaches.",
   "The council delivers highways through a set of term contracts in recent years, with core maintenance, surfacing, resurfacing and new infrastructure each held by separate contractors rather than a single partner. Westpark 26 business park and the Chelston and Foxmoor estates by the M5 anchor local trade.",
   "National Highways operates the M5 with junction 26 serving the town and the trunk A38 Chelston link alongside, where a major refurbishment of the junction sliproads and roundabout has recently been carried out. Motorway and trunk-link work alike mean fast roads and major junction schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Wellington crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-link and winter-maintenance work",
  "s2_intro":"Across Wellington's Somerset Council carriageway work and the National Highways M5 and A38",
 },
 "bathgate": {
  "region":"Bathgate and West Lothian",
  "nearby":["Livingston","Falkirk","Airdrie"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Bathgate's highway maintenance teams and roadworks contractors, from West Lothian Council's in-house roads service to Transport Scotland work on the M8, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bathgate area's roads running",
  "s1loc":[
   "Bathgate sits on the M8 corridor in central Scotland, a former shale-oil and motor-industry town between Edinburgh and Glasgow. West Lothian Council is the roads authority, and its gangs work in Class 3 hi-vis along the motorway approaches and the town's commuter routes.",
   "The council maintains its network in-house through its own roads service, looking after around a thousand kilometres of carriageway directly under a multi-year capital programme. The Pyramids Business Park at Easter Inch, on the site of the former Motorola plant and now a film and television hub, anchors local trade.",
   "Transport Scotland is the trunk-roads authority, with the M8 through Bathgate maintained on its behalf by BEAR Scotland in the south-east operating unit, and the A801 links the town to the M9 near Falkirk. Motorway and trunk-link work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Bathgate crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, motorway-corridor and winter-maintenance work",
  "s2_intro":"Across Bathgate's in-house carriageway work and the Transport Scotland M8",
 },
 "musselburgh": {
  "region":"Musselburgh and East Lothian",
  "nearby":["Edinburgh","Livingston","Falkirk"],
  "snapshot":"iNeedWorkwear kits Musselburgh's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from East Lothian Council's in-house roads service to Transport Scotland work on the A1 and Edinburgh City Bypass, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Musselburgh area's roads running",
  "s1loc":[
   "Musselburgh stands at the mouth of the River Esk on the Firth of Forth just east of Edinburgh, the largest town in East Lothian. East Lothian Council is the roads authority, and its gangs work in Class 3 hi-vis along the A1 approaches and the coast road into the capital.",
   "The council maintains its adopted network in-house through its own roads service, handling carriageways, footways, drainage and winter gritting directly, with recent active-travel works around the Wallyford and Old Craighall corridors. The town's racecourse, harbour and commercial estates anchor local trade.",
   "Transport Scotland is the trunk-roads authority, with the A1 and the A720 Edinburgh City Bypass maintained on its behalf by BEAR Scotland in the south-east operating unit, and the long-planned Sheriffhall roundabout grade-separation set to remove the bypass's last at-grade junction. Trunk and bypass work alike mean fast roads and major junction schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Musselburgh crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, bypass and winter-maintenance work",
  "s2_intro":"Across Musselburgh's in-house carriageway work and the Transport Scotland A1 and A720",
 },
 "penzance": {
  "region":"Penzance and Cornwall",
  "nearby":["Camborne","Truro","Falmouth"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Penzance's highway maintenance teams and roadworks contractors, from Cornwall Council's CORMAC company to National Highways work on the A30, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Penzance area's roads running",
  "s1loc":[
   "Penzance is the harbour town at the far west of Cornwall, where the A30 finally reaches the coast at Mount's Bay. Cornwall Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that trunk-road terminus and the harbour approaches.",
   "The council delivers highways through CORMAC, its own company within the Corserv group, maintaining around seven thousand five hundred kilometres of Cornish road under term service contracts covering routine maintenance, drainage, signs and vegetation. Penzance Harbour, the mainland terminal for the Isles of Scilly ferry, and the heliport beside the A30 anchor local trade.",
   "National Highways operates the A30, the strategic spine of Cornwall ending at Penzance, while the council-managed A394 toward Helston and the A3071 carry local traffic. Trunk-terminus and harbour-access work alike mean busy roads and heavy seasonal traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Penzance crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, harbour-access and seasonal-traffic work",
  "s2_intro":"Across Penzance's CORMAC carriageway work and the National Highways A30",
 },
 "melksham": {
  "region":"Melksham and Wiltshire",
  "nearby":["Chippenham","Trowbridge","Bath"],
  "snapshot":"iNeedWorkwear kits Melksham's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Wiltshire Council's M Group Highways term contract to the A350 corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Melksham area's roads running",
  "s1loc":[
   "Melksham is a market town on the River Avon in west Wiltshire, sitting on the A350 between Chippenham and Trowbridge. Wiltshire Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that busy north-south corridor and the town's approaches.",
   "The council delivers highways through M Group Highways, the rebranded Milestone, under a term contract that began in 2025 covering carriageways, footways, drainage, lighting and winter gritting along with the council's parish stewards. The Bowerhill industrial estate, on land linked to the town's rubber-manufacturing heritage, anchors local trade.",
   "The council manages the A350 corridor through the town, where a major Melksham bypass with a river viaduct has been proposed, while National Highways operates the M4 to the north near Chippenham. Corridor and bypass work alike mean busy roads and major scheme planning.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Melksham crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, A350-corridor and winter-maintenance work",
  "s2_intro":"Across Melksham's M Group Highways carriageway work and the A350 corridor",
 },
 "seaham": {
  "region":"Seaham and County Durham",
  "nearby":["Sunderland","Houghton le Spring","Peterlee"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Seaham's highway maintenance teams and roadworks contractors, from Durham County Council's in-house highways operation to National Highways work on the A19, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Seaham area's roads running",
  "s1loc":[
   "Seaham is a former colliery and harbour town on the Durham coast, its marina and seafront built around the old coal docks south of Sunderland. Durham County Council is the highway authority, and its gangs work in Class 3 hi-vis along the coast roads and the A19 approaches.",
   "The council maintains its network largely through its own in-house highways teams, directly running inspection and works crews across thousands of kilometres of road, with external frameworks for major schemes. The South Seaham Garden Village at Cold Hesledon, with its new spine road, and the harbour marina anchor local trade.",
   "National Highways operates the A19 immediately west of the town, the strategic north-south route, while the council-managed A690 and A182 carry local traffic toward Durham and the coast, with the A1(M) further west. Trunk-road and coast-route work alike mean fast roads and new-estate infrastructure.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Seaham crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, coast-route and winter-maintenance work",
  "s2_intro":"Across Seaham's in-house carriageway work and the National Highways A19",
 },
 "horwich": {
  "region":"Horwich and Greater Manchester",
  "nearby":["Bolton","Chorley","Leyland"],
  "snapshot":"iNeedWorkwear kits Horwich's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Bolton Council's highways service to National Highways work on the M61, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Horwich area's roads running",
  "s1loc":[
   "Horwich sits at the foot of Rivington Pike on the north-western edge of Greater Manchester, a former locomotive-works town beside the M61. Bolton Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis around the motorway junction and the retail-park approaches.",
   "The council delivers highways through its own service with framework contractors brought in for capital schemes, working alongside Transport for Greater Manchester on the key route network. Middlebrook retail and leisure park and the Bolton Wanderers stadium, with the former loco-works regeneration at Rivington Chase, anchor local trade.",
   "National Highways operates the M61, reached at junction 6, where the A6027 De Havilland Way links the motorway to the retail parks and the A673 runs into Horwich and Bolton. Motorway-junction and retail-corridor work alike mean fast roads and heavy visitor traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Horwich crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, retail-corridor and winter-maintenance work",
  "s2_intro":"Across Horwich's Bolton Council carriageway work and the National Highways M61",
 },
 "hailsham": {
  "region":"Hailsham and East Sussex",
  "nearby":["Eastbourne","Bexhill-on-Sea","Crowborough"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Hailsham's highway maintenance teams and roadworks contractors, from East Sussex Highways and its Balfour Beatty Living Places partnership to National Highways work on the A27, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Hailsham area's roads running",
  "s1loc":[
   "Hailsham is a historic Wealden market and rope-making town north of Eastbourne, sitting on the A22 corridor toward the south coast. East Sussex County Council is the highway authority, and its gangs work in Class 3 hi-vis along that corridor and the town bypass.",
   "The county delivers highways through the East Sussex Highways partnership, run with Balfour Beatty Living Places since 2023, covering roads, drainage, lighting, structures and winter gritting across the county. The Diplocks Way industrial area and the town's commercial estates anchor local trade.",
   "National Highways operates the A27 south-coast trunk route past Polegate to the south, while the council-managed A22 carries the Hailsham bypass and links north toward the Weald. Trunk-road and bypass work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Hailsham crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bypass and winter-maintenance work",
  "s2_intro":"Across Hailsham's East Sussex Highways carriageway work and the National Highways A27",
 },
 "chesham": {
  "region":"Chesham and Buckinghamshire",
  "nearby":["Hemel Hempstead","Berkhamsted","High Wycombe"],
  "snapshot":"iNeedWorkwear kits Chesham's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Buckinghamshire Council's Balfour Beatty Living Places term contract to National Highways work on the M25 and A41, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Chesham area's roads running",
  "s1loc":[
   "Chesham sits in a narrow Chiltern Hills valley at the source of the River Chess, the northern terminus of the London Underground Metropolitan line in the Chilterns area of outstanding natural beauty. Buckinghamshire Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the steep valley approaches and the A416 spine.",
   "The council delivers highways through Balfour Beatty Living Places, whose term contract began in 2023 and runs into the 2030s, maintaining thousands of kilometres of carriageway, footways and cycle routes with winter gritting, lighting and gully work. The town's valley industrial sites and the constrained Chiltern network anchor local trade.",
   "National Highways operates the M25 to the south near Chorleywood and the A41 dual carriageway, while the council-managed A416 St Mary's Way carries the town's traffic between Amersham and Berkhamsted. Strategic-link and valley-spine work alike mean busy roads and steep, constrained approaches.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Chesham crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, valley-spine and winter-maintenance work",
  "s2_intro":"Across Chesham's Balfour Beatty Living Places carriageway work and the National Highways M25 and A41",
 },
 "gainsborough": {
  "region":"Gainsborough and Lincolnshire",
  "nearby":["Retford","Lincoln","Scunthorpe"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Gainsborough's highway maintenance teams and roadworks contractors, from Lincolnshire County Council's Balfour Beatty Living Places contract to the A631 relief road and the M180, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Gainsborough area's roads running",
  "s1loc":[
   "Gainsborough is a Trent-side market and engineering town in West Lindsey, where the A156, A631 and A159 meet beside the river. Lincolnshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along the relief road and the riverside routes.",
   "The county delivers highways through Balfour Beatty Living Places, whose contract was extended to run into the early 2030s, covering gritting, drainage, reactive repairs and traffic management across roughly nine thousand kilometres of carriageway. The town's engineering heritage and the eastern industrial estates anchor local trade.",
   "National Highways operates the M180 and M181 to the north toward Scunthorpe as the nearest motorway, while the council-managed A631 Gainsborough relief road, Thorndike Way, carries traffic to the A156 and A159 around the centre. Relief-road and county-route work alike mean busy roads and junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Gainsborough crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, relief-road and winter-maintenance work",
  "s2_intro":"Across Gainsborough's Balfour Beatty Living Places carriageway work and the A631 relief road",
 },
 "renfrew": {
  "region":"Renfrew and Renfrewshire",
  "nearby":["Paisley","Glasgow","Clydebank"],
  "snapshot":"iNeedWorkwear kits Renfrew's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Renfrewshire Council's in-house roads service to Transport Scotland work on the M8, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Renfrew area's roads running",
  "s1loc":[
   "Renfrew sits on the south bank of the Clyde beside Glasgow Airport, a historic burgh now anchored by the new opening road bridge over the river. Renfrewshire Council is the roads authority, and its gangs work in Class 3 hi-vis along the airport approaches and the riverside routes.",
   "The council maintains its local roads in-house through its own service, and recently delivered the Renfrew Bridge, the first opening road bridge over the Clyde, linking the town to Yoker and Clydebank and serving the advanced manufacturing innovation district beside the airport. That district and the airport estates anchor local trade.",
   "Transport Scotland is the trunk-roads authority, with the M8 to the north and the A737 and A898 Erskine Bridge approach maintained on its behalf by Amey in the south-west operating unit. Motorway and bridge-approach work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Renfrew crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, airport-corridor and winter-maintenance work",
  "s2_intro":"Across Renfrew's in-house carriageway work and the Transport Scotland M8",
 },
 "bellshill": {
  "region":"Bellshill and North Lanarkshire",
  "nearby":["Motherwell","Coatbridge","Hamilton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Bellshill's highway maintenance teams and roadworks contractors, from North Lanarkshire Council's roads maintenance arrangement to Transport Scotland work on the M74, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bellshill area's roads running",
  "s1loc":[
   "Bellshill stands on the Lanarkshire plateau between Motherwell and Coatbridge, ringed by the M8, M73 and M74 in the heart of the central-belt motorway network. North Lanarkshire Council is the roads authority, and its gangs work in Class 3 hi-vis along the A725 bypass and the motorway approaches.",
   "The council delivers roads maintenance through a long-term arrangement that passed in recent years from Amey's PPP to a new contractor, HOCHTIEF, covering carriageways, lighting and structures across the network. Strathclyde Business Park off the A725 and the nearby Eurocentral rail-freight and distribution park anchor local trade.",
   "Transport Scotland is the trunk-roads authority, with the M74 at Raith and the M8 and M73 maintained on its behalf by Amey in the south-west operating unit, while the A725 Bellshill bypass runs beneath the grade-separated Raith interchange. Motorway and interchange work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Bellshill crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, interchange and winter-maintenance work",
  "s2_intro":"Across Bellshill's roads-maintenance carriageway work and the Transport Scotland M74",
 },
 "shoreham-by-sea": {
  "region":"Shoreham-by-Sea and West Sussex",
  "nearby":["Worthing","Hove","Lancing"],
  "snapshot":"iNeedWorkwear kits Shoreham-by-Sea's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from West Sussex County Council's VolkerHighways contract to National Highways work on the A27, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Shoreham-by-Sea area's roads running",
  "s1loc":[
   "Shoreham-by-Sea sits at the mouth of the River Adur on the West Sussex coast, a working port town between Worthing and Brighton on the A27. West Sussex County Council is the highway authority, and its gangs work in Class 3 hi-vis along that coastal trunk corridor and the harbour approaches.",
   "The county delivers highways through VolkerHighways, appointed under the core maintenance contract that began in 2025 alongside a second contractor, covering planned, responsive and emergency works, structures and winter maintenance. Shoreham Port, a south-coast commercial harbour, and Shoreham Airport, the country's oldest licensed airfield, anchor local trade.",
   "National Highways operates the A27 through and north of the town, where the long-discussed Worthing and Lancing improvement is a live corridor scheme, while the council manages the A283 and A259. Trunk-corridor and port-access work alike mean fast roads and heavy goods movements.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Shoreham-by-Sea crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, port-access and winter-maintenance work",
  "s2_intro":"Across Shoreham-by-Sea's VolkerHighways carriageway work and the National Highways A27",
 },
 "llandudno": {
  "region":"Llandudno and Conwy",
  "nearby":["Colwyn Bay","Rhyl","Bangor"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Llandudno's highway maintenance teams and roadworks contractors, from Conwy County Borough Council's highways service to Welsh Government trunk-road work on the A55, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Llandudno area's roads running",
  "s1loc":[
   "Llandudno is the largest seaside resort in Wales, set on a bay beneath the Great Orme with the A55 expressway sweeping across the Conwy estuary nearby. Conwy County Borough Council is the local highway authority, and its gangs work in Class 3 hi-vis along the promenade routes and the A470 spur into the resort.",
   "The council maintains its local roads in-house through its highways and neighbourhood services, handling routine maintenance, drainage and winter gritting, with framework contractors brought in for larger resurfacing and capital schemes. The resort's seasonal tourism economy and the A55-corridor estates anchor local trade.",
   "The A55 North Wales Expressway is a trunk road managed for the Welsh Government through Traffic Wales, maintained by the North and Mid Wales Trunk Road Agent, with the Conwy Tunnel beneath the estuary the longest road tunnel in Wales. Trunk-expressway and tunnel work alike mean fast roads and major structure maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Llandudno crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, expressway-corridor and seasonal-traffic work",
  "s2_intro":"Across Llandudno's Conwy County Borough Council carriageway work and the Welsh Government A55",
 },
 "poulton-le-fylde": {
  "region":"Poulton-le-Fylde and Lancashire",
  "nearby":["Blackpool","Thornton Cleveleys","Fleetwood"],
  "snapshot":"iNeedWorkwear kits Poulton-le-Fylde's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Lancashire County Council's highways service to National Highways work on the M55 and A585, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Poulton-le-Fylde area's roads running",
  "s1loc":[
   "Poulton-le-Fylde is a historic market town on the Fylde coast plain inland of Blackpool, close to the M55 and the A585 corridor toward Fleetwood. Lancashire County Council is the highway authority, and its gangs work in Class 3 hi-vis along those routes and the town's approaches.",
   "The county delivers highways largely in-house through its own workforce, handling routine maintenance, potholes and gritting with contractors on capital resurfacing, under a substantial annual maintenance budget. The Fylde employment areas and the Hillhouse enterprise zone near Thornton anchor local trade.",
   "National Highways operates the M55 serving the Fylde and built the A585 Windy Harbour to Skippool bypass linking the motorway to Fleetwood, with the Norcross junction reconstructed as part of that corridor. Motorway and bypass work alike mean fast roads and major junction schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Poulton-le-Fylde crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, bypass-corridor and winter-maintenance work",
  "s2_intro":"Across Poulton-le-Fylde's Lancashire County Council carriageway work and the National Highways M55 and A585",
 },
 "stourport-on-severn": {
  "region":"Stourport-on-Severn and Worcestershire",
  "nearby":["Kidderminster","Bromsgrove","Worcester"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Stourport-on-Severn's highway maintenance teams and roadworks contractors, from Worcestershire County Council's term highways contract to the A451 corridor and the M5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Stourport-on-Severn area's roads running",
  "s1loc":[
   "Stourport-on-Severn is a Georgian canal town in Wyre Forest, grown around the basins where the Staffordshire and Worcestershire Canal meets the River Severn. Worcestershire County Council is the highway authority, and its gangs work in Class 3 hi-vis along the A451 and the town's riverside routes.",
   "The county delivers highways through a term maintenance contract, run by Ringway in recent years and being renewed, with a separate engineering term contract held alongside it, covering roads, footways, bridges, gullies and winter service. The Stourport Road employment corridor, the Sandy Lane industrial estate and the marina anchor local trade.",
   "The council manages the A451 north to Kidderminster and on toward Worcester, while National Highways operates the M5 reached to the east via Kidderminster and the A449 and A456. Town-corridor and motorway-link work alike mean busy roads and junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Stourport-on-Severn crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, A451-corridor and winter-maintenance work",
  "s2_intro":"Across Stourport-on-Severn's term-contract carriageway work and the A451 corridor and M5",
 },
 "skegness": {
  "region":"Skegness and Lincolnshire",
  "nearby":["Boston","Lincoln","Spalding"],
  "snapshot":"iNeedWorkwear kits Skegness's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Lincolnshire County Council's Balfour Beatty Living Places contract to the A52 and A158 coastal routes, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Skegness area's roads running",
  "s1loc":[
   "Skegness is the Lincolnshire coast's leading resort, its seafront and the Butlin's holiday camp at Ingoldmells drawing heavy seasonal traffic down the A52 and A158. Lincolnshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along those coastal routes and the town centre.",
   "The county delivers highways through Balfour Beatty Living Places, whose contract was extended to run into the early 2030s, covering gritting, drainage, reactive repairs and traffic management across roughly nine thousand kilometres of carriageway. The resort economy and the Go Skegness improvement programme anchor local work.",
   "The council manages the A52 from Boston and the A158 from Lincoln, the coastal terminus routes with no motorway reaching the town, including junction works at the Ship corner where the two meet. Coastal-route and resort-junction work alike mean busy roads and heavy seasonal peaks.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Skegness crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, coastal-route and seasonal-traffic work",
  "s2_intro":"Across Skegness's Balfour Beatty Living Places carriageway work and the A52 and A158",
 },
 "biddulph": {
  "region":"Biddulph and Staffordshire",
  "nearby":["Congleton","Kidsgrove","Stoke-on-Trent"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Biddulph's highway maintenance teams and roadworks contractors, from Staffordshire County Council's Amey term partnership to National Highways work on the M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Biddulph area's roads running",
  "s1loc":[
   "Biddulph is a Staffordshire Moorlands town on the A527 between the Potteries and Congleton, set on the Cheshire fringe below the moors. Staffordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that corridor and the town relief road.",
   "The county delivers highways through Amey under its Infrastructure+ contract, an arrangement running since 2014 and extended in recent years, covering carriageways, drainage, lighting, signals, bridges and trees. The Biddulph Industrial Estate and the Meadows Way commercial sites anchor local trade.",
   "National Highways operates the M6 to the west of the Potteries, reached via the A500, while the council-managed A527 and the A53 toward Leek carry local traffic, with the Biddulph inner relief road, Meadows Way, around the centre. Motorway-link and relief-road work alike mean busy roads and junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Biddulph crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, relief-road and winter-maintenance work",
  "s2_intro":"Across Biddulph's Amey term-contract carriageway work and the National Highways M6",
 },
 "dorchester": {
  "region":"Dorchester and Dorset",
  "nearby":["Weymouth","Poole","Bournemouth"],
  "snapshot":"iNeedWorkwear kits Dorchester's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Dorset Council's highways term service contract to National Highways work on the A35, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Dorchester area's roads running",
  "s1loc":[
   "Dorchester is the county town of Dorset, set on the River Frome with the model settlement of Poundbury on its western edge. Dorset Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the A35 bypass and the town approaches.",
   "The council delivers highways through Dorset Highways under a long-running term service contract, held in recent years by Hanson, now Heidelberg Materials, and being re-tendered for a new term later in the decade, covering maintenance, drainage and winter service. Poundbury and the Brewery Square regeneration anchor local trade.",
   "National Highways operates the A35, the Honiton-to-Poole trunk road that runs as the Dorchester bypass south of the town, meeting the council-managed A37 toward Yeovil at the Monkey's Jump roundabout. Trunk-road and bypass work alike mean fast roads and major junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Dorchester crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, bypass and winter-maintenance work",
  "s2_intro":"Across Dorchester's term-service carriageway work and the National Highways A35",
 },
 "atherton": {
  "region":"Atherton and Greater Manchester",
  "nearby":["Leigh","Wigan","Hindley"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Atherton's highway maintenance teams and roadworks contractors, from Wigan Council's in-house highways operation to National Highways work on the M61 and M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Atherton area's roads running",
  "s1loc":[
   "Atherton, the old Chowbent, is a former cotton and mining town in the Wigan borough between Leigh and Bolton on the A579. The Metropolitan Borough of Wigan is the highway authority, and its gangs work in Class 3 hi-vis along Atherleigh Way and the town's busy junctions.",
   "The council runs a predominantly in-house highways operation, publishing a rolling planned-maintenance programme for inspections, resurfacing and reactive works across the borough. The former mill-town industrial sites and the A579 trade corridor anchor local work.",
   "National Highways operates the M61 to the north and the M6 to the west as the strategic network, while the council-managed A580 East Lancashire Road runs to the south and the A579 Atherleigh Way and the A577 meet at the Talbot roundabout. Strategic-network and town-junction work alike mean fast roads and busy multi-arm junctions.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Atherton crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, town-junction and winter-maintenance work",
  "s2_intro":"Across Atherton's in-house carriageway work and the National Highways M61 and M6",
 },
 "failsworth": {
  "region":"Failsworth and Greater Manchester",
  "nearby":["Oldham","Middleton","Droylsden"],
  "snapshot":"iNeedWorkwear kits Failsworth's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Oldham Council's in-house highways service to National Highways work on the M60, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Failsworth area's roads running",
  "s1loc":[
   "Failsworth sits on the A62 Oldham Road between Manchester and Oldham, with the M60 orbital skirting its eastern edge and the Metrolink tram line running through the town. The Metropolitan Borough of Oldham is the highway authority, and its gangs work in Class 3 hi-vis along that road-and-tram corridor.",
   "The council brought its highways service back in-house in recent years after winding down its Unity Partnership company, now running delivery through its own teams with framework contractors for larger schemes. The A62 corridor trade and the Daisy Nook fringe anchor local work.",
   "National Highways operates the M60, reached via junction 22, while the council-managed A62 Oldham Road carries the tram line and local traffic through the town. Orbital and tram-corridor work alike mean fast roads and central-reservation maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Failsworth crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, tram-corridor and winter-maintenance work",
  "s2_intro":"Across Failsworth's in-house carriageway work and the National Highways M60",
 },
 "colne": {
  "region":"Colne and Lancashire",
  "nearby":["Nelson","Burnley","Accrington"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Colne's highway maintenance teams and roadworks contractors, from Lancashire County Council's highways service to National Highways work on the M65, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Colne area's roads running",
  "s1loc":[
   "Colne is a Pendle hill town at the very end of the M65, a former weaving town on the edge of the Lancashire moors toward the Yorkshire border. Lancashire County Council is the highway authority, and its gangs work in Class 3 hi-vis along the motorway terminus and the A56 and A6068 onward routes.",
   "The county delivers highways mainly through its own in-house teams, more recently supported by a streamlined maintenance partner for pothole and reactive repairs, alongside contractors on capital resurfacing. The town's mill-conversion industrial sites and the Pennine trade routes anchor local work.",
   "National Highways operates the M65, which reaches its northern terminus at Colne junction 14, while the council-managed A56 and A6068 carry traffic onward toward Skipton, with the long-mooted Colne to Foulridge link a recurring corridor proposal. Motorway-terminus and Pennine-route work alike mean fast roads and exposed upland weather.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Colne crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, Pennine-route and winter-maintenance work",
  "s2_intro":"Across Colne's Lancashire County Council carriageway work and the National Highways M65",
 },
 "bingley": {
  "region":"Bingley and West Yorkshire",
  "nearby":["Shipley","Keighley","Bradford"],
  "snapshot":"iNeedWorkwear kits Bingley's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Bradford Council and the Yorkshire Highways Alliance framework to the A650 relief road, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bingley area's roads running",
  "s1loc":[
   "Bingley sits in the Aire valley between Bradford and Keighley, famous for the Five Rise Locks on the Leeds and Liverpool Canal and bypassed by the A650 relief road. The City of Bradford Metropolitan District Council is the highway authority, and its gangs work in Class 3 hi-vis along that relief road and the valley corridor.",
   "The council maintains its network largely in-house, running winter service with its own drivers and drawing on contractor frameworks for construction works, including access to the Yorkshire Highways Alliance minor-works framework. The Damart textile mill and the Aire valley industrial estates anchor local trade.",
   "National Highways operates the M606 and M62 to the south as the strategic network, while the council-managed A650 Bingley relief road, a dual carriageway opened to cut town-centre traffic, and the A6038 carry local traffic. Relief-road and valley-corridor work alike mean busy roads and structures maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Bingley crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, relief-road and winter-maintenance work",
  "s2_intro":"Across Bingley's Yorkshire Highways Alliance carriageway work and the A650 relief road",
 },
 "mirfield": {
  "region":"Mirfield and West Yorkshire",
  "nearby":["Dewsbury","Huddersfield","Brighouse"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Mirfield's highway maintenance teams and roadworks contractors, from Kirklees Council's in-house highways service to National Highways work on the M62, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Mirfield area's roads running",
  "s1loc":[
   "Mirfield sits on the River Calder between Dewsbury and Brighouse, a Calder-valley town on the A644 just south of the M62. Kirklees Council is the West Yorkshire metropolitan highway authority, and its gangs work in Class 3 hi-vis along that valley corridor and the motorway approaches.",
   "The council delivers highway maintenance through its own in-house service, supported by contractors for specialist and cyclical works and access to the Yorkshire Highways Alliance minor-works frameworks. The John Cotton textile works and the Calder valley estates anchor local trade.",
   "National Highways operates the M62, reached at junction 25 near Brighouse via the A644, while the council-managed A644, A62 and A638 carry local traffic, with the A62 to Cooper Bridge corridor improvement a current scheme. Motorway-link and valley-corridor work alike mean fast roads and major junction schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Mirfield crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, valley-corridor and winter-maintenance work",
  "s2_intro":"Across Mirfield's in-house carriageway work and the National Highways M62",
 },
 "yeadon": {
  "region":"Yeadon and West Yorkshire",
  "nearby":["Guiseley","Horsforth","Shipley"],
  "snapshot":"iNeedWorkwear kits Yeadon's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Leeds City Council and the Yorkshire Highways Alliance framework to the A658 airport corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Yeadon area's roads running",
  "s1loc":[
   "Yeadon sits on the Aireborough edge of the Leeds district, home to Leeds Bradford Airport on the A658 Harrogate Road. Leeds City Council is the West Yorkshire metropolitan highway authority, and its gangs work in Class 3 hi-vis along that airport corridor and the A65 toward Otley.",
   "The council delivers highways in-house and hosts the Yorkshire Highways Alliance frameworks, tendering large minor-works and carriageway packages on behalf of the West Yorkshire authorities. The Leeds Bradford Airport industrial estate fronting the A658 anchors local trade.",
   "National Highways operates the M62, M621 and A1(M) beyond the district as the strategic network, while the council-managed A658 Harrogate Road and the A65 carry the airport and commuter traffic. Airport-corridor and commuter-route work alike mean busy roads and heavy traffic generation.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Yeadon crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, airport-corridor and winter-maintenance work",
  "s2_intro":"Across Yeadon's Yorkshire Highways Alliance carriageway work and the A658 airport corridor",
 },
 "west bromwich": {
  "region":"West Bromwich and the West Midlands",
  "nearby":["Walsall","Wednesbury","Smethwick"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to West Bromwich's highway maintenance teams and roadworks contractors, from Sandwell Council and the Black Country highways framework to National Highways work on the M5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the West Bromwich area's roads running",
  "s1loc":[
   "West Bromwich is a Black Country town at the heart of Sandwell, with the M5 running along its western edge and the Hawthorns football ground beside junction 1. Sandwell Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis along that motorway corridor and the Expressway routes.",
   "The council procures local highway works through the Black Country Highways Works Framework, led by Wolverhampton on behalf of the region's authorities, with Colas among the appointed contractors in recent years. The Black Country industrial estates and the A41 Expressway corridor anchor local trade.",
   "National Highways operates the M5 with junction 1 on the town's western edge, where a major congestion-relief and junction-reconstruction scheme is being progressed, while the council-managed A41 Black Country Route and A4031 carry local traffic. Motorway-junction and Expressway work alike mean fast roads and major reconstruction.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by West Bromwich crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, motorway-junction and winter-maintenance work",
  "s2_intro":"Across West Bromwich's Black Country framework carriageway work and the National Highways M5",
 },
 "peterlee": {
  "region":"Peterlee and County Durham",
  "nearby":["Seaham","Hartlepool","Houghton le Spring"],
  "snapshot":"iNeedWorkwear kits Peterlee's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Durham County Council's in-house highways operation to the A19 corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Peterlee area's roads running",
  "s1loc":[
   "Peterlee is a 1948 new town on the east Durham plateau between the A19 and the North Sea coast, named after the miners' leader Peter Lee. Durham County Council is the highway authority, and its gangs work in Class 3 hi-vis along the A19 approaches and the town's industrial estates.",
   "The council maintains its network largely in-house, running its own inspection and works teams and a tracked winter-gritting fleet across thousands of kilometres of road, with contractors for major schemes. The North West and South West Industrial Estates and Bracken Hill Business Park, among the county's largest, anchor local trade.",
   "The A19 dual carriageway runs immediately west of the town as the regional spine toward Sunderland and Teesside, with the council-managed A181 linking west toward Durham, while National Highways operates the trunk network beyond. Dual-carriageway and estate-access work alike mean fast roads and busy industrial junctions.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Peterlee crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, industrial-estate and winter-maintenance work",
  "s2_intro":"Across Peterlee's in-house carriageway work and the A19 corridor",
 },
 "faversham": {
  "region":"Faversham and Kent",
  "nearby":["Sittingbourne","Canterbury","Whitstable"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Faversham's highway maintenance teams and roadworks contractors, from Kent County Council's Ringway term contract to National Highways work on the M2, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Faversham area's roads running",
  "s1loc":[
   "Faversham is a historic market and brewing town on a creek off the Swale in north Kent, served directly by the M2. Kent County Council is the highway authority, and its gangs work in Class 3 hi-vis along the motorway approaches and the A2 Watling Street.",
   "The county delivers highways through a long-term term-maintenance contract that passed in recent years from Amey to Ringway, covering roads, drainage, lighting, signals and winter gritting across the Kent network. Shepherd Neame, Britain's oldest brewer, on Court Street anchors the town's trade beside the creekside estates.",
   "National Highways operates the M2 with junction 6 serving the town and the A2 trunk corridor running through, while the council manages the local creek and coast roads. Motorway and trunk-corridor work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Faversham crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, trunk-corridor and winter-maintenance work",
  "s2_intro":"Across Faversham's Ringway carriageway work and the National Highways M2",
 },
 "burnham-on-sea": {
  "region":"Burnham-on-Sea and Somerset",
  "nearby":["Bridgwater","Weston-super-Mare","Clevedon"],
  "snapshot":"iNeedWorkwear kits Burnham-on-Sea's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Somerset Council's Kier term contract to National Highways work on the M5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Burnham-on-Sea area's roads running",
  "s1loc":[
   "Burnham-on-Sea is a Bristol Channel resort twinned with Highbridge on the Somerset Levels, close to the M5 at the Edithmead interchange. Somerset Council, the unitary authority created in 2023, is the highway authority, and its gangs work in Class 3 hi-vis along the coast roads and the motorway approaches.",
   "The council delivers core highways through Kier under a long-term contract that began in 2024, with additional firms appointed alongside it, covering repairs, drainage, verge cutting and winter gritting across thousands of miles of road. The town's seafront economy and the Edithmead estates anchor local trade.",
   "National Highways operates the M5 with junction 22 at Edithmead about three miles east linking to the A38, with Sedgemoor services on the corridor. Motorway and coast-road work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Burnham-on-Sea crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, coast-road and winter-maintenance work",
  "s2_intro":"Across Burnham-on-Sea's Kier term-contract carriageway work and the National Highways M5",
 },
 "northwich": {
  "region":"Northwich and Cheshire",
  "nearby":["Crewe","Sandbach","Ellesmere Port"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Northwich's highway maintenance teams and roadworks contractors, from Cheshire West and Chester Council's highways service to National Highways work on the M6 and M56, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Northwich area's roads running",
  "s1loc":[
   "Northwich is a mid-Cheshire salt town at the meeting of the Weaver and the Dane, long shaped by brine extraction and historic subsidence. Cheshire West and Chester Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the A556 and the town's river crossings.",
   "The council runs its own highways maintenance programme with contractors for surfacing and schemes, on ground where a major mine-stabilisation programme addressed the legacy of salt subsidence. The salt-industry estates and the A556 corridor anchor local trade.",
   "National Highways operates the M6 and M56, linked near the town by the A556 Chester-to-Manchester route, while the council-managed A559 follows the old Roman alignment. Motorway-link and corridor work alike mean fast roads and ground-condition-aware repairs.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Northwich crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, A556-corridor and winter-maintenance work",
  "s2_intro":"Across Northwich's Cheshire West and Chester carriageway work and the National Highways M6 and M56",
 },
 "bangor": {
  "region":"Bangor and Gwynedd",
  "nearby":["Llandudno","Colwyn Bay","Rhyl"],
  "snapshot":"iNeedWorkwear kits Bangor's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Cyngor Gwynedd's highways service to Welsh Government trunk-road work on the A55, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bangor area's roads running",
  "s1loc":[
   "Bangor is a cathedral and university city at the foot of Snowdonia by the Menai Strait, where the A55 crosses to Anglesey. Cyngor Gwynedd, Gwynedd Council, is the local highway authority, and its gangs work in Class 3 hi-vis along the city approaches and the strait crossings.",
   "The council maintains its local roads predominantly in-house through its highways and municipal department, with its own engineering consultancy for design, drawing on borrowing-funded capital programmes. Bangor University and the city's port and retail economy anchor local trade.",
   "The A55 North Wales Expressway is a trunk road managed for the Welsh Government through Traffic Wales and the North and Mid Wales Trunk Road Agent, for which Gwynedd is itself the lead authority, while the A5 and the Menai and Britannia bridges carry the crossings to Anglesey. Expressway and crossing work alike mean fast roads and major structure maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Bangor crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, expressway-corridor and winter-maintenance work",
  "s2_intro":"Across Bangor's Cyngor Gwynedd carriageway work and the Welsh Government A55",
 },
 "maesteg": {
  "region":"Maesteg and Bridgend",
  "nearby":["Bridgend","Port Talbot","Neath"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Maesteg's highway maintenance teams and roadworks contractors, from Bridgend County Borough Council's highways service to Welsh Government trunk-road work on the M4, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Maesteg area's roads running",
  "s1loc":[
   "Maesteg sits at the head of the Llynfi valley in the South Wales valleys, a former coal and ironworks town north of Bridgend. Bridgend County Borough Council is the local highway authority, and its gangs work in Class 3 hi-vis along the valley road and the route down to the M4.",
   "The council delivers highway maintenance through its own roads and transport service, supported by contractors for larger schemes, with the Ewenny Road industrial estate redevelopment clearing former mine workings for new homes and an enterprise hub. The Llynfi valley estates anchor local trade.",
   "The A4063 runs down the valley to Bridgend and the M4, where the Welsh Government, through Traffic Wales and the South Wales Trunk Road Agent, manages the motorway and the A48, while the valley road itself is the council's. Trunk-link and valley-corridor work alike mean busy roads and former-coalfield ground conditions.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Maesteg crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, valley-corridor and winter-maintenance work",
  "s2_intro":"Across Maesteg's Bridgend County Borough Council carriageway work and the Welsh Government M4",
 },
 "buckley": {
  "region":"Buckley and Flintshire",
  "nearby":["Wrexham","Rhyl","Prestatyn"],
  "snapshot":"iNeedWorkwear kits Buckley's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Flintshire County Council's Streetscene service to Welsh Government trunk-road work on the A55 and A494, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Buckley area's roads running",
  "s1loc":[
   "Buckley is the largest town in Flintshire, a former brick and pottery town on the higher ground above the Deeside industrial belt in north-east Wales. Flintshire County Council is the local highway authority, and its gangs work in Class 3 hi-vis along the A549 through the town and the routes to Deeside.",
   "The council maintains its roads in-house through its Streetscene service, looking after well over a thousand kilometres of network directly, with many residents commuting to the Deeside industrial park off the A494. The town's brick-heritage sites and the Deeside estates anchor local trade.",
   "The A55 and the A494 are trunk roads managed for the Welsh Government through Traffic Wales and the North and Mid Wales Trunk Road Agent, with a long-running A494 River Dee bridge replacement in development, while the A549 through Buckley is the council's. Trunk and town-road work alike mean fast roads and major structure planning.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Buckley crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, Deeside-corridor and winter-maintenance work",
  "s2_intro":"Across Buckley's Flintshire Streetscene carriageway work and the Welsh Government A55 and A494",
 },
 "hythe": {
  "region":"Hythe and Hampshire",
  "nearby":["Southampton","Totton","Eastleigh"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Hythe's highway maintenance teams and roadworks contractors, from Hampshire County Council's M Group Highways partnership to the A326 Waterside corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Hythe area's roads running",
  "s1loc":[
   "Hythe sits on the Waterside of Southampton Water across from the city, the gateway to the Fawley refinery complex on the edge of the New Forest. Hampshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along the A326 and the petrochemical-access routes.",
   "The county delivers highways through the Hampshire Highways partnership with M Group Highways, the rebranded Milestone, an arrangement running for several years and extended, covering tens of thousands of task orders a year. Fawley refinery, the largest in the country, and the Waterside industrial sites anchor local trade.",
   "The A326 is the principal council-managed route linking Hythe and the Waterside north to the M27 at Southampton, while National Highways operates the M27 and M3 strategic motorways. Refinery-access and corridor work alike mean heavy goods traffic and busy junctions.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Hythe crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, refinery-access and winter-maintenance work",
  "s2_intro":"Across Hythe's M Group Highways carriageway work and the A326 Waterside corridor",
 },
 "berkhamsted": {
  "region":"Berkhamsted and Hertfordshire",
  "nearby":["Hemel Hempstead","Chesham","Watford"],
  "snapshot":"iNeedWorkwear kits Berkhamsted's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Hertfordshire County Council's Ringway term contract to National Highways work on the M25, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Berkhamsted area's roads running",
  "s1loc":[
   "Berkhamsted is a Chilterns market town in the Bulbourne valley west of Hemel Hempstead, with the Grand Union Canal and the A41 bypass running side by side. Hertfordshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that bypass and the canal-side streets.",
   "The county delivers highways through Ringway, re-appointed in recent years under a contract that began that October and runs into the 2030s, covering road maintenance, potholes, lighting, signals and gritting. The town's commercial centre and the Chiltern valley estates anchor local trade.",
   "National Highways operates the M25 to the south near junction 20 and the M1 beyond, while the council-managed A41 Berkhamsted bypass, a dual carriageway, carries through-traffic south-west of the town. Strategic-link and bypass work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Berkhamsted crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bypass and winter-maintenance work",
  "s2_intro":"Across Berkhamsted's Ringway carriageway work and the National Highways M25 and A41",
 },
 "dumbarton": {
  "region":"Dumbarton and West Dunbartonshire",
  "nearby":["Clydebank","Glasgow","Renfrew"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Dumbarton's highway maintenance teams and roadworks contractors, from West Dunbartonshire Council's in-house roads service to Transport Scotland work on the A82, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Dumbarton area's roads running",
  "s1loc":[
   "Dumbarton stands on the Clyde at the mouth of the River Leven beneath Dumbarton Rock, the historic county town of Dunbartonshire on the road to Loch Lomond. West Dunbartonshire Council is the roads authority, and its gangs work in Class 3 hi-vis along the A82 corridor and the riverside routes.",
   "The council delivers roads through its in-house Roads and Neighbourhood service, with a small-works framework for extra capacity, handling carriageways, gritting and winter service directly. The town's distilling heritage and the Leven-side estates anchor local trade.",
   "Transport Scotland is the trunk-roads authority, with the A82 Glasgow-to-Loch Lomond route through and past the town maintained on its behalf by BEAR Scotland in the north-west operating unit. Trunk-corridor and tourist-route work alike mean fast roads and heavy seasonal traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Dumbarton crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, trunk-corridor and winter-maintenance work",
  "s2_intro":"Across Dumbarton's in-house carriageway work and the Transport Scotland A82",
 },
 "alloa": {
  "region":"Alloa and Clackmannanshire",
  "nearby":["Falkirk","Dunfermline","Livingston"],
  "snapshot":"iNeedWorkwear kits Alloa's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Clackmannanshire Council's in-house roads team to Transport Scotland work on the Clackmannanshire Bridge, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Alloa area's roads running",
  "s1loc":[
   "Alloa is the chief town of Clackmannanshire on the upper Forth, a former brewing and glass town just north of the Clackmannanshire Bridge. Clackmannanshire Council is the roads authority, and its gangs work in Class 3 hi-vis along the A907 and the bridge approaches.",
   "The council delivers roads through its in-house roads and transportation team, running a small-works framework for larger and specialist jobs alongside its own crews. The town's brewing heritage and the Forth-side estates anchor local trade.",
   "Transport Scotland is the trunk-roads authority, with the Clackmannanshire Bridge over the Forth and the connecting A876 and A977 maintained on its behalf by BEAR Scotland and linking to the M9, while the A907 through Alloa is the council's. Bridge and trunk-link work alike mean fast roads and major structure maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Alloa crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bridge-approach and winter-maintenance work",
  "s2_intro":"Across Alloa's in-house carriageway work and the Transport Scotland Clackmannanshire Bridge",
 },
 "ripley": {
  "region":"Ripley and Derbyshire",
  "nearby":["Belper","Alfreton","Ilkeston"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Ripley's highway maintenance teams and roadworks contractors, from Derbyshire County Council's ALLRoads in-house operation to National Highways work on the A38, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Ripley area's roads running",
  "s1loc":[
   "Ripley is an Amber Valley town in the Derbyshire coalfield, a former coal and iron centre built around the Butterley Company on the A610 between the M1 and Matlock. Derbyshire County Council is the highway authority, and its gangs work in Class 3 hi-vis along that corridor and the A38 approaches.",
   "The county maintains its network in-house through Derbyshire Highways and its ALLRoads direct labour organisation, covering construction, drainage, lighting and sign manufacture, with the county police headquarters and the Butterley heritage sites nearby. The coalfield estates and the A610 corridor anchor local trade.",
   "National Highways operates the A38 dual carriageway past Ripley toward the Hartshay interchange, while the council-managed A610 runs from M1 junction 26 around the town toward Codnor and Matlock. Trunk-road and corridor work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Ripley crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, corridor and winter-maintenance work",
  "s2_intro":"Across Ripley's ALLRoads carriageway work and the National Highways A38",
 },
 "spennymoor": {
  "region":"Spennymoor and County Durham",
  "nearby":["Bishop Auckland","Newton Aycliffe","Darlington"],
  "snapshot":"iNeedWorkwear kits Spennymoor's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Durham County Council's in-house highways operation to National Highways work on the A1(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Spennymoor area's roads running",
  "s1loc":[
   "Spennymoor is a former coal and steel town south of Durham city, now a manufacturing centre on the A688 and A167 corridors. Durham County Council is the highway authority, and its gangs work in Class 3 hi-vis along those routes and the approaches to the A1(M).",
   "The council maintains its network largely in-house through Durham Highways, looking after thousands of kilometres of road, hundreds of bridges and tens of thousands of street lights, under a substantial annual investment programme. Thorn Lighting's large factory on the Green Lane Industrial Estate anchors local trade.",
   "National Highways operates the A1(M) a few miles east as the strategic route, while the council-managed A688 and the A167, the old Great North Road, carry local traffic. Trunk-road and town-corridor work alike mean fast roads and busy industrial junctions.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Spennymoor crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, industrial-corridor and winter-maintenance work",
  "s2_intro":"Across Spennymoor's in-house carriageway work and the National Highways A1(M)",
 },
 "kempston": {
  "region":"Kempston and Bedfordshire",
  "nearby":["Bedford","Milton Keynes","Dunstable"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Kempston's highway maintenance teams and roadworks contractors, from Bedford Borough Council's term contractor to National Highways work on the A421, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Kempston area's roads running",
  "s1loc":[
   "Kempston sits on the River Great Ouse immediately south-west of Bedford, effectively continuous with the town. Bedford Borough Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the A6 and the approaches to the A421.",
   "The council delivers highways through a term contractor, with Heidelberg Materials re-securing the contract in recent years, covering resurfacing, kerbing, ironwork, minor bridge repairs and drainage. The town's estates and the Great Ouse riverside anchor local trade.",
   "National Highways operates the A421 dual carriageway, the bypass south of Bedford linking M1 junction 13 toward Cambridge along the Oxford-to-Cambridge corridor, while the council-managed A6 carries local traffic through Kempston and Bedford. Trunk-road and town-route work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Kempston crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, bypass-corridor and winter-maintenance work",
  "s2_intro":"Across Kempston's term-contractor carriageway work and the National Highways A421",
 },
 "lancing": {
  "region":"Lancing and West Sussex",
  "nearby":["Worthing","Shoreham-by-Sea","Littlehampton"],
  "snapshot":"iNeedWorkwear kits Lancing's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from West Sussex County Council's VolkerHighways contract to National Highways work on the A27, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Lancing area's roads running",
  "s1loc":[
   "Lancing is a large West Sussex coastal village between Worthing and Shoreham, with the A27 running along its northern edge below Lancing College. West Sussex County Council is the highway authority, and its gangs work in Class 3 hi-vis along that trunk corridor and the coast roads.",
   "The county delivers highways through VolkerHighways, appointed under the core maintenance contract that began in 2025, covering planned, responsive and emergency works, structures and winter maintenance. Lancing Business Park and the Shoreham Airport fringe across the Adur anchor local trade.",
   "National Highways operates the A27 along the coast, where the long-discussed Worthing and Lancing capacity improvements remain under review, while the council manages the A259 and local distributors. Trunk-corridor and coast-road work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Lancing crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, coast-corridor and winter-maintenance work",
  "s2_intro":"Across Lancing's VolkerHighways carriageway work and the National Highways A27",
 },
 "prestatyn": {
  "region":"Prestatyn and Denbighshire",
  "nearby":["Rhyl","Colwyn Bay","Llandudno"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Prestatyn's highway maintenance teams and roadworks contractors, from Denbighshire County Council's highways service to Welsh Government trunk-road work on the A55, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Prestatyn area's roads running",
  "s1loc":[
   "Prestatyn is a North Wales coastal resort at the northern end of the Offa's Dyke path, set between the Clwydian hills and the sea just off the A55. Denbighshire County Council is the local highway authority, and its gangs work in Class 3 hi-vis along the seafront routes and the expressway approaches.",
   "The council maintains its local roads through its own highways service, handling routine maintenance, drainage and winter gritting, with contractors on larger schemes. The resort economy and the A548 coast-road estates anchor local trade.",
   "The A55 North Wales Expressway is a trunk road managed for the Welsh Government through Traffic Wales and the North and Mid Wales Trunk Road Agent, with the A548 the other key route, while the town's streets are the council's. Expressway and coast-road work alike mean fast roads and heavy seasonal traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Prestatyn crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, expressway-corridor and seasonal-traffic work",
  "s2_intro":"Across Prestatyn's Denbighshire County Council carriageway work and the Welsh Government A55",
 },
 "horsforth": {
  "region":"Horsforth and West Yorkshire",
  "nearby":["Guiseley","Yeadon","Leeds"],
  "snapshot":"iNeedWorkwear kits Horsforth's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Leeds City Council and the Yorkshire Highways Alliance framework to the A65 and outer ring road, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Horsforth area's roads running",
  "s1loc":[
   "Horsforth sits on the north-western edge of Leeds on the A65 Kirkstall-to-Ilkley corridor, bordered to the south by the outer ring road near Leeds Bradford Airport. Leeds City Council is the West Yorkshire metropolitan highway authority, and its gangs work in Class 3 hi-vis along that corridor and the ring-road junctions.",
   "The council delivers highways through its own teams and the Yorkshire Highways Alliance frameworks, for which it acts as lead authority on behalf of the West Yorkshire councils. The airport-corridor business sites and the A65 trade estates anchor local work.",
   "National Highways operates the M62, M1, M621 and A1(M) beyond the district, while the council-managed A65 and the A6120 Leeds outer ring road meet at the Horsforth roundabout, where capacity improvements have been sought. Ring-road and corridor work alike mean busy roads and major junction schemes.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Horsforth crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, ring-road and winter-maintenance work",
  "s2_intro":"Across Horsforth's Yorkshire Highways Alliance carriageway work and the A65 and outer ring road",
 },
 "goole": {
  "region":"Goole and East Yorkshire",
  "nearby":["Selby","Doncaster","Scunthorpe"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Goole's highway maintenance teams and roadworks contractors, from East Riding of Yorkshire Council's in-house highways team to National Highways work on the M62, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Goole area's roads running",
  "s1loc":[
   "Goole is the United Kingdom's furthest-inland port, set where the Ouse meets the Don on the M62 in the East Riding. East Riding of Yorkshire Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the port roads and the motorway-junction approaches.",
   "The council delivers its highways maintenance programme in-house through its own team, coordinating with the port operator on works around the docks. The Port of Goole, run by Associated British Ports, and the Capitol Park and Axis 36 sites at the motorway junction, including the Siemens Mobility train factory, anchor local trade.",
   "National Highways operates the M62 with junction 36 serving the town and port, where the Tom Pudding Way link road connects the junction to the docks, while the council manages the local network. Motorway-junction and port-access work alike mean fast roads and heavy goods movements.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Goole crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, port-access and winter-maintenance work",
  "s2_intro":"Across Goole's in-house carriageway work and the National Highways M62",
 },
 "oswestry": {
  "region":"Oswestry and Shropshire",
  "nearby":["Shrewsbury","Telford","Wrexham"],
  "snapshot":"iNeedWorkwear kits Oswestry's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Shropshire Council's Kier term contract to National Highways work on the A5, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Oswestry area's roads running",
  "s1loc":[
   "Oswestry is a market town on the English side of the Welsh border in north Shropshire, where the A5 and A483 meet at the Mile End roundabout. Shropshire Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that trunk corridor and the town approaches.",
   "The council delivers highways through its Kier term maintenance contract, extended in recent years and moving toward a more mixed model with more direct council control and local contractors. The town's business parks and the border-trade routes anchor local work.",
   "National Highways operates the A5 trunk road past the town, with the Mile End roundabout the key gateway junction and the A483 running north toward Wrexham across the Welsh border into Welsh Government roads. Trunk-road and border-corridor work alike mean fast roads and busy junction maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Oswestry crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, border-corridor and winter-maintenance work",
  "s2_intro":"Across Oswestry's Kier term-contract carriageway work and the National Highways A5",
 },
 "sandbach": {
  "region":"Sandbach and Cheshire",
  "nearby":["Crewe","Congleton","Northwich"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Sandbach's highway maintenance teams and roadworks contractors, from Cheshire East Highways and its Ringway Jacobs joint venture to National Highways work on the M6, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Sandbach area's roads running",
  "s1loc":[
   "Sandbach is a Cheshire market town with Saxon crosses and a long commercial-vehicle heritage, sitting right on the M6 at junction 17. Cheshire East Council is the unitary highway authority, and its gangs work in Class 3 hi-vis around that motorway junction and the town's trade estates.",
   "The council delivers highways through Cheshire East Highways, its joint venture with Ringway Jacobs running for over a decade and renewed in recent years, covering carriageways, footways, bridges, lighting and drainage across around sixteen hundred miles of road. The Foden and ERF truck heritage and the Springvale industrial estate anchor local trade.",
   "National Highways operates the M6 with junction 17 at Sandbach and the adjacent motorway services, while the council-managed A534 and A533 feed the town. Motorway-junction and town-route work alike mean fast roads and heavy goods traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Sandbach crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-junction and winter-maintenance work",
  "s2_intro":"Across Sandbach's Cheshire East Highways carriageway work and the National Highways M6",
 },
 "normanton": {
  "region":"Normanton and West Yorkshire",
  "nearby":["Castleford","Pontefract","Featherstone"],
  "snapshot":"iNeedWorkwear kits Normanton's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Wakefield Council and the Yorkshire Highways Alliance framework to National Highways work on the M62, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Normanton area's roads running",
  "s1loc":[
   "Normanton is a former railway and mining town in the Wakefield district, now a major logistics hub built around M62 junction 31. Wakefield Council is the West Yorkshire metropolitan highway authority, and its gangs work in Class 3 hi-vis around that motorway junction and the warehouse estates.",
   "The council manages highways in-house, splitting delivery between its own teams and framework contractors commissioned through the Yorkshire Highways Alliance. The Normanton Industrial Estate and the rail-connected Europort, with occupiers from Haribo to Warburtons, anchor local trade.",
   "National Highways operates the M62 with junction 31 the gateway, the A1(M) and M1 both within a few miles, while the council-managed A655 Pontefract Road links the estates to the junction. Motorway and logistics-corridor work alike mean fast roads and heavy goods traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Normanton crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, logistics-corridor and winter-maintenance work",
  "s2_intro":"Across Normanton's Yorkshire Highways Alliance carriageway work and the National Highways M62",
 },
 "stanley": {
  "region":"Stanley and County Durham",
  "nearby":["Chester-le-Street","Consett","Washington"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Stanley's highway maintenance teams and roadworks contractors, from Durham County Council's in-house highways operation to the A693 corridor and the A1(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Stanley area's roads running",
  "s1loc":[
   "Stanley is a former colliery town on the ridge between Chester-le-Street and Consett in north-west Durham, close to the Beamish museum. Durham County Council is the highway authority, and its gangs work in Class 3 hi-vis along the A693 and the hilltop routes.",
   "The council maintains its network largely in-house through Durham Highways, running its own inspection and works teams across thousands of kilometres of road, with contractors for major schemes. The town's commercial sites and the Beamish visitor economy anchor local trade.",
   "The council-managed A693 carries the town's main route toward Chester-le-Street, where it meets the A1(M) at around junction 63, with National Highways operating that motorway. Town-corridor and motorway-link work alike mean busy roads and exposed hilltop weather.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Stanley crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, ridge-corridor and winter-maintenance work",
  "s2_intro":"Across Stanley's in-house carriageway work and the A693 corridor and A1(M)",
 },
 "cottingham": {
  "region":"Cottingham and East Yorkshire",
  "nearby":["Hull","Beverley","Hessle"],
  "snapshot":"iNeedWorkwear kits Cottingham's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from East Riding of Yorkshire Council's highways service to the A164 corridor and the Humber Bridge, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Cottingham area's roads running",
  "s1loc":[
   "Cottingham is one of England's largest villages, set just north-west of Hull between the city and Beverley on the A164 corridor. East Riding of Yorkshire Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along that busy road and the town approaches.",
   "The council delivers highways through its in-house teams and a recent multi-supplier framework for highways labour and street lighting shared with neighbouring authorities. The A164, the busiest road in the East Riding, and the routes toward the Humber Bridge anchor local trade.",
   "The council-managed A164 carries heavy daily traffic between Beverley and the Humber Bridge, where a major Jock's Lodge grade-separated junction improvement is being built, with the A1079 the other key route, while National Highways operates the A63 and M62 corridor toward Hull. Corridor and junction work alike mean busy roads and major scheme traffic management.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Cottingham crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, A164-corridor and winter-maintenance work",
  "s2_intro":"Across Cottingham's East Riding carriageway work and the A164 corridor",
 },
 "ossett": {
  "region":"Ossett and West Yorkshire",
  "nearby":["Dewsbury","Batley","Normanton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Ossett's highway maintenance teams and roadworks contractors, from Wakefield Council and the Yorkshire Highways Alliance framework to National Highways work on the M1, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Ossett area's roads running",
  "s1loc":[
   "Ossett is a Heavy Woollen District town in the Wakefield district, built on the rag-wool shoddy trade and sitting on the A638 by M1 junction 40. Wakefield Council is the West Yorkshire metropolitan highway authority, and its gangs work in Class 3 hi-vis along that motorway-junction corridor and the town streets.",
   "The council manages highways in-house, splitting delivery between its own teams and framework contractors commissioned through the Yorkshire Highways Alliance. The town's textile-heritage mill sites and the A638 trade estates anchor local work.",
   "National Highways operates the M1 with junction 40 at Ossett the gateway, while the council-managed A638 Dewsbury-to-Wakefield road feeds the junction. Motorway-junction and town-route work alike mean fast roads and busy commuter traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Ossett crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, motorway-junction and winter-maintenance work",
  "s2_intro":"Across Ossett's Yorkshire Highways Alliance carriageway work and the National Highways M1",
 },
 "maltby": {
  "region":"Maltby and South Yorkshire",
  "nearby":["Rotherham","Worksop","Mexborough"],
  "snapshot":"iNeedWorkwear kits Maltby's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Rotherham Council's Streetpride service to National Highways work on the M18, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Maltby area's roads running",
  "s1loc":[
   "Maltby is a former pit town east of Rotherham on the A631, set on the South Yorkshire logistics corridor by M18 junction 1. Rotherham Metropolitan Borough Council is the highway authority, and its gangs work in Class 3 hi-vis along that corridor and the motorway-junction approaches.",
   "The council manages highway maintenance in-house through its Streetpride service with zonal working, supported by a Ringway construction-project partnership in recent years. The former Maltby Colliery redevelopment and the Aven and Hellaby industrial estates anchor local trade.",
   "National Highways operates the M18 with junction 1 by the town and the M1 and A1(M) within reach, while the council-managed A631 Rotherham Road links the town to the centre and east toward Bawtry. Motorway and logistics-corridor work alike mean fast roads and heavy goods traffic.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Maltby crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, logistics-corridor and winter-maintenance work",
  "s2_intro":"Across Maltby's Streetpride carriageway work and the National Highways M18",
 },
 "ripon": {
  "region":"Ripon and North Yorkshire",
  "nearby":["Harrogate","Knaresborough","Northallerton"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Ripon's highway maintenance teams and roadworks contractors, from North Yorkshire Council's NY Highways company to National Highways work on the A1(M), with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Ripon area's roads running",
  "s1loc":[
   "Ripon is one of England's smallest cathedral cities, set on the A61 between Harrogate and the A1(M) at the edge of the Yorkshire Dales. North Yorkshire Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the A61 and the city approaches.",
   "The council delivers highways through NY Highways, its own company looking after thousands of miles of road across the county, on ground where gypsum-related sinkhole conditions can affect local infrastructure. The Army Foundation College, the racecourse and the city's tourism economy anchor local trade.",
   "National Highways operates the A1(M) just east of the city as the strategic route, while the council-managed A61 carries traffic between Harrogate to the south and Thirsk to the north. Trunk-road and city-corridor work alike mean fast roads and ground-condition-aware repairs.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Ripon crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, city-corridor and winter-maintenance work",
  "s2_intro":"Across Ripon's NY Highways carriageway work and the National Highways A1(M)",
 },
 "guisborough": {
  "region":"Guisborough and the Tees Valley",
  "nearby":["Redcar","Middlesbrough","Stockton-on-Tees"],
  "snapshot":"iNeedWorkwear kits Guisborough's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Redcar and Cleveland Council's highways service to the A171 corridor, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Guisborough area's roads running",
  "s1loc":[
   "Guisborough is an ancient market town below the North York Moors east of Middlesbrough, the gateway to the national park on the A171. Redcar and Cleveland Borough Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the town bypass and the moor-edge routes.",
   "The council delivers highways largely in-house through its own resurfacing crews, supported by external contractors for specific schemes. The Priory ruins, the moor-edge tourism economy and the town's trade estates anchor local work.",
   "The council-managed A171 and A173 cross at Guisborough, carried in part by the town bypass with the A174 coast road nearby, while National Highways operates the strategic Tees Valley network beyond. Bypass and moor-edge work alike mean busy roads and exposed upland approaches.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Guisborough crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, bypass and winter-maintenance work",
  "s2_intro":"Across Guisborough's Redcar and Cleveland carriageway work and the A171 corridor",
 },
 "saltash": {
  "region":"Saltash and Cornwall",
  "nearby":["Plymouth","Bodmin","St Austell"],
  "snapshot":"iNeedWorkwear supplies Class 3 hi-vis, safety boots, waterproofs and branded workwear to Saltash's highway maintenance teams and roadworks contractors, from Cornwall Council's CORMAC company to National Highways work on the A38 Tamar crossing, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Saltash area's roads running",
  "s1loc":[
   "Saltash is the gateway into Cornwall on the west bank of the Tamar, where the A38 road bridge and Brunel's railway bridge cross from Plymouth side by side. Cornwall Council is the unitary highway authority, and its gangs work in Class 3 hi-vis along the A38 approaches and the town routes.",
   "The council delivers highways through CORMAC, its own company within the Corserv group, maintaining around seven thousand five hundred kilometres of Cornish road under term service contracts, while the Tamar Bridge itself is jointly owned and run by Cornwall Council and Plymouth City Council through a toll-funded joint committee. The town's trade estates and the river crossing anchor local work.",
   "National Highways operates the A38 trunk road through the Saltash Tunnel, recently given a major technology upgrade, carrying the strategic route across the Tamar, while CORMAC maintains the local network. Trunk-tunnel and bridge work alike mean fast roads and major structure maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting put Saltash crews out in Class 3 hi-vis beside running traffic.",
  ],
  "kit_loc":"across the area's carriageway, river-crossing and winter-maintenance work",
  "s2_intro":"Across Saltash's CORMAC carriageway work and the National Highways A38 Tamar crossing",
 },
 "bideford": {
  "region":"Bideford and Devon",
  "nearby":["Barnstaple","Tiverton","Exeter"],
  "snapshot":"iNeedWorkwear kits Bideford's highway maintenance teams and roadworks contractors with Class 3 hi-vis, safety boots, waterproofs and branded workwear, from Devon County Council's term maintenance contract to the A39 Atlantic Highway, with name and ID branding placed off the certified reflective area and multi-depot supply.",
  "s1_head":"Kitting the people who keep the Bideford area's roads running",
  "s1loc":[
   "Bideford is a historic port town on the River Torridge in north Devon, where the A39 Atlantic Highway crosses the Torridge Bridge past the old long bridge. Devon County Council is the highway authority, and its gangs work in Class 3 hi-vis along the bypass and the estuary routes.",
   "The county delivers highways through an outsourced term maintenance contract, held by Milestone in recent years, with a successor arrangement being procured and an in-house option under consideration. The Caddsdown business park and the port's maritime trade anchor local work.",
   "The council-managed A39 Atlantic Highway runs through the town toward north Cornwall, carried over the river by the Torridge Bridge, with the A386 linking south to the A30 and the A361 North Devon Link Road the strategic route toward the M5. Bypass and link-route work alike mean busy roads and major structure maintenance.",
   "Resurfacing, lining, drainage, lighting and winter gritting are all handled by Bideford crews in Class 3 hi-vis on the carriageway.",
  ],
  "kit_loc":"across the area's carriageway, estuary-corridor and winter-maintenance work",
  "s2_intro":"Across Bideford's term-maintenance carriageway work and the A39 Atlantic Highway",
 },
}
