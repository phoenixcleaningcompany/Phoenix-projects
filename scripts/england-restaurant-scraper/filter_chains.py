#!/usr/bin/env python3
"""
Dedupes restaurants_full.csv and filters chain brands by keyword, not
...
def main():
    ...
    for fname, recs in (("restaurants_independent.csv", independent), ("restaurants_chains.csv", chains)):
